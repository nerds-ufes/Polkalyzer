...
class MininetNX( Topo ):
	def build( self ):
		...
		lss9 = self.addLink('s6','s33',**linkSSParameters)
		lss10 = self.addLink('s6','s7',**linkSSParameters)
		lss11 = self.addLink('s7','s18',**linkSSParameters)
		lss12 = self.addLink('s8','s17',**linkSSParameters)
		...
		lss16 = self.addLink('s12','s24',**linkSSParameters)
		lss17 = self.addLink('s12','s25',**linkSSParameters)
		lss18 = self.addLink('s12','s27',**linkSSParameters)
		lss19 = self.addLink('s12','s30',**linkSSParameters)
		lss20 = self.addLink('s13','s14',**linkSSParameters)
		lss21 = self.addLink('s14','s28',**linkSSParameters)
		lss22 = self.addLink('s15','s24',**linkSSParameters)
		...
		lss26 = self.addLink('s21','s23',**linkSSParameters)
		lss27 = self.addLink('s22','s24',**linkSSParameters)
		lss28 = self.addLink('s23','s24',**linkSSParameters)
		lss29 = self.addLink('s24','s32',**linkSSParameters)
		lss30 = self.addLink('s24','s29',**linkSSParameters)
