...
class MininetNX( Topo ):
	def build( self ):
		...
		lss3 = self.addLink('s1','s11')
		lss4 = self.addLink('s2','s4')
		lss5 = self.addLink('s3','s4')
		lss6 = self.addLink('s4','s5')
		lss7 = self.addLink('s4','s6')
		lss8 = self.addLink('s5','s24')
		lss9 = self.addLink('s5','s8')
		lss10 = self.addLink('s5','s10')
		lss11 = self.addLink('s5','s9')
		lss12 = self.addLink('s6','s33')
		lss13 = self.addLink('s6','s7')
		lss14 = self.addLink('s7','s8')
		lss15 = self.addLink('s7','s18')
		lss16 = self.addLink('s8','s17')
		lss17 = self.addLink('s8','s33')
		lss18 = self.addLink('s9','s17')
		lss19 = self.addLink('s10','s11')
		lss20 = self.addLink('s11','s12')
		lss21 = self.addLink('s12','s13')
		lss22 = self.addLink('s12','s24')
		lss23 = self.addLink('s12','s25')
		lss24 = self.addLink('s12','s27')
		lss25 = self.addLink('s12','s30')
		lss26 = self.addLink('s13','s14')
		lss27 = self.addLink('s14','s26')
		lss28 = self.addLink('s14','s28')
		lss29 = self.addLink('s15','s16')
		lss30 = self.addLink('s15','s24')
		lss31 = self.addLink('s15','s28')
		lss32 = self.addLink('s16','s18')
		lss33 = self.addLink('s17','s21')
		lss34 = self.addLink('s18','s21')
		lss35 = self.addLink('s19','s21')
		lss36 = self.addLink('s20','s29')
		lss37 = self.addLink('s20','s22')
		lss38 = self.addLink('s21','s23')
		lss39 = self.addLink('s22','s24')
		lss40 = self.addLink('s22','s23')
		lss41 = self.addLink('s23','s24')
		lss42 = self.addLink('s24','s32')
		lss43 = self.addLink('s24','s29')
		lss44 = self.addLink('s25','s26')
		lss45 = self.addLink('s26','s27')
		lss46 = self.addLink('s29','s30')
		lss47 = self.addLink('s30','s31')
		lss48 = self.addLink('s31','s32')
