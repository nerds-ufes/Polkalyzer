...
class MininetNX( Topo ):
	def build( self ):
		...
		lhs34 = self.addLink('s18','h34')
		lhs35 = self.addLink('s18','h35')
		lhs36 = self.addLink('s19','h36')
		lhs37 = self.addLink('s19','h37')
		lhs38 = self.addLink('s20','h38')
		lhs39 = self.addLink('s20','h39')
		lhs40 = self.addLink('s21','h40')
		lhs41 = self.addLink('s21','h41')
		lhs42 = self.addLink('s22','h42')
		lhs43 = self.addLink('s22','h43')
		lhs44 = self.addLink('s23','h44')
		lhs45 = self.addLink('s23','h45')
		lhs46 = self.addLink('s24','h46')
		lhs47 = self.addLink('s24','h47')
		lhs48 = self.addLink('s25','h48')
		lhs49 = self.addLink('s25','h49')
		lhs50 = self.addLink('s26','h50')
		lhs51 = self.addLink('s26','h51')
		lhs52 = self.addLink('s27','h52')
		lhs53 = self.addLink('s27','h53')
		lhs54 = self.addLink('s28','h54')
		lhs55 = self.addLink('s28','h55')
		lhs56 = self.addLink('s29','h56')
		lhs57 = self.addLink('s29','h57')
		#Add a link of switches of original topology
		lss0 = self.addLink('s0','s1')
		lss1 = self.addLink('s0','s20')
		lss2 = self.addLink('s0','s23')
		lss3 = self.addLink('s1','s2')
		lss4 = self.addLink('s2','s22')
		lss5 = self.addLink('s2','s25')
		lss6 = self.addLink('s3','s21')
		lss7 = self.addLink('s3','s22')
		lss8 = self.addLink('s4','s25')
		lss9 = self.addLink('s4','s28')
		lss10 = self.addLink('s5','s12')
		lss11 = self.addLink('s5','s23')
		lss12 = self.addLink('s6','s24')
		lss13 = self.addLink('s6','s7')
		lss14 = self.addLink('s7','s12')
		lss15 = self.addLink('s7','s14')
		lss16 = self.addLink('s8','s9')
		lss17 = self.addLink('s8','s14')
		lss18 = self.addLink('s9','s15')
		lss19 = self.addLink('s10','s26')
		lss20 = self.addLink('s10','s11')
		lss21 = self.addLink('s11','s24')
		lss22 = self.addLink('s11','s18')
		lss23 = self.addLink('s13','s27')
		lss24 = self.addLink('s13','s29')
		lss25 = self.addLink('s15','s16')
		lss26 = self.addLink('s16','s19')
		lss27 = self.addLink('s16','s29')
		lss28 = self.addLink('s18','s28')
		lss29 = self.addLink('s19','s22')
