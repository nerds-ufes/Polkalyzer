...
class MininetNX( Topo ):
	def build( self ):
		...
		lhs34 = self.addLink('s18','h34',**linkHSParameters)
		lhs35 = self.addLink('s18','h35',**linkHSParameters)
		lhs36 = self.addLink('s19','h36',**linkHSParameters)
		lhs37 = self.addLink('s19','h37',**linkHSParameters)
		lhs38 = self.addLink('s20','h38',**linkHSParameters)
		lhs39 = self.addLink('s20','h39',**linkHSParameters)
		lhs40 = self.addLink('s21','h40',**linkHSParameters)
		lhs41 = self.addLink('s21','h41',**linkHSParameters)
		lhs42 = self.addLink('s22','h42',**linkHSParameters)
		lhs43 = self.addLink('s22','h43',**linkHSParameters)
		lhs44 = self.addLink('s23','h44',**linkHSParameters)
		lhs45 = self.addLink('s23','h45',**linkHSParameters)
		lhs46 = self.addLink('s24','h46',**linkHSParameters)
		lhs47 = self.addLink('s24','h47',**linkHSParameters)
		lhs48 = self.addLink('s25','h48',**linkHSParameters)
		lhs49 = self.addLink('s25','h49',**linkHSParameters)
		lhs50 = self.addLink('s26','h50',**linkHSParameters)
		lhs51 = self.addLink('s26','h51',**linkHSParameters)
		lhs52 = self.addLink('s27','h52',**linkHSParameters)
		lhs53 = self.addLink('s27','h53',**linkHSParameters)
		lhs54 = self.addLink('s28','h54',**linkHSParameters)
		lhs55 = self.addLink('s28','h55',**linkHSParameters)
		lhs56 = self.addLink('s29','h56',**linkHSParameters)
		lhs57 = self.addLink('s29','h57',**linkHSParameters)
		#Add a link of switches of original topology
		lss0 = self.addLink('s0','s1',**linkSSParameters)
		lss1 = self.addLink('s0','s20',**linkSSParameters)
		lss2 = self.addLink('s0','s23',**linkSSParameters)
		lss3 = self.addLink('s1','s2',**linkSSParameters)
		lss4 = self.addLink('s2','s22',**linkSSParameters)
		lss5 = self.addLink('s2','s25',**linkSSParameters)
		lss6 = self.addLink('s3','s21',**linkSSParameters)
		lss7 = self.addLink('s3','s22',**linkSSParameters)
		lss8 = self.addLink('s4','s25',**linkSSParameters)
		lss9 = self.addLink('s4','s28',**linkSSParameters)
		lss10 = self.addLink('s5','s12',**linkSSParameters)
		lss11 = self.addLink('s5','s23',**linkSSParameters)
		lss12 = self.addLink('s6','s24',**linkSSParameters)
		lss13 = self.addLink('s6','s7',**linkSSParameters)
		lss14 = self.addLink('s7','s12',**linkSSParameters)
		lss15 = self.addLink('s7','s14',**linkSSParameters)
		lss16 = self.addLink('s8','s9',**linkSSParameters)
		lss17 = self.addLink('s8','s14',**linkSSParameters)
		lss18 = self.addLink('s9','s15',**linkSSParameters)
		lss19 = self.addLink('s10','s26',**linkSSParameters)
		lss20 = self.addLink('s10','s11',**linkSSParameters)
		lss21 = self.addLink('s11','s24',**linkSSParameters)
		lss22 = self.addLink('s11','s18',**linkSSParameters)
		lss23 = self.addLink('s13','s27',**linkSSParameters)
		lss24 = self.addLink('s13','s29',**linkSSParameters)
		lss25 = self.addLink('s15','s16',**linkSSParameters)
		lss26 = self.addLink('s16','s19',**linkSSParameters)
		lss27 = self.addLink('s16','s29',**linkSSParameters)
		lss28 = self.addLink('s18','s28',**linkSSParameters)
		lss29 = self.addLink('s19','s22',**linkSSParameters)
		lss30 = self.addLink('s20','s21',**linkSSParameters)
		lss31 = self.addLink('s26','s27',**linkSSParameters)
		
topos = { 'Arpanet19728': ( lambda: MininetNX() ) }