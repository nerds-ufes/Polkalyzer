...
class MininetNX( Topo ):
	def build( self ):
		...
		lhs17 = self.addLink('s18','h17',**linkHSParameters)
		lhs18 = self.addLink('s19','h18',**linkHSParameters)
		lhs19 = self.addLink('s20','h19',**linkHSParameters)
		lhs20 = self.addLink('s21','h20',**linkHSParameters)
		lhs21 = self.addLink('s22','h21',**linkHSParameters)
		lhs22 = self.addLink('s23','h22',**linkHSParameters)
		lhs23 = self.addLink('s24','h23',**linkHSParameters)
		lhs24 = self.addLink('s25','h24',**linkHSParameters)
		lhs25 = self.addLink('s26','h25',**linkHSParameters)
		lhs26 = self.addLink('s27','h26',**linkHSParameters)
		lhs27 = self.addLink('s28','h27',**linkHSParameters)
		lhs28 = self.addLink('s29','h28',**linkHSParameters)
		...
		lss8 = self.addLink('s4','s28',**linkSSParameters)
		lss9 = self.addLink('s5','s23',**linkSSParameters)
		lss10 = self.addLink('s5','s12',**linkSSParameters)
		lss11 = self.addLink('s6','s7',**linkSSParameters)
		lss12 = self.addLink('s6','s24',**linkSSParameters)
		lss13 = self.addLink('s7','s12',**linkSSParameters)
		lss14 = self.addLink('s7','s14',**linkSSParameters)
		lss15 = self.addLink('s8','s14',**linkSSParameters)
		lss16 = self.addLink('s9','s15',**linkSSParameters)
		lss17 = self.addLink('s10','s11',**linkSSParameters)
		lss18 = self.addLink('s11','s18',**linkSSParameters)
		lss19 = self.addLink('s13','s29',**linkSSParameters)
		lss20 = self.addLink('s13','s27',**linkSSParameters)
		lss21 = self.addLink('s15','s16',**linkSSParameters)
		lss22 = self.addLink('s16','s19',**linkSSParameters)
		lss23 = self.addLink('s16','s29',**linkSSParameters)
		lss24 = self.addLink('s18','s28',**linkSSParameters)
		lss25 = self.addLink('s19','s22',**linkSSParameters)
		lss26 = self.addLink('s20','s21',**linkSSParameters)
		lss27 = self.addLink('s26','s27',**linkSSParameters)
