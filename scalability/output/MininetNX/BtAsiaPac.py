...
class MininetNX( Topo ):
	def build( self ):
		...
		lss3 = self.addLink('s1','s3')
		lss4 = self.addLink('s1','s4')
		lss5 = self.addLink('s1','s16')
		lss6 = self.addLink('s1','s17')
		lss7 = self.addLink('s2','s3')
		lss8 = self.addLink('s3','s4')
		lss9 = self.addLink('s3','s5')
		lss10 = self.addLink('s3','s9')
		lss11 = self.addLink('s3','s12')
		lss12 = self.addLink('s3','s13')
		lss13 = self.addLink('s3','s16')
		lss14 = self.addLink('s3','s17')
		lss15 = self.addLink('s3','s18')
		lss16 = self.addLink('s3','s19')
		lss17 = self.addLink('s5','s10')
		lss18 = self.addLink('s6','s10')
		lss19 = self.addLink('s7','s10')
		lss20 = self.addLink('s8','s9')
		lss21 = self.addLink('s9','s18')
		lss22 = self.addLink('s10','s11')
		lss23 = self.addLink('s10','s13')
		lss24 = self.addLink('s10','s14')
		lss25 = self.addLink('s10','s18')
		lss26 = self.addLink('s13','s14')
		lss27 = self.addLink('s14','s16')
		lss28 = self.addLink('s14','s17')
		lss29 = self.addLink('s14','s15')
