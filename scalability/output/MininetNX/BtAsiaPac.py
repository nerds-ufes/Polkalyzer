...
class MininetNX( Topo ):
	def build( self ):
		...
		lss5 = self.addLink('s1','s16',**linkSSParameters)
		lss6 = self.addLink('s1','s17',**linkSSParameters)
		lss7 = self.addLink('s2','s3',**linkSSParameters)
		lss8 = self.addLink('s3','s4',**linkSSParameters)
		lss9 = self.addLink('s3','s5',**linkSSParameters)
		lss10 = self.addLink('s3','s9',**linkSSParameters)
		lss11 = self.addLink('s3','s12',**linkSSParameters)
		lss12 = self.addLink('s3','s13',**linkSSParameters)
		lss13 = self.addLink('s3','s16',**linkSSParameters)
		lss14 = self.addLink('s3','s17',**linkSSParameters)
		lss15 = self.addLink('s3','s18',**linkSSParameters)
		lss16 = self.addLink('s3','s19',**linkSSParameters)
		lss17 = self.addLink('s5','s10',**linkSSParameters)
		lss18 = self.addLink('s6','s10',**linkSSParameters)
		lss19 = self.addLink('s7','s10',**linkSSParameters)
		lss20 = self.addLink('s8','s9',**linkSSParameters)
		lss21 = self.addLink('s9','s18',**linkSSParameters)
		lss22 = self.addLink('s10','s11',**linkSSParameters)
		lss23 = self.addLink('s10','s13',**linkSSParameters)
		lss24 = self.addLink('s10','s14',**linkSSParameters)
		lss25 = self.addLink('s10','s18',**linkSSParameters)
		lss26 = self.addLink('s13','s14',**linkSSParameters)
		lss27 = self.addLink('s14','s16',**linkSSParameters)
		lss28 = self.addLink('s14','s17',**linkSSParameters)
		lss29 = self.addLink('s14','s15',**linkSSParameters)
		lss30 = self.addLink('s15','s17',**linkSSParameters)
		
topos = { 'BtAsiaPac': ( lambda: MininetNX() ) }