...
class MininetNX( Topo ):
	def build( self ):
		...
		lss4 = self.addLink('s1','s16',**linkSSParameters)
		lss5 = self.addLink('s1','s17',**linkSSParameters)
		lss6 = self.addLink('s3','s5',**linkSSParameters)
		lss7 = self.addLink('s3','s9',**linkSSParameters)
		lss8 = self.addLink('s3','s12',**linkSSParameters)
		lss9 = self.addLink('s3','s13',**linkSSParameters)
		lss10 = self.addLink('s3','s18',**linkSSParameters)
		lss11 = self.addLink('s3','s19',**linkSSParameters)
		lss12 = self.addLink('s5','s10',**linkSSParameters)
		lss13 = self.addLink('s6','s10',**linkSSParameters)
