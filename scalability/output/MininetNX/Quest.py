...
class MininetNX( Topo ):
	def build( self ):
		...
		lss4 = self.addLink('s1','s4',**linkSSParameters)
		lss5 = self.addLink('s1','s14',**linkSSParameters)
		...
		lss9 = self.addLink('s2','s14',**linkSSParameters)
		lss10 = self.addLink('s2','s19',**linkSSParameters)
		lss11 = self.addLink('s3','s19',**linkSSParameters)
		lss12 = self.addLink('s3','s4',**linkSSParameters)
		lss13 = self.addLink('s3','s18',**linkSSParameters)
		lss14 = self.addLink('s4','s19',**linkSSParameters)
		lss15 = self.addLink('s4','s18',**linkSSParameters)
		lss16 = self.addLink('s4','s5',**linkSSParameters)
		lss17 = self.addLink('s5','s6',**linkSSParameters)
		lss18 = self.addLink('s5','s7',**linkSSParameters)
		lss19 = self.addLink('s7','s8',**linkSSParameters)
		lss20 = self.addLink('s8','s10',**linkSSParameters)
		lss21 = self.addLink('s9','s10',**linkSSParameters)
		lss22 = self.addLink('s9','s12',**linkSSParameters)
		lss23 = self.addLink('s10','s13',**linkSSParameters)
		lss24 = self.addLink('s11','s12',**linkSSParameters)
		lss25 = self.addLink('s11','s15',**linkSSParameters)
		...
		lss30 = self.addLink('s16','s17',**linkSSParameters)
		
topos = { 'Quest': ( lambda: MininetNX() ) }