...
class MininetNX( Topo ):
	def build( self ):
		...
		lss4 = self.addLink('s1','s4')
		lss5 = self.addLink('s1','s14')
		lss6 = self.addLink('s2','s3')
		lss7 = self.addLink('s2','s5')
		lss8 = self.addLink('s2','s10')
		lss9 = self.addLink('s2','s14')
		lss10 = self.addLink('s2','s19')
		lss11 = self.addLink('s3','s19')
		lss12 = self.addLink('s3','s4')
		lss13 = self.addLink('s3','s18')
		lss14 = self.addLink('s4','s19')
		lss15 = self.addLink('s4','s18')
		lss16 = self.addLink('s4','s5')
		lss17 = self.addLink('s5','s6')
		lss18 = self.addLink('s5','s7')
		lss19 = self.addLink('s7','s8')
		lss20 = self.addLink('s8','s10')
		lss21 = self.addLink('s9','s10')
		lss22 = self.addLink('s9','s12')
		lss23 = self.addLink('s10','s13')
		lss24 = self.addLink('s11','s12')
		lss25 = self.addLink('s11','s15')
		lss26 = self.addLink('s13','s14')
		lss27 = self.addLink('s14','s16')
		lss28 = self.addLink('s14','s15')
		lss29 = self.addLink('s15','s17')
