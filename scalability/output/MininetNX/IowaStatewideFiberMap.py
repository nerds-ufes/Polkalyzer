...
class MininetNX( Topo ):
	def build( self ):
		...
		lss0 = self.addLink('s0','s30')
		lss1 = self.addLink('s0','s31')
		lss2 = self.addLink('s1','s30')
		lss3 = self.addLink('s2','s32')
		lss4 = self.addLink('s2','s31')
		lss5 = self.addLink('s3','s32')
		lss6 = self.addLink('s3','s4')
		lss7 = self.addLink('s3','s29')
		lss8 = self.addLink('s4','s20')
		lss9 = self.addLink('s5','s10')
		lss10 = self.addLink('s5','s20')
		lss11 = self.addLink('s5','s6')
		lss12 = self.addLink('s6','s9')
		lss13 = self.addLink('s6','s7')
		lss14 = self.addLink('s7','s8')
		lss15 = self.addLink('s7','s17')
		lss16 = self.addLink('s7','s15')
		lss17 = self.addLink('s8','s32')
		lss18 = self.addLink('s9','s32')
		lss19 = self.addLink('s10','s11')
		lss20 = self.addLink('s11','s12')
		lss21 = self.addLink('s12','s25')
		lss22 = self.addLink('s12','s17')
		lss23 = self.addLink('s13','s28')
		lss24 = self.addLink('s13','s14')
		lss25 = self.addLink('s13','s15')
		lss26 = self.addLink('s14','s16')
		lss27 = self.addLink('s14','s18')
		lss28 = self.addLink('s14','s15')
		lss29 = self.addLink('s15','s19')
		lss30 = self.addLink('s16','s17')
		lss31 = self.addLink('s19','s31')
		lss32 = self.addLink('s19','s30')
		lss33 = self.addLink('s20','s22')
		lss34 = self.addLink('s20','s21')
		lss35 = self.addLink('s21','s22')
		lss36 = self.addLink('s22','s24')
		lss37 = self.addLink('s22','s27')
		lss38 = self.addLink('s22','s23')
		lss39 = self.addLink('s24','s26')
		lss40 = self.addLink('s25','s26')
		
topos = { 'IowaStatewideFiberMap': ( lambda: MininetNX() ) }