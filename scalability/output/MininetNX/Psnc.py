...
class MininetNX( Topo ):
	def build( self ):
		...
		lss2 = self.addLink('s0','s1',**linkSSParameters)
		...
		lss8 = self.addLink('s5','s34',**linkSSParameters)
		lss9 = self.addLink('s5','s6',**linkSSParameters)
		lss10 = self.addLink('s6','s19',**linkSSParameters)
		lss11 = self.addLink('s6','s35',**linkSSParameters)
		lss12 = self.addLink('s6','s7',**linkSSParameters)
		lss13 = self.addLink('s7','s8',**linkSSParameters)
		lss14 = self.addLink('s9','s10',**linkSSParameters)
		lss15 = self.addLink('s9','s11',**linkSSParameters)
		...
		lss19 = self.addLink('s14','s16',**linkSSParameters)
		lss20 = self.addLink('s14','s15',**linkSSParameters)
		lss21 = self.addLink('s16','s17',**linkSSParameters)
		lss22 = self.addLink('s17','s18',**linkSSParameters)
		lss23 = self.addLink('s17','s19',**linkSSParameters)
		lss24 = self.addLink('s18','s26',**linkSSParameters)
		lss25 = self.addLink('s18','s21',**linkSSParameters)
		lss26 = self.addLink('s19','s20',**linkSSParameters)
		lss27 = self.addLink('s20','s31',**linkSSParameters)
		...
		lss31 = self.addLink('s23','s25',**linkSSParameters)
		lss32 = self.addLink('s25','s27',**linkSSParameters)
		lss33 = self.addLink('s26','s27',**linkSSParameters)
		lss34 = self.addLink('s27','s28',**linkSSParameters)
		lss35 = self.addLink('s28','s32',**linkSSParameters)
		lss36 = self.addLink('s28','s29',**linkSSParameters)
		lss37 = self.addLink('s30','s32',**linkSSParameters)
		lss38 = self.addLink('s31','s32',**linkSSParameters)
		lss39 = self.addLink('s32','s33',**linkSSParameters)
		lss40 = self.addLink('s33','s34',**linkSSParameters)
		
topos = { 'Psnc': ( lambda: MininetNX() ) }