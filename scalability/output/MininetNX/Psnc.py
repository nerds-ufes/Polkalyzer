...
class MininetNX( Topo ):
	def build( self ):
		...
		lss7 = self.addLink('s5','s34',**linkSSParameters)
		lss8 = self.addLink('s6','s7',**linkSSParameters)
		lss9 = self.addLink('s6','s19',**linkSSParameters)
		lss10 = self.addLink('s6','s35',**linkSSParameters)
		...
		lss19 = self.addLink('s17','s19',**linkSSParameters)
		lss20 = self.addLink('s17','s18',**linkSSParameters)
		lss21 = self.addLink('s18','s26',**linkSSParameters)
		lss22 = self.addLink('s18','s21',**linkSSParameters)
		lss23 = self.addLink('s19','s20',**linkSSParameters)
		lss24 = self.addLink('s20','s31',**linkSSParameters)
		...
		lss28 = self.addLink('s25','s27',**linkSSParameters)
		lss29 = self.addLink('s26','s27',**linkSSParameters)
		lss30 = self.addLink('s28','s32',**linkSSParameters)
		lss31 = self.addLink('s28','s29',**linkSSParameters)
		lss32 = self.addLink('s30','s32',**linkSSParameters)
		lss33 = self.addLink('s32','s33',**linkSSParameters)
		lss34 = self.addLink('s33','s34',**linkSSParameters)
