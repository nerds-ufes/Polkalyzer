...
class MininetNX( Topo ):
	def build( self ):
		...
		lss2 = self.addLink('s0','s1')
		lss3 = self.addLink('s1','s2')
		lss4 = self.addLink('s2','s3')
		lss5 = self.addLink('s3','s4')
		lss6 = self.addLink('s3','s6')
		lss7 = self.addLink('s4','s5')
		lss8 = self.addLink('s5','s34')
		lss9 = self.addLink('s5','s6')
		lss10 = self.addLink('s6','s19')
		lss11 = self.addLink('s6','s35')
		lss12 = self.addLink('s6','s7')
		lss13 = self.addLink('s7','s8')
		lss14 = self.addLink('s9','s10')
		lss15 = self.addLink('s9','s11')
		lss16 = self.addLink('s11','s12')
		lss17 = self.addLink('s12','s13')
		lss18 = self.addLink('s12','s14')
		lss19 = self.addLink('s14','s16')
		lss20 = self.addLink('s14','s15')
		lss21 = self.addLink('s16','s17')
		lss22 = self.addLink('s17','s18')
		lss23 = self.addLink('s17','s19')
		lss24 = self.addLink('s18','s26')
		lss25 = self.addLink('s18','s21')
		lss26 = self.addLink('s19','s20')
		lss27 = self.addLink('s20','s31')
		lss28 = self.addLink('s21','s22')
		lss29 = self.addLink('s22','s23')
		lss30 = self.addLink('s23','s24')
		lss31 = self.addLink('s23','s25')
		lss32 = self.addLink('s25','s27')
		lss33 = self.addLink('s26','s27')
		lss34 = self.addLink('s27','s28')
		lss35 = self.addLink('s28','s32')
		lss36 = self.addLink('s28','s29')
		lss37 = self.addLink('s30','s32')
		lss38 = self.addLink('s31','s32')
		lss39 = self.addLink('s32','s33')
		lss40 = self.addLink('s33','s34')
