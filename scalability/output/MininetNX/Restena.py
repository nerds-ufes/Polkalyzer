...
class MininetNX( Topo ):
	def build( self ):
		...
		lss7 = self.addLink('s4','s15',**linkSSParameters)
		...
		lss17 = self.addLink('s9','s16',**linkSSParameters)
		lss18 = self.addLink('s9','s17',**linkSSParameters)
		lss19 = self.addLink('s9','s18',**linkSSParameters)
		lss20 = self.addLink('s10','s11',**linkSSParameters)
		
topos = { 'Restena': ( lambda: MininetNX() ) }