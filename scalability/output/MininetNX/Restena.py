...
class MininetNX( Topo ):
	def build( self ):
		...
		lss5 = self.addLink('s4','s15',**linkSSParameters)
		...
		lss12 = self.addLink('s8','s13',**linkSSParameters)
		lss13 = self.addLink('s8','s14',**linkSSParameters)
		lss14 = self.addLink('s9','s10',**linkSSParameters)
		lss15 = self.addLink('s9','s16',**linkSSParameters)
		lss16 = self.addLink('s9','s17',**linkSSParameters)
		lss17 = self.addLink('s9','s18',**linkSSParameters)
