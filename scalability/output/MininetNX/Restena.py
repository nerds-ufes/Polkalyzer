...
class MininetNX( Topo ):
	def build( self ):
		...
		lss7 = self.addLink('s4','s15')
		lss8 = self.addLink('s5','s8')
		lss9 = self.addLink('s6','s8')
		lss10 = self.addLink('s7','s9')
		lss11 = self.addLink('s8','s9')
		lss12 = self.addLink('s8','s11')
		lss13 = self.addLink('s8','s12')
		lss14 = self.addLink('s8','s13')
		lss15 = self.addLink('s8','s14')
		lss16 = self.addLink('s9','s10')
		lss17 = self.addLink('s9','s16')
		lss18 = self.addLink('s9','s17')
		lss19 = self.addLink('s9','s18')
