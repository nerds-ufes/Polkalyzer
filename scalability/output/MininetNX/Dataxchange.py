...
class MininetNX( Topo ):
	def build( self ):
		...
		lss5 = self.addLink('s1','s4',**linkSSParameters)
		lss6 = self.addLink('s1','s5',**linkSSParameters)
		lss7 = self.addLink('s2','s4',**linkSSParameters)
		lss8 = self.addLink('s2','s5',**linkSSParameters)
		lss9 = self.addLink('s3','s4',**linkSSParameters)
		lss10 = self.addLink('s4','s5',**linkSSParameters)
