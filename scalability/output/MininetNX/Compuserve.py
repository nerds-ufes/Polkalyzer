...
class MininetNX( Topo ):
	def build( self ):
		...
		lss6 = self.addLink('s5','s10',**linkSSParameters)
		lss7 = self.addLink('s6','s10',**linkSSParameters)
		lss8 = self.addLink('s6','s11',**linkSSParameters)
		lss9 = self.addLink('s6','s12',**linkSSParameters)
		lss10 = self.addLink('s6','s13',**linkSSParameters)
