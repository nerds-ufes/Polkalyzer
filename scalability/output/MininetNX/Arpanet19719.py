...
class MininetNX( Topo ):
	def build( self ):
		...
		lss3 = self.addLink('s0','s1')
		lss4 = self.addLink('s1','s2')
		lss5 = self.addLink('s2','s3')
		lss6 = self.addLink('s2','s4')
		lss7 = self.addLink('s3','s17')
		lss8 = self.addLink('s4','s9')
		lss9 = self.addLink('s4','s5')
		lss10 = self.addLink('s5','s6')
		lss11 = self.addLink('s6','s13')
		lss12 = self.addLink('s7','s8')
		lss13 = self.addLink('s7','s12')
		lss14 = self.addLink('s8','s15')
		lss15 = self.addLink('s8','s13')
		lss16 = self.addLink('s9','s10')
		lss17 = self.addLink('s9','s15')
		lss18 = self.addLink('s10','s14')
		lss19 = self.addLink('s11','s16')
