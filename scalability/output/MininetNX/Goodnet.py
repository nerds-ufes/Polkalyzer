...
class MininetNX( Topo ):
	def build( self ):
		...
		lss5 = self.addLink('s0','s11')
		lss6 = self.addLink('s0','s13')
		lss7 = self.addLink('s0','s14')
		lss8 = self.addLink('s0','s16')
		lss9 = self.addLink('s1','s3')
		lss10 = self.addLink('s2','s3')
		lss11 = self.addLink('s3','s5')
		lss12 = self.addLink('s3','s6')
		lss13 = self.addLink('s3','s8')
		lss14 = self.addLink('s3','s10')
		lss15 = self.addLink('s3','s14')
		lss16 = self.addLink('s3','s16')
		lss17 = self.addLink('s4','s5')
		lss18 = self.addLink('s5','s6')
		lss19 = self.addLink('s6','s7')
		lss20 = self.addLink('s6','s8')
		lss21 = self.addLink('s6','s11')
		lss22 = self.addLink('s6','s13')
		lss23 = self.addLink('s6','s14')
		lss24 = self.addLink('s6','s16')
		lss25 = self.addLink('s8','s9')
		lss26 = self.addLink('s8','s10')
		lss27 = self.addLink('s8','s12')
		lss28 = self.addLink('s10','s14')
		lss29 = self.addLink('s11','s12')
		lss30 = self.addLink('s14','s15')
