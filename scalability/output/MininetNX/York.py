...
class MininetNX( Topo ):
	def build( self ):
		...
		lss8 = self.addLink('s6','s10',**linkSSParameters)
		lss9 = self.addLink('s7','s8',**linkSSParameters)
		lss10 = self.addLink('s8','s9',**linkSSParameters)
		lss11 = self.addLink('s9','s20',**linkSSParameters)
