...
class MininetNX( Topo ):
	def build( self ):
		...
		lss8 = self.addLink('s2','s8',**linkSSParameters)
		lss9 = self.addLink('s2','s3',**linkSSParameters)
		lss10 = self.addLink('s2','s7',**linkSSParameters)
		lss11 = self.addLink('s3','s4',**linkSSParameters)
		lss12 = self.addLink('s3','s5',**linkSSParameters)
		lss13 = self.addLink('s3','s6',**linkSSParameters)
		lss14 = self.addLink('s4','s5',**linkSSParameters)
		lss15 = self.addLink('s4','s6',**linkSSParameters)
		lss16 = self.addLink('s5','s6',**linkSSParameters)
		lss17 = self.addLink('s5','s7',**linkSSParameters)
