...
class MininetNX( Topo ):
	def build( self ):
		...
		lss5 = self.addLink('s1','s8',**linkSSParameters)
		lss6 = self.addLink('s1','s2',**linkSSParameters)
		lss7 = self.addLink('s1','s7',**linkSSParameters)
		
topos = { 'Gridnet': ( lambda: MininetNX() ) }