...
class MininetNX( Topo ):
	def build( self ):
		...
		lss5 = self.addLink('s1','s8')
		lss6 = self.addLink('s1','s2')
		lss7 = self.addLink('s1','s7')
		lss8 = self.addLink('s2','s8')
		lss9 = self.addLink('s2','s3')
		lss10 = self.addLink('s2','s7')
		lss11 = self.addLink('s3','s4')
		lss12 = self.addLink('s3','s5')
		lss13 = self.addLink('s3','s6')
		lss14 = self.addLink('s4','s5')
		lss15 = self.addLink('s4','s6')
		lss16 = self.addLink('s5','s6')
		lss17 = self.addLink('s5','s7')
