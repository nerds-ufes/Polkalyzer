...
class MininetNX( Topo ):
	def build( self ):
		...
		lss12 = self.addLink('s4','s13',**linkSSParameters)
		lss13 = self.addLink('s4','s15',**linkSSParameters)
		lss14 = self.addLink('s4','s22',**linkSSParameters)
		lss15 = self.addLink('s4','s24',**linkSSParameters)
		lss16 = self.addLink('s4','s25',**linkSSParameters)
		lss17 = self.addLink('s4','s26',**linkSSParameters)
		lss18 = self.addLink('s4','s28',**linkSSParameters)
		lss19 = self.addLink('s4','s30',**linkSSParameters)
		lss20 = self.addLink('s4','s31',**linkSSParameters)
		lss21 = self.addLink('s5','s41',**linkSSParameters)
		lss22 = self.addLink('s7','s10',**linkSSParameters)
		lss23 = self.addLink('s7','s23',**linkSSParameters)
		lss24 = self.addLink('s11','s40',**linkSSParameters)
		lss25 = self.addLink('s11','s36',**linkSSParameters)
		lss26 = self.addLink('s11','s27',**linkSSParameters)
		lss27 = self.addLink('s12','s33',**linkSSParameters)
		lss28 = self.addLink('s12','s14',**linkSSParameters)
		lss29 = self.addLink('s15','s35',**linkSSParameters)
		lss30 = self.addLink('s15','s37',**linkSSParameters)
		lss31 = self.addLink('s15','s39',**linkSSParameters)
		lss32 = self.addLink('s15','s42',**linkSSParameters)
		lss33 = self.addLink('s15','s16',**linkSSParameters)
		lss34 = self.addLink('s15','s17',**linkSSParameters)
		lss35 = self.addLink('s15','s18',**linkSSParameters)
		lss36 = self.addLink('s15','s19',**linkSSParameters)
		lss37 = self.addLink('s15','s29',**linkSSParameters)
		lss38 = self.addLink('s17','s43',**linkSSParameters)
