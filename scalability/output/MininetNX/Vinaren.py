...
class MininetNX( Topo ):
	def build( self ):
		...
		lss0 = self.addLink('s0','s7')
		lss1 = self.addLink('s1','s7')
		lss2 = self.addLink('s2','s7')
		lss3 = self.addLink('s3','s17')
		lss4 = self.addLink('s4','s13')
		lss5 = self.addLink('s5','s15')
		lss6 = self.addLink('s6','s7')
		lss7 = self.addLink('s7','s8')
		lss8 = self.addLink('s7','s14')
		lss9 = self.addLink('s7','s16')
		lss10 = self.addLink('s7','s17')
		lss11 = self.addLink('s9','s10')
		lss12 = self.addLink('s9','s21')
		lss13 = self.addLink('s10','s11')
		lss14 = self.addLink('s10','s20')
		lss15 = self.addLink('s10','s13')
		lss16 = self.addLink('s11','s19')
		lss17 = self.addLink('s11','s12')
		lss18 = self.addLink('s11','s13')
		lss19 = self.addLink('s13','s14')
		lss20 = self.addLink('s13','s22')
		lss21 = self.addLink('s13','s23')
