...
class MininetNX( Topo ):
	def build( self ):
		...
		lss4 = self.addLink('s1','s18',**linkSSParameters)
		lss5 = self.addLink('s2','s3',**linkSSParameters)
		lss6 = self.addLink('s3','s19',**linkSSParameters)
		lss7 = self.addLink('s3','s4',**linkSSParameters)
		lss8 = self.addLink('s3','s5',**linkSSParameters)
		lss9 = self.addLink('s5','s6',**linkSSParameters)
		lss10 = self.addLink('s6','s8',**linkSSParameters)
		lss11 = self.addLink('s6','s20',**linkSSParameters)
		lss12 = self.addLink('s6','s7',**linkSSParameters)
		lss13 = self.addLink('s7','s10',**linkSSParameters)
		...
		lss17 = self.addLink('s10','s13',**linkSSParameters)
		lss18 = self.addLink('s11','s16',**linkSSParameters)
		lss19 = self.addLink('s11','s13',**linkSSParameters)
		lss20 = self.addLink('s12','s20',**linkSSParameters)
...
topos = { 'Packetexchange': ( lambda: MininetNX() ) }