...
class MininetNX( Topo ):
	def build( self ):
		...
		lss6 = self.addLink('s1','s10',**linkSSParameters)
		lss7 = self.addLink('s2','s3',**linkSSParameters)
		lss8 = self.addLink('s3','s8',**linkSSParameters)
		lss9 = self.addLink('s3','s4',**linkSSParameters)
		lss10 = self.addLink('s3','s7',**linkSSParameters)
		lss11 = self.addLink('s4','s10',**linkSSParameters)
