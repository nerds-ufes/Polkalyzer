...
class MininetNX( Topo ):
	def build( self ):
		...
		lss1 = self.addLink('s0','s5',**linkSSParameters)
		lss2 = self.addLink('s1','s2',**linkSSParameters)
		lss3 = self.addLink('s1','s6',**linkSSParameters)
		lss4 = self.addLink('s1','s7',**linkSSParameters)
		lss5 = self.addLink('s1','s10',**linkSSParameters)
		lss6 = self.addLink('s2','s3',**linkSSParameters)
