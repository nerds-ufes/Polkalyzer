...
class MininetNX( Topo ):
	def build( self ):
		...
		lss1 = self.addLink('s1','s22')
		lss2 = self.addLink('s2','s22')
		lss3 = self.addLink('s3','s22')
		lss4 = self.addLink('s4','s22')
		lss5 = self.addLink('s5','s6')
		lss6 = self.addLink('s5','s22')
		lss7 = self.addLink('s7','s8')
		lss8 = self.addLink('s7','s22')
		lss9 = self.addLink('s9','s10')
		lss10 = self.addLink('s9','s11')
		lss11 = self.addLink('s9','s12')
		lss12 = self.addLink('s10','s22')
		lss13 = self.addLink('s13','s14')
		lss14 = self.addLink('s13','s22')
		lss15 = self.addLink('s15','s23')
		lss16 = self.addLink('s16','s17')
		lss17 = self.addLink('s16','s22')
		lss18 = self.addLink('s18','s23')
		lss19 = self.addLink('s19','s20')
		lss20 = self.addLink('s19','s21')
		lss21 = self.addLink('s20','s23')
		lss22 = self.addLink('s22','s23')
