...
class MininetNX( Topo ):
	def build( self ):
		...
		lss6 = self.addLink('s5','s22',**linkSSParameters)
		lss7 = self.addLink('s7','s8',**linkSSParameters)
		lss8 = self.addLink('s7','s22',**linkSSParameters)
		...
		lss14 = self.addLink('s13','s22',**linkSSParameters)
		lss15 = self.addLink('s15','s23',**linkSSParameters)
		lss16 = self.addLink('s16','s17',**linkSSParameters)
		lss17 = self.addLink('s16','s22',**linkSSParameters)
