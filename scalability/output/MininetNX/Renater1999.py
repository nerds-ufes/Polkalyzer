...
class MininetNX( Topo ):
	def build( self ):
		...
		lss1 = self.addLink('s1','s22',**linkSSParameters)
		lss2 = self.addLink('s2','s22',**linkSSParameters)
		lss3 = self.addLink('s3','s22',**linkSSParameters)
		lss4 = self.addLink('s4','s22',**linkSSParameters)
		lss5 = self.addLink('s5','s22',**linkSSParameters)
		lss6 = self.addLink('s5','s6',**linkSSParameters)
		lss7 = self.addLink('s7','s22',**linkSSParameters)
		...
		lss12 = self.addLink('s10','s22',**linkSSParameters)
		lss13 = self.addLink('s13','s22',**linkSSParameters)
		lss14 = self.addLink('s13','s14',**linkSSParameters)
		lss15 = self.addLink('s15','s23',**linkSSParameters)
		lss16 = self.addLink('s16','s22',**linkSSParameters)
		lss17 = self.addLink('s16','s17',**linkSSParameters)
		lss18 = self.addLink('s18','s23',**linkSSParameters)
...
topos = { 'Renater1999': ( lambda: MininetNX() ) }