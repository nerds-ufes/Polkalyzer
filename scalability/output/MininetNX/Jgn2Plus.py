...
class MininetNX( Topo ):
	def build( self ):
		...
		lss5 = self.addLink('s2','s8',**linkSSParameters)
		lss6 = self.addLink('s2','s14',**linkSSParameters)
		lss7 = self.addLink('s2','s15',**linkSSParameters)
		lss8 = self.addLink('s2','s16',**linkSSParameters)
		...
		lss13 = self.addLink('s10','s17',**linkSSParameters)
