...
class MininetNX( Topo ):
	def build( self ):
		...
		lss3 = self.addLink('s0','s21',**linkSSParameters)
		lss4 = self.addLink('s0','s5',**linkSSParameters)
		lss5 = self.addLink('s1','s2',**linkSSParameters)
		lss6 = self.addLink('s1','s3',**linkSSParameters)
		...
		lss10 = self.addLink('s1','s14',**linkSSParameters)
		lss11 = self.addLink('s1','s15',**linkSSParameters)
		lss12 = self.addLink('s1','s17',**linkSSParameters)
		lss13 = self.addLink('s1','s18',**linkSSParameters)
		lss14 = self.addLink('s1','s20',**linkSSParameters)
		lss15 = self.addLink('s1','s22',**linkSSParameters)
		lss16 = self.addLink('s1','s23',**linkSSParameters)
		lss17 = self.addLink('s3','s5',**linkSSParameters)
		lss18 = self.addLink('s5','s6',**linkSSParameters)
		lss19 = self.addLink('s5','s7',**linkSSParameters)
		lss20 = self.addLink('s5','s11',**linkSSParameters)
		lss21 = self.addLink('s5','s15',**linkSSParameters)
		lss22 = self.addLink('s5','s16',**linkSSParameters)
		lss23 = self.addLink('s5','s17',**linkSSParameters)
		lss24 = self.addLink('s5','s19',**linkSSParameters)
		lss25 = self.addLink('s6','s7',**linkSSParameters)
		lss26 = self.addLink('s7','s8',**linkSSParameters)
		lss27 = self.addLink('s7','s9',**linkSSParameters)
		lss28 = self.addLink('s10','s17',**linkSSParameters)
		lss29 = self.addLink('s11','s17',**linkSSParameters)
		lss30 = self.addLink('s12','s17',**linkSSParameters)
		lss31 = self.addLink('s13','s16',**linkSSParameters)
		lss32 = self.addLink('s13','s17',**linkSSParameters)
		lss33 = self.addLink('s14','s17',**linkSSParameters)
		lss34 = self.addLink('s16','s17',**linkSSParameters)
		lss35 = self.addLink('s17','s18',**linkSSParameters)
		lss36 = self.addLink('s19','s20',**linkSSParameters)
		
topos = { 'BtEurope': ( lambda: MininetNX() ) }