...
class MininetNX( Topo ):
	def build( self ):
		...
		lss8 = self.addLink('s1','s12',**linkSSParameters)
		lss9 = self.addLink('s1','s14',**linkSSParameters)
		lss10 = self.addLink('s1','s15',**linkSSParameters)
		lss11 = self.addLink('s1','s17',**linkSSParameters)
		lss12 = self.addLink('s1','s18',**linkSSParameters)
		lss13 = self.addLink('s1','s20',**linkSSParameters)
		lss14 = self.addLink('s1','s22',**linkSSParameters)
		lss15 = self.addLink('s1','s23',**linkSSParameters)
		lss16 = self.addLink('s5','s11',**linkSSParameters)
		lss17 = self.addLink('s5','s16',**linkSSParameters)
		lss18 = self.addLink('s5','s19',**linkSSParameters)
		lss19 = self.addLink('s6','s7',**linkSSParameters)
		lss20 = self.addLink('s7','s8',**linkSSParameters)
		lss21 = self.addLink('s7','s9',**linkSSParameters)
		lss22 = self.addLink('s13','s17',**linkSSParameters)
