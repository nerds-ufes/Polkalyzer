...
class MininetNX( Topo ):
	def build( self ):
		...
		lss2 = self.addLink('s0','s7')
		lss3 = self.addLink('s0','s21')
		lss4 = self.addLink('s0','s5')
		lss5 = self.addLink('s1','s2')
		lss6 = self.addLink('s1','s3')
		lss7 = self.addLink('s1','s4')
		lss8 = self.addLink('s1','s5')
		lss9 = self.addLink('s1','s12')
		lss10 = self.addLink('s1','s14')
		lss11 = self.addLink('s1','s15')
		lss12 = self.addLink('s1','s17')
		lss13 = self.addLink('s1','s18')
		lss14 = self.addLink('s1','s20')
		lss15 = self.addLink('s1','s22')
		lss16 = self.addLink('s1','s23')
		lss17 = self.addLink('s3','s5')
		lss18 = self.addLink('s5','s6')
		lss19 = self.addLink('s5','s7')
		lss20 = self.addLink('s5','s11')
		lss21 = self.addLink('s5','s15')
		lss22 = self.addLink('s5','s16')
		lss23 = self.addLink('s5','s17')
		lss24 = self.addLink('s5','s19')
		lss25 = self.addLink('s6','s7')
		lss26 = self.addLink('s7','s8')
		lss27 = self.addLink('s7','s9')
		lss28 = self.addLink('s10','s17')
		lss29 = self.addLink('s11','s17')
		lss30 = self.addLink('s12','s17')
		lss31 = self.addLink('s13','s16')
		lss32 = self.addLink('s13','s17')
		lss33 = self.addLink('s14','s17')
		lss34 = self.addLink('s16','s17')
		lss35 = self.addLink('s17','s18')
		lss36 = self.addLink('s19','s20')
