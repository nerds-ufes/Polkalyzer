...
class MininetNX( Topo ):
	def build( self ):
		...
		lss0 = self.addLink('s0','s4')
		lss1 = self.addLink('s1','s4')
		lss2 = self.addLink('s2','s4')
		lss3 = self.addLink('s3','s13')
		lss4 = self.addLink('s4','s8')
		lss5 = self.addLink('s4','s10')
		lss6 = self.addLink('s4','s11')
		lss7 = self.addLink('s4','s13')
		lss8 = self.addLink('s4','s14')
		lss9 = self.addLink('s4','s15')
		lss10 = self.addLink('s4','s16')
		lss11 = self.addLink('s5','s24')
		lss12 = self.addLink('s6','s8')
		lss13 = self.addLink('s7','s8')
		lss14 = self.addLink('s8','s9')
		lss15 = self.addLink('s8','s17')
		lss16 = self.addLink('s8','s18')
		lss17 = self.addLink('s8','s19')
		lss18 = self.addLink('s8','s22')
		lss19 = self.addLink('s12','s13')
		lss20 = self.addLink('s13','s24')
		lss21 = self.addLink('s13','s26')
		lss22 = self.addLink('s13','s28')
		lss23 = self.addLink('s20','s22')
		lss24 = self.addLink('s21','s22')
		lss25 = self.addLink('s22','s33')
		lss26 = self.addLink('s22','s34')
		lss27 = self.addLink('s22','s35')
		lss28 = self.addLink('s22','s36')
		lss29 = self.addLink('s22','s37')
		lss30 = self.addLink('s22','s38')
		lss31 = self.addLink('s22','s42')
		lss32 = self.addLink('s22','s40')
		lss33 = self.addLink('s22','s24')
		lss34 = self.addLink('s22','s25')
		lss35 = self.addLink('s23','s24')
		lss36 = self.addLink('s24','s32')
		lss37 = self.addLink('s24','s39')
		lss38 = self.addLink('s24','s41')
		lss39 = self.addLink('s24','s27')
		lss40 = self.addLink('s24','s29')
		lss41 = self.addLink('s24','s30')
		lss42 = self.addLink('s24','s31')
