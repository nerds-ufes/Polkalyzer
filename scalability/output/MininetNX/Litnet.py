...
class MininetNX( Topo ):
	def build( self ):
		...
		lss2 = self.addLink('s2','s4',**linkSSParameters)
		lss3 = self.addLink('s3','s13',**linkSSParameters)
		lss4 = self.addLink('s4','s8',**linkSSParameters)
		lss5 = self.addLink('s4','s10',**linkSSParameters)
		lss6 = self.addLink('s4','s11',**linkSSParameters)
		lss7 = self.addLink('s4','s13',**linkSSParameters)
		lss8 = self.addLink('s4','s14',**linkSSParameters)
		lss9 = self.addLink('s4','s15',**linkSSParameters)
		lss10 = self.addLink('s4','s16',**linkSSParameters)
		lss11 = self.addLink('s5','s24',**linkSSParameters)
		lss12 = self.addLink('s6','s8',**linkSSParameters)
		lss13 = self.addLink('s7','s8',**linkSSParameters)
		lss14 = self.addLink('s8','s9',**linkSSParameters)
		lss15 = self.addLink('s8','s17',**linkSSParameters)
		lss16 = self.addLink('s8','s18',**linkSSParameters)
		lss17 = self.addLink('s8','s19',**linkSSParameters)
		lss18 = self.addLink('s8','s22',**linkSSParameters)
		lss19 = self.addLink('s12','s13',**linkSSParameters)
		lss20 = self.addLink('s13','s24',**linkSSParameters)
		lss21 = self.addLink('s13','s26',**linkSSParameters)
		lss22 = self.addLink('s13','s28',**linkSSParameters)
		lss23 = self.addLink('s20','s22',**linkSSParameters)
		lss24 = self.addLink('s21','s22',**linkSSParameters)
		lss25 = self.addLink('s22','s33',**linkSSParameters)
		lss26 = self.addLink('s22','s34',**linkSSParameters)
		lss27 = self.addLink('s22','s35',**linkSSParameters)
		lss28 = self.addLink('s22','s36',**linkSSParameters)
		lss29 = self.addLink('s22','s37',**linkSSParameters)
		lss30 = self.addLink('s22','s38',**linkSSParameters)
		lss31 = self.addLink('s22','s42',**linkSSParameters)
		lss32 = self.addLink('s22','s40',**linkSSParameters)
		lss33 = self.addLink('s22','s24',**linkSSParameters)
		lss34 = self.addLink('s22','s25',**linkSSParameters)
		lss35 = self.addLink('s23','s24',**linkSSParameters)
		lss36 = self.addLink('s24','s32',**linkSSParameters)
		lss37 = self.addLink('s24','s39',**linkSSParameters)
		lss38 = self.addLink('s24','s41',**linkSSParameters)
		lss39 = self.addLink('s24','s27',**linkSSParameters)
		lss40 = self.addLink('s24','s29',**linkSSParameters)
		lss41 = self.addLink('s24','s30',**linkSSParameters)
		lss42 = self.addLink('s24','s31',**linkSSParameters)
		
topos = { 'Litnet': ( lambda: MininetNX() ) }