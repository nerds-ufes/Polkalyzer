...
class MininetNX( Topo ):
	def build( self ):
		...
		lss33 = self.addLink('s22','s25',**linkSSParameters)
		lss34 = self.addLink('s23','s24',**linkSSParameters)
		lss35 = self.addLink('s24','s32',**linkSSParameters)
		lss36 = self.addLink('s24','s39',**linkSSParameters)
		lss37 = self.addLink('s24','s41',**linkSSParameters)
		lss38 = self.addLink('s24','s27',**linkSSParameters)
		lss39 = self.addLink('s24','s29',**linkSSParameters)
		lss40 = self.addLink('s24','s30',**linkSSParameters)
		lss41 = self.addLink('s24','s31',**linkSSParameters)
