...
class MininetNX( Topo ):
	def build( self ):
		...
		lhs88 = self.addLink('s46','h88',**linkHSParameters)
		lhs89 = self.addLink('s46','h89',**linkHSParameters)
		lhs90 = self.addLink('s47','h90',**linkHSParameters)
		lhs91 = self.addLink('s47','h91',**linkHSParameters)
		lhs92 = self.addLink('s48','h92',**linkHSParameters)
		lhs93 = self.addLink('s48','h93',**linkHSParameters)
		lhs94 = self.addLink('s49','h94',**linkHSParameters)
		lhs95 = self.addLink('s49','h95',**linkHSParameters)
		lhs96 = self.addLink('s50','h96',**linkHSParameters)
		lhs97 = self.addLink('s50','h97',**linkHSParameters)
		lhs98 = self.addLink('s51','h98',**linkHSParameters)
		lhs99 = self.addLink('s51','h99',**linkHSParameters)
		lhs100 = self.addLink('s52','h100',**linkHSParameters)
		lhs101 = self.addLink('s52','h101',**linkHSParameters)
		lhs102 = self.addLink('s53','h102',**linkHSParameters)
		lhs103 = self.addLink('s53','h103',**linkHSParameters)
		lhs104 = self.addLink('s54','h104',**linkHSParameters)
		lhs105 = self.addLink('s54','h105',**linkHSParameters)
		#Add a link of switches of original topology
		lss0 = self.addLink('s0','s17',**linkSSParameters)
		lss1 = self.addLink('s0','s2',**linkSSParameters)
		lss2 = self.addLink('s1','s2',**linkSSParameters)
		lss3 = self.addLink('s2','s3',**linkSSParameters)
		lss4 = self.addLink('s2','s41',**linkSSParameters)
		lss5 = self.addLink('s2','s11',**linkSSParameters)
		lss6 = self.addLink('s2','s13',**linkSSParameters)
		lss7 = self.addLink('s2','s14',**linkSSParameters)
		lss8 = self.addLink('s2','s46',**linkSSParameters)
		lss9 = self.addLink('s2','s28',**linkSSParameters)
		lss10 = self.addLink('s3','s23',**linkSSParameters)
		lss11 = self.addLink('s4','s32',**linkSSParameters)
		lss12 = self.addLink('s4','s5',**linkSSParameters)
		lss13 = self.addLink('s4','s6',**linkSSParameters)
		lss14 = self.addLink('s4','s47',**linkSSParameters)
		lss15 = self.addLink('s4','s23',**linkSSParameters)
		lss16 = self.addLink('s4','s26',**linkSSParameters)
		lss17 = self.addLink('s5','s8',**linkSSParameters)
		lss18 = self.addLink('s6','s10',**linkSSParameters)
		lss19 = self.addLink('s6','s51',**linkSSParameters)
		lss20 = self.addLink('s6','s7',**linkSSParameters)
		lss21 = self.addLink('s7','s8',**linkSSParameters)
		lss22 = self.addLink('s7','s30',**linkSSParameters)
		lss23 = self.addLink('s8','s9',**linkSSParameters)
		lss24 = self.addLink('s8','s41',**linkSSParameters)
		lss25 = self.addLink('s9','s10',**linkSSParameters)
		lss26 = self.addLink('s10','s11',**linkSSParameters)
		lss27 = self.addLink('s10','s41',**linkSSParameters)
		lss28 = self.addLink('s11','s36',**linkSSParameters)
		lss29 = self.addLink('s11','s37',**linkSSParameters)
		lss30 = self.addLink('s11','s38',**linkSSParameters)
		lss31 = self.addLink('s11','s12',**linkSSParameters)
		lss32 = self.addLink('s11','s49',**linkSSParameters)
		lss33 = self.addLink('s11','s29',**linkSSParameters)
		lss34 = self.addLink('s12','s13',**linkSSParameters)
		lss35 = self.addLink('s14','s40',**linkSSParameters)
		lss36 = self.addLink('s14','s39',**linkSSParameters)
		lss37 = self.addLink('s14','s54',**linkSSParameters)
		lss38 = self.addLink('s14','s15',**linkSSParameters)
		lss39 = self.addLink('s15','s16',**linkSSParameters)
		lss40 = self.addLink('s16','s17',**linkSSParameters)
		lss41 = self.addLink('s17','s34',**linkSSParameters)
		lss42 = self.addLink('s17','s35',**linkSSParameters)
		lss43 = self.addLink('s17','s18',**linkSSParameters)
		lss44 = self.addLink('s17','s53',**linkSSParameters)
		lss45 = self.addLink('s18','s19',**linkSSParameters)
		lss46 = self.addLink('s19','s42',**linkSSParameters)
		lss47 = self.addLink('s19','s43',**linkSSParameters)
		lss48 = self.addLink('s19','s20',**linkSSParameters)
		lss49 = self.addLink('s19','s21',**linkSSParameters)
		lss50 = self.addLink('s19','s23',**linkSSParameters)
		lss51 = self.addLink('s19','s52',**linkSSParameters)
		lss52 = self.addLink('s20','s21',**linkSSParameters)
		lss53 = self.addLink('s21','s22',**linkSSParameters)
		lss54 = self.addLink('s22','s24',**linkSSParameters)
		lss55 = self.addLink('s22','s23',**linkSSParameters)
		lss56 = self.addLink('s23','s48',**linkSSParameters)
		lss57 = self.addLink('s23','s24',**linkSSParameters)
		lss58 = self.addLink('s23','s25',**linkSSParameters)
		lss59 = self.addLink('s23','s31',**linkSSParameters)
		lss60 = self.addLink('s24','s25',**linkSSParameters)
		lss61 = self.addLink('s25','s27',**linkSSParameters)
		lss62 = self.addLink('s26','s33',**linkSSParameters)
		lss63 = self.addLink('s26','s50',**linkSSParameters)
		lss64 = self.addLink('s26','s27',**linkSSParameters)
