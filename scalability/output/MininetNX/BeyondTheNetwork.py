...
class MininetNX( Topo ):
	def build( self ):
		...
		lhs44 = self.addLink('s46','h44',**linkHSParameters)
		lhs45 = self.addLink('s47','h45',**linkHSParameters)
		lhs46 = self.addLink('s48','h46',**linkHSParameters)
		lhs47 = self.addLink('s49','h47',**linkHSParameters)
		lhs48 = self.addLink('s50','h48',**linkHSParameters)
		lhs49 = self.addLink('s51','h49',**linkHSParameters)
		lhs50 = self.addLink('s52','h50',**linkHSParameters)
		lhs51 = self.addLink('s53','h51',**linkHSParameters)
		lhs52 = self.addLink('s54','h52',**linkHSParameters)
		...
		lss11 = self.addLink('s4','s23',**linkSSParameters)
		lss12 = self.addLink('s4','s32',**linkSSParameters)
		lss13 = self.addLink('s4','s47',**linkSSParameters)
		lss14 = self.addLink('s4','s26',**linkSSParameters)
		lss15 = self.addLink('s5','s8',**linkSSParameters)
		lss16 = self.addLink('s6','s10',**linkSSParameters)
		lss17 = self.addLink('s6','s51',**linkSSParameters)
		lss18 = self.addLink('s7','s8',**linkSSParameters)
		lss19 = self.addLink('s7','s30',**linkSSParameters)
		lss20 = self.addLink('s8','s41',**linkSSParameters)
		lss21 = self.addLink('s8','s9',**linkSSParameters)
		lss22 = self.addLink('s10','s41',**linkSSParameters)
		lss23 = self.addLink('s11','s36',**linkSSParameters)
		lss24 = self.addLink('s11','s37',**linkSSParameters)
		lss25 = self.addLink('s11','s38',**linkSSParameters)
		lss26 = self.addLink('s11','s12',**linkSSParameters)
		lss27 = self.addLink('s11','s49',**linkSSParameters)
		lss28 = self.addLink('s11','s29',**linkSSParameters)
		lss29 = self.addLink('s14','s40',**linkSSParameters)
		lss30 = self.addLink('s14','s39',**linkSSParameters)
		lss31 = self.addLink('s14','s54',**linkSSParameters)
		lss32 = self.addLink('s15','s16',**linkSSParameters)
		lss33 = self.addLink('s16','s17',**linkSSParameters)
		lss34 = self.addLink('s17','s34',**linkSSParameters)
		lss35 = self.addLink('s17','s35',**linkSSParameters)
		lss36 = self.addLink('s17','s18',**linkSSParameters)
		lss37 = self.addLink('s17','s53',**linkSSParameters)
		lss38 = self.addLink('s18','s19',**linkSSParameters)
		lss39 = self.addLink('s19','s42',**linkSSParameters)
		lss40 = self.addLink('s19','s43',**linkSSParameters)
		lss41 = self.addLink('s19','s20',**linkSSParameters)
		lss42 = self.addLink('s19','s21',**linkSSParameters)
		lss43 = self.addLink('s19','s52',**linkSSParameters)
		lss44 = self.addLink('s22','s23',**linkSSParameters)
		lss45 = self.addLink('s23','s48',**linkSSParameters)
		lss46 = self.addLink('s23','s24',**linkSSParameters)
		lss47 = self.addLink('s23','s25',**linkSSParameters)
		lss48 = self.addLink('s23','s31',**linkSSParameters)
		lss49 = self.addLink('s25','s27',**linkSSParameters)
		lss50 = self.addLink('s26','s33',**linkSSParameters)
		lss51 = self.addLink('s26','s50',**linkSSParameters)
