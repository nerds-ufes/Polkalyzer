...
class MininetNX( Topo ):
	def build( self ):
		...
		lss2 = self.addLink('s1','s34',**linkSSParameters)
		...
		lss13 = self.addLink('s9','s38',**linkSSParameters)
		lss14 = self.addLink('s10','s39',**linkSSParameters)
		lss15 = self.addLink('s11','s12',**linkSSParameters)
		lss16 = self.addLink('s12','s13',**linkSSParameters)
		lss17 = self.addLink('s14','s15',**linkSSParameters)
		lss18 = self.addLink('s14','s16',**linkSSParameters)
		lss19 = self.addLink('s15','s18',**linkSSParameters)
		lss20 = self.addLink('s16','s17',**linkSSParameters)
		lss21 = self.addLink('s18','s26',**linkSSParameters)
		lss22 = self.addLink('s18','s19',**linkSSParameters)
		lss23 = self.addLink('s18','s21',**linkSSParameters)
		lss24 = self.addLink('s19','s35',**linkSSParameters)
		lss25 = self.addLink('s20','s21',**linkSSParameters)
		lss26 = self.addLink('s20','s36',**linkSSParameters)
		lss27 = self.addLink('s22','s23',**linkSSParameters)
		lss28 = self.addLink('s22','s40',**linkSSParameters)
		lss29 = self.addLink('s23','s24',**linkSSParameters)
		lss30 = self.addLink('s24','s25',**linkSSParameters)
		lss31 = self.addLink('s25','s33',**linkSSParameters)
		lss32 = self.addLink('s25','s41',**linkSSParameters)
		lss33 = self.addLink('s25','s26',**linkSSParameters)
		lss34 = self.addLink('s25','s27',**linkSSParameters)
		lss35 = self.addLink('s29','s31',**linkSSParameters)
		lss36 = self.addLink('s30','s31',**linkSSParameters)
		lss37 = self.addLink('s31','s32',**linkSSParameters)
		lss38 = self.addLink('s31','s34',**linkSSParameters)
		lss39 = self.addLink('s32','s33',**linkSSParameters)
		lss40 = self.addLink('s35','s37',**linkSSParameters)
