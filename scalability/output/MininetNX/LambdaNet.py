...
class MininetNX( Topo ):
	def build( self ):
		...
		lss0 = self.addLink('s0','s28')
		lss1 = self.addLink('s0','s31')
		lss2 = self.addLink('s1','s2')
		lss3 = self.addLink('s1','s34')
		lss4 = self.addLink('s2','s3')
		lss5 = self.addLink('s3','s4')
		lss6 = self.addLink('s4','s6')
		lss7 = self.addLink('s5','s6')
		lss8 = self.addLink('s5','s7')
		lss9 = self.addLink('s6','s13')
		lss10 = self.addLink('s7','s8')
		lss11 = self.addLink('s7','s39')
		lss12 = self.addLink('s8','s9')
		lss13 = self.addLink('s9','s10')
		lss14 = self.addLink('s9','s38')
		lss15 = self.addLink('s10','s39')
		lss16 = self.addLink('s11','s17')
		lss17 = self.addLink('s11','s12')
		lss18 = self.addLink('s11','s39')
		lss19 = self.addLink('s12','s13')
		lss20 = self.addLink('s14','s16')
		lss21 = self.addLink('s14','s15')
		lss22 = self.addLink('s15','s18')
		lss23 = self.addLink('s16','s17')
		lss24 = self.addLink('s18','s26')
		lss25 = self.addLink('s18','s19')
		lss26 = self.addLink('s18','s21')
		lss27 = self.addLink('s19','s35')
		lss28 = self.addLink('s20','s40')
		lss29 = self.addLink('s20','s36')
		lss30 = self.addLink('s20','s21')
		lss31 = self.addLink('s22','s40')
		lss32 = self.addLink('s22','s23')
		lss33 = self.addLink('s23','s24')
		lss34 = self.addLink('s24','s25')
		lss35 = self.addLink('s25','s41')
		lss36 = self.addLink('s25','s26')
		lss37 = self.addLink('s25','s27')
		lss38 = self.addLink('s25','s33')
		lss39 = self.addLink('s29','s31')
		lss40 = self.addLink('s30','s31')
		lss41 = self.addLink('s31','s32')
		lss42 = self.addLink('s31','s34')
		lss43 = self.addLink('s32','s33')
		lss44 = self.addLink('s35','s37')
		lss45 = self.addLink('s36','s37')
