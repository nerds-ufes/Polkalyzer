...
class MininetNX( Topo ):
	def build( self ):
		...
		lss6 = self.addLink('s1','s18',**linkSSParameters)
		...
		lss10 = self.addLink('s7','s14',**linkSSParameters)
		lss11 = self.addLink('s7','s16',**linkSSParameters)
		lss12 = self.addLink('s7','s17',**linkSSParameters)
