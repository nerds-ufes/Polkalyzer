...
class MininetNX( Topo ):
	def build( self ):
		...
		lss1 = self.addLink('s0','s27',**linkSSParameters)
		...
		lss10 = self.addLink('s7','s31',**linkSSParameters)
		...
		lss17 = self.addLink('s14','s17',**linkSSParameters)
		lss18 = self.addLink('s14','s18',**linkSSParameters)
		...
		lss23 = self.addLink('s18','s32',**linkSSParameters)
		lss24 = self.addLink('s18','s19',**linkSSParameters)
		lss25 = self.addLink('s19','s20',**linkSSParameters)
		lss26 = self.addLink('s20','s28',**linkSSParameters)
