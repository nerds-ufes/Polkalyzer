...
class MininetNX( Topo ):
	def build( self ):
		...
		lss14 = self.addLink('s14','s29',**linkSSParameters)
		lss15 = self.addLink('s14','s17',**linkSSParameters)
		lss16 = self.addLink('s14','s18',**linkSSParameters)
		lss17 = self.addLink('s14','s15',**linkSSParameters)
		lss18 = self.addLink('s16','s17',**linkSSParameters)
		lss19 = self.addLink('s18','s32',**linkSSParameters)
		lss20 = self.addLink('s18','s19',**linkSSParameters)
		lss21 = self.addLink('s20','s28',**linkSSParameters)
		lss22 = self.addLink('s20','s21',**linkSSParameters)
		lss23 = self.addLink('s22','s23',**linkSSParameters)
		lss24 = self.addLink('s23','s24',**linkSSParameters)
		lss25 = self.addLink('s24','s25',**linkSSParameters)
		lss26 = self.addLink('s25','s26',**linkSSParameters)
		lss27 = self.addLink('s25','s28',**linkSSParameters)
		lss28 = self.addLink('s26','s27',**linkSSParameters)
		lss29 = self.addLink('s27','s29',**linkSSParameters)
