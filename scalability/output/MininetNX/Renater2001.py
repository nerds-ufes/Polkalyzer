...
class MininetNX( Topo ):
	def build( self ):
		...
		lss2 = self.addLink('s1','s22')
		lss3 = self.addLink('s2','s22')
		lss4 = self.addLink('s3','s22')
		lss5 = self.addLink('s4','s22')
		lss6 = self.addLink('s5','s6')
		lss7 = self.addLink('s5','s22')
		lss8 = self.addLink('s7','s8')
		lss9 = self.addLink('s7','s22')
		lss10 = self.addLink('s8','s9')
		lss11 = self.addLink('s9','s11')
		lss12 = self.addLink('s9','s12')
		lss13 = self.addLink('s9','s22')
		lss14 = self.addLink('s10','s22')
		lss15 = self.addLink('s12','s13')
		lss16 = self.addLink('s13','s14')
		lss17 = self.addLink('s13','s23')
		lss18 = self.addLink('s14','s20')
		lss19 = self.addLink('s15','s23')
		lss20 = self.addLink('s16','s17')
		lss21 = self.addLink('s17','s23')
		lss22 = self.addLink('s18','s23')
		lss23 = self.addLink('s19','s20')
		lss24 = self.addLink('s19','s21')
		lss25 = self.addLink('s20','s23')
		lss26 = self.addLink('s22','s23')
