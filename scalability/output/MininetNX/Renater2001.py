...
class MininetNX( Topo ):
	def build( self ):
		...
		lss10 = self.addLink('s9','s22',**linkSSParameters)
		lss11 = self.addLink('s9','s11',**linkSSParameters)
		lss12 = self.addLink('s9','s12',**linkSSParameters)
		lss13 = self.addLink('s10','s22',**linkSSParameters)
		lss14 = self.addLink('s13','s23',**linkSSParameters)
		lss15 = self.addLink('s13','s14',**linkSSParameters)
		lss16 = self.addLink('s15','s23',**linkSSParameters)
		lss17 = self.addLink('s16','s17',**linkSSParameters)
		lss18 = self.addLink('s17','s23',**linkSSParameters)
		lss19 = self.addLink('s18','s23',**linkSSParameters)
