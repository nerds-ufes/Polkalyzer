...
class MininetNX( Topo ):
	def build( self ):
		...
		lss2 = self.addLink('s1','s22',**linkSSParameters)
		lss3 = self.addLink('s2','s22',**linkSSParameters)
		lss4 = self.addLink('s3','s22',**linkSSParameters)
		lss5 = self.addLink('s4','s22',**linkSSParameters)
		...
		lss9 = self.addLink('s7','s22',**linkSSParameters)
		...
		lss13 = self.addLink('s9','s22',**linkSSParameters)
		lss14 = self.addLink('s10','s22',**linkSSParameters)
		lss15 = self.addLink('s12','s13',**linkSSParameters)
		lss16 = self.addLink('s13','s14',**linkSSParameters)
		lss17 = self.addLink('s13','s23',**linkSSParameters)
		lss18 = self.addLink('s14','s20',**linkSSParameters)
		lss19 = self.addLink('s15','s23',**linkSSParameters)
		lss20 = self.addLink('s16','s17',**linkSSParameters)
		lss21 = self.addLink('s17','s23',**linkSSParameters)
		lss22 = self.addLink('s18','s23',**linkSSParameters)
		lss23 = self.addLink('s19','s20',**linkSSParameters)
		lss24 = self.addLink('s19','s21',**linkSSParameters)
		lss25 = self.addLink('s20','s23',**linkSSParameters)
		lss26 = self.addLink('s22','s23',**linkSSParameters)
		
topos = { 'Renater2001': ( lambda: MininetNX() ) }