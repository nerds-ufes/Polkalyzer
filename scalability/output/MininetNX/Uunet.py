...
class MininetNX( Topo ):
	def build( self ):
		...
		lss11 = self.addLink('s4','s19',**linkSSParameters)
		lss12 = self.addLink('s4','s23',**linkSSParameters)
		lss13 = self.addLink('s4','s27',**linkSSParameters)
		lss14 = self.addLink('s6','s47',**linkSSParameters)
		lss15 = self.addLink('s7','s41',**linkSSParameters)
		lss16 = self.addLink('s8','s9',**linkSSParameters)
		lss17 = self.addLink('s8','s10',**linkSSParameters)
		lss18 = self.addLink('s8','s11',**linkSSParameters)
		lss19 = self.addLink('s8','s48',**linkSSParameters)
		lss20 = self.addLink('s11','s12',**linkSSParameters)
		lss21 = self.addLink('s12','s16',**linkSSParameters)
		lss22 = self.addLink('s12','s13',**linkSSParameters)
		lss23 = self.addLink('s14','s15',**linkSSParameters)
		lss24 = self.addLink('s15','s48',**linkSSParameters)
		lss25 = self.addLink('s16','s40',**linkSSParameters)
		lss26 = self.addLink('s16','s17',**linkSSParameters)
		lss27 = self.addLink('s18','s19',**linkSSParameters)
		lss28 = self.addLink('s19','s38',**linkSSParameters)
		lss29 = self.addLink('s19','s39',**linkSSParameters)
		lss30 = self.addLink('s19','s20',**linkSSParameters)
		lss31 = self.addLink('s21','s45',**linkSSParameters)
		lss32 = self.addLink('s21','s34',**linkSSParameters)
		lss33 = self.addLink('s21','s36',**linkSSParameters)
		lss34 = self.addLink('s22','s23',**linkSSParameters)
		lss35 = self.addLink('s23','s24',**linkSSParameters)
		lss36 = self.addLink('s23','s26',**linkSSParameters)
		lss37 = self.addLink('s25','s32',**linkSSParameters)
		lss38 = self.addLink('s30','s31',**linkSSParameters)
		lss39 = self.addLink('s31','s32',**linkSSParameters)
		lss40 = self.addLink('s32','s33',**linkSSParameters)
		lss41 = self.addLink('s34','s35',**linkSSParameters)
		lss42 = self.addLink('s36','s37',**linkSSParameters)
		lss43 = self.addLink('s41','s48',**linkSSParameters)
		lss44 = self.addLink('s41','s42',**linkSSParameters)
		lss45 = self.addLink('s41','s43',**linkSSParameters)
		lss46 = self.addLink('s44','s45',**linkSSParameters)
		lss47 = self.addLink('s46','s47',**linkSSParameters)
