...
class MininetNX( Topo ):
	def build( self ):
		...
		lss0 = self.addLink('s0','s8')
		lss1 = self.addLink('s0','s1')
		lss2 = self.addLink('s0','s29')
		lss3 = self.addLink('s1','s2')
		lss4 = self.addLink('s2','s3')
		lss5 = self.addLink('s2','s4')
		lss6 = self.addLink('s2','s45')
		lss7 = self.addLink('s2','s47')
		lss8 = self.addLink('s2','s28')
		lss9 = self.addLink('s2','s31')
		lss10 = self.addLink('s3','s4')
		lss11 = self.addLink('s4','s5')
		lss12 = self.addLink('s4','s45')
		lss13 = self.addLink('s4','s47')
		lss14 = self.addLink('s4','s16')
		lss15 = self.addLink('s4','s19')
		lss16 = self.addLink('s4','s23')
		lss17 = self.addLink('s4','s27')
		lss18 = self.addLink('s4','s31')
		lss19 = self.addLink('s5','s6')
		lss20 = self.addLink('s6','s22')
		lss21 = self.addLink('s6','s47')
		lss22 = self.addLink('s7','s41')
		lss23 = self.addLink('s7','s45')
		lss24 = self.addLink('s8','s9')
		lss25 = self.addLink('s8','s10')
		lss26 = self.addLink('s8','s11')
		lss27 = self.addLink('s8','s48')
		lss28 = self.addLink('s11','s12')
		lss29 = self.addLink('s12','s16')
		lss30 = self.addLink('s12','s13')
		lss31 = self.addLink('s14','s16')
		lss32 = self.addLink('s14','s19')
		lss33 = self.addLink('s14','s15')
		lss34 = self.addLink('s15','s48')
		lss35 = self.addLink('s16','s40')
		lss36 = self.addLink('s16','s41')
		lss37 = self.addLink('s16','s45')
		lss38 = self.addLink('s16','s17')
		lss39 = self.addLink('s16','s31')
		lss40 = self.addLink('s17','s18')
		lss41 = self.addLink('s18','s19')
		lss42 = self.addLink('s19','s32')
		lss43 = self.addLink('s19','s38')
		lss44 = self.addLink('s19','s39')
		lss45 = self.addLink('s19','s43')
		lss46 = self.addLink('s19','s45')
		lss47 = self.addLink('s19','s47')
		lss48 = self.addLink('s19','s20')
		lss49 = self.addLink('s19','s21')
		lss50 = self.addLink('s19','s23')
		lss51 = self.addLink('s19','s31')
		lss52 = self.addLink('s20','s21')
		lss53 = self.addLink('s21','s34')
		lss54 = self.addLink('s21','s36')
		lss55 = self.addLink('s21','s45')
		lss56 = self.addLink('s21','s31')
		lss57 = self.addLink('s22','s25')
		lss58 = self.addLink('s22','s23')
		lss59 = self.addLink('s23','s24')
		lss60 = self.addLink('s23','s26')
		lss61 = self.addLink('s23','s31')
		lss62 = self.addLink('s24','s25')
		lss63 = self.addLink('s25','s32')
		lss64 = self.addLink('s30','s32')
		lss65 = self.addLink('s30','s31')
		lss66 = self.addLink('s31','s32')
		lss67 = self.addLink('s31','s45')
		lss68 = self.addLink('s31','s47')
		lss69 = self.addLink('s32','s33')
		lss70 = self.addLink('s32','s36')
		lss71 = self.addLink('s33','s35')
		lss72 = self.addLink('s33','s36')
		lss73 = self.addLink('s34','s35')
		lss74 = self.addLink('s35','s36')
		lss75 = self.addLink('s36','s37')
		lss76 = self.addLink('s41','s48')
		lss77 = self.addLink('s41','s42')
		lss78 = self.addLink('s41','s43')
		lss79 = self.addLink('s42','s45')
		lss80 = self.addLink('s44','s45')
		lss81 = self.addLink('s44','s46')
		lss82 = self.addLink('s45','s47')
		lss83 = self.addLink('s46','s47')
