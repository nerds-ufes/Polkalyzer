...
class MininetNX( Topo ):
	def build( self ):
		...
		lss2 = self.addLink('s0','s29',**linkSSParameters)
		lss3 = self.addLink('s1','s2',**linkSSParameters)
		lss4 = self.addLink('s2','s3',**linkSSParameters)
		lss5 = self.addLink('s2','s4',**linkSSParameters)
		lss6 = self.addLink('s2','s45',**linkSSParameters)
		lss7 = self.addLink('s2','s47',**linkSSParameters)
		lss8 = self.addLink('s2','s28',**linkSSParameters)
		lss9 = self.addLink('s2','s31',**linkSSParameters)
		lss10 = self.addLink('s3','s4',**linkSSParameters)
		lss11 = self.addLink('s4','s5',**linkSSParameters)
		lss12 = self.addLink('s4','s45',**linkSSParameters)
		lss13 = self.addLink('s4','s47',**linkSSParameters)
		lss14 = self.addLink('s4','s16',**linkSSParameters)
		lss15 = self.addLink('s4','s19',**linkSSParameters)
		lss16 = self.addLink('s4','s23',**linkSSParameters)
		lss17 = self.addLink('s4','s27',**linkSSParameters)
		lss18 = self.addLink('s4','s31',**linkSSParameters)
		lss19 = self.addLink('s5','s6',**linkSSParameters)
		lss20 = self.addLink('s6','s22',**linkSSParameters)
		lss21 = self.addLink('s6','s47',**linkSSParameters)
		lss22 = self.addLink('s7','s41',**linkSSParameters)
		lss23 = self.addLink('s7','s45',**linkSSParameters)
		lss24 = self.addLink('s8','s9',**linkSSParameters)
		lss25 = self.addLink('s8','s10',**linkSSParameters)
		lss26 = self.addLink('s8','s11',**linkSSParameters)
		lss27 = self.addLink('s8','s48',**linkSSParameters)
		lss28 = self.addLink('s11','s12',**linkSSParameters)
		lss29 = self.addLink('s12','s16',**linkSSParameters)
		lss30 = self.addLink('s12','s13',**linkSSParameters)
		lss31 = self.addLink('s14','s16',**linkSSParameters)
		lss32 = self.addLink('s14','s19',**linkSSParameters)
		lss33 = self.addLink('s14','s15',**linkSSParameters)
		lss34 = self.addLink('s15','s48',**linkSSParameters)
		lss35 = self.addLink('s16','s40',**linkSSParameters)
		lss36 = self.addLink('s16','s41',**linkSSParameters)
		lss37 = self.addLink('s16','s45',**linkSSParameters)
		lss38 = self.addLink('s16','s17',**linkSSParameters)
		lss39 = self.addLink('s16','s31',**linkSSParameters)
		lss40 = self.addLink('s17','s18',**linkSSParameters)
		lss41 = self.addLink('s18','s19',**linkSSParameters)
		lss42 = self.addLink('s19','s32',**linkSSParameters)
		lss43 = self.addLink('s19','s38',**linkSSParameters)
		lss44 = self.addLink('s19','s39',**linkSSParameters)
		lss45 = self.addLink('s19','s43',**linkSSParameters)
		lss46 = self.addLink('s19','s45',**linkSSParameters)
		lss47 = self.addLink('s19','s47',**linkSSParameters)
		...
		lss51 = self.addLink('s19','s31',**linkSSParameters)
		lss52 = self.addLink('s20','s21',**linkSSParameters)
		lss53 = self.addLink('s21','s34',**linkSSParameters)
		lss54 = self.addLink('s21','s36',**linkSSParameters)
		lss55 = self.addLink('s21','s45',**linkSSParameters)
		lss56 = self.addLink('s21','s31',**linkSSParameters)
		lss57 = self.addLink('s22','s25',**linkSSParameters)
		lss58 = self.addLink('s22','s23',**linkSSParameters)
		lss59 = self.addLink('s23','s24',**linkSSParameters)
		lss60 = self.addLink('s23','s26',**linkSSParameters)
		lss61 = self.addLink('s23','s31',**linkSSParameters)
		lss62 = self.addLink('s24','s25',**linkSSParameters)
		lss63 = self.addLink('s25','s32',**linkSSParameters)
		lss64 = self.addLink('s30','s32',**linkSSParameters)
		lss65 = self.addLink('s30','s31',**linkSSParameters)
		lss66 = self.addLink('s31','s32',**linkSSParameters)
		lss67 = self.addLink('s31','s45',**linkSSParameters)
		lss68 = self.addLink('s31','s47',**linkSSParameters)
		lss69 = self.addLink('s32','s33',**linkSSParameters)
		lss70 = self.addLink('s32','s36',**linkSSParameters)
		lss71 = self.addLink('s33','s35',**linkSSParameters)
		lss72 = self.addLink('s33','s36',**linkSSParameters)
		lss73 = self.addLink('s34','s35',**linkSSParameters)
		lss74 = self.addLink('s35','s36',**linkSSParameters)
		lss75 = self.addLink('s36','s37',**linkSSParameters)
		lss76 = self.addLink('s41','s48',**linkSSParameters)
		lss77 = self.addLink('s41','s42',**linkSSParameters)
		lss78 = self.addLink('s41','s43',**linkSSParameters)
		lss79 = self.addLink('s42','s45',**linkSSParameters)
		lss80 = self.addLink('s44','s45',**linkSSParameters)
		lss81 = self.addLink('s44','s46',**linkSSParameters)
		lss82 = self.addLink('s45','s47',**linkSSParameters)
		lss83 = self.addLink('s46','s47',**linkSSParameters)
		
topos = { 'Uunet': ( lambda: MininetNX() ) }