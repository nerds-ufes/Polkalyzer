...
class MininetNX( Topo ):
	def build( self ):
		...
		lss3 = self.addLink('s1','s14')
		lss4 = self.addLink('s2','s3')
		lss5 = self.addLink('s3','s51')
		lss6 = self.addLink('s3','s4')
		lss7 = self.addLink('s3','s5')
		lss8 = self.addLink('s3','s6')
		lss9 = self.addLink('s4','s6')
		lss10 = self.addLink('s6','s8')
		lss11 = self.addLink('s7','s8')
		lss12 = self.addLink('s7','s14')
		lss13 = self.addLink('s8','s10')
		lss14 = self.addLink('s9','s10')
		lss15 = self.addLink('s9','s13')
		lss16 = self.addLink('s10','s11')
		lss17 = self.addLink('s10','s49')
		lss18 = self.addLink('s11','s12')
		lss19 = self.addLink('s11','s13')
		lss20 = self.addLink('s12','s49')
		lss21 = self.addLink('s12','s50')
		lss22 = self.addLink('s14','s51')
		lss23 = self.addLink('s14','s17')
		lss24 = self.addLink('s14','s45')
		lss25 = self.addLink('s15','s16')
		lss26 = self.addLink('s15','s18')
		lss27 = self.addLink('s16','s17')
		lss28 = self.addLink('s16','s19')
		lss29 = self.addLink('s17','s45')
		lss30 = self.addLink('s18','s23')
		lss31 = self.addLink('s18','s19')
		lss32 = self.addLink('s19','s51')
		lss33 = self.addLink('s19','s22')
		lss34 = self.addLink('s20','s43')
		lss35 = self.addLink('s20','s21')
		lss36 = self.addLink('s21','s51')
		lss37 = self.addLink('s21','s22')
		lss38 = self.addLink('s22','s27')
		lss39 = self.addLink('s22','s51')
		lss40 = self.addLink('s23','s24')
		lss41 = self.addLink('s24','s25')
		lss42 = self.addLink('s25','s26')
		lss43 = self.addLink('s26','s27')
		lss44 = self.addLink('s27','s54')
		lss45 = self.addLink('s27','s29')
		lss46 = self.addLink('s28','s29')
		lss47 = self.addLink('s28','s54')
		lss48 = self.addLink('s29','s30')
		lss49 = self.addLink('s30','s52')
		lss50 = self.addLink('s30','s54')
		lss51 = self.addLink('s30','s31')
		lss52 = self.addLink('s31','s32')
		lss53 = self.addLink('s32','s33')
		lss54 = self.addLink('s32','s34')
		lss55 = self.addLink('s33','s34')
		lss56 = self.addLink('s33','s52')
		lss57 = self.addLink('s33','s53')
		lss58 = self.addLink('s34','s35')
		lss59 = self.addLink('s35','s36')
		lss60 = self.addLink('s35','s37')
		lss61 = self.addLink('s36','s42')
		lss62 = self.addLink('s37','s38')
		lss63 = self.addLink('s38','s53')
		lss64 = self.addLink('s38','s39')
		lss65 = self.addLink('s39','s40')
		lss66 = self.addLink('s40','s41')
		lss67 = self.addLink('s41','s42')
		lss68 = self.addLink('s43','s44')
		lss69 = self.addLink('s43','s51')
		lss70 = self.addLink('s43','s46')
		lss71 = self.addLink('s44','s45')
		lss72 = self.addLink('s44','s46')
		lss73 = self.addLink('s44','s47')
		lss74 = self.addLink('s45','s49')
		lss75 = self.addLink('s46','s51')
		lss76 = self.addLink('s47','s48')
		lss77 = self.addLink('s47','s49')
		lss78 = self.addLink('s48','s49')
		lss79 = self.addLink('s48','s50')
		lss80 = self.addLink('s52','s53')
