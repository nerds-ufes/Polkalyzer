...
class MininetNX( Topo ):
	def build( self ):
		...
		lss8 = self.addLink('s1','s2',**linkSSParameters)
		lss9 = self.addLink('s1','s3',**linkSSParameters)
		lss10 = self.addLink('s1','s4',**linkSSParameters)
		lss11 = self.addLink('s1','s5',**linkSSParameters)
		lss12 = self.addLink('s1','s6',**linkSSParameters)
		lss13 = self.addLink('s1','s7',**linkSSParameters)
		lss14 = self.addLink('s1','s8',**linkSSParameters)
		lss15 = self.addLink('s2','s3',**linkSSParameters)
		lss16 = self.addLink('s2','s4',**linkSSParameters)
		lss17 = self.addLink('s2','s5',**linkSSParameters)
		lss18 = self.addLink('s2','s6',**linkSSParameters)
		lss19 = self.addLink('s2','s7',**linkSSParameters)
		lss20 = self.addLink('s2','s8',**linkSSParameters)
		lss21 = self.addLink('s3','s4',**linkSSParameters)
		lss22 = self.addLink('s3','s5',**linkSSParameters)
		lss23 = self.addLink('s3','s6',**linkSSParameters)
		lss24 = self.addLink('s3','s7',**linkSSParameters)
		lss25 = self.addLink('s3','s8',**linkSSParameters)
		lss26 = self.addLink('s4','s5',**linkSSParameters)
		lss27 = self.addLink('s4','s6',**linkSSParameters)
		lss28 = self.addLink('s4','s7',**linkSSParameters)
		lss29 = self.addLink('s4','s8',**linkSSParameters)
		lss30 = self.addLink('s5','s6',**linkSSParameters)
		lss31 = self.addLink('s5','s7',**linkSSParameters)
		lss32 = self.addLink('s5','s8',**linkSSParameters)
		lss33 = self.addLink('s6','s7',**linkSSParameters)
		lss34 = self.addLink('s6','s8',**linkSSParameters)
		lss35 = self.addLink('s7','s8',**linkSSParameters)
