...
class MininetNX( Topo ):
	def build( self ):
		...
		lss1 = self.addLink('s0','s21',**linkSSParameters)
		lss2 = self.addLink('s0','s15',**linkSSParameters)
		lss3 = self.addLink('s2','s20',**linkSSParameters)
		lss4 = self.addLink('s3','s16',**linkSSParameters)
		lss5 = self.addLink('s3','s4',**linkSSParameters)
		lss6 = self.addLink('s4','s22',**linkSSParameters)
		...
		lss12 = self.addLink('s8','s19',**linkSSParameters)
		lss13 = self.addLink('s9','s10',**linkSSParameters)
		lss14 = self.addLink('s11','s12',**linkSSParameters)
		lss15 = self.addLink('s11','s13',**linkSSParameters)
		lss16 = self.addLink('s12','s20',**linkSSParameters)
		lss17 = self.addLink('s13','s23',**linkSSParameters)
		lss18 = self.addLink('s14','s17',**linkSSParameters)
		...
		lss22 = self.addLink('s20','s22',**linkSSParameters)
