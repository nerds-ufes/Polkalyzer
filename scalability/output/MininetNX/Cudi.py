...
class MininetNX( Topo ):
	def build( self ):
		...
		lss5 = self.addLink('s1','s43',**linkSSParameters)
		lss6 = self.addLink('s1','s4',**linkSSParameters)
		lss7 = self.addLink('s2','s5',**linkSSParameters)
		lss8 = self.addLink('s2','s44',**linkSSParameters)
		lss9 = self.addLink('s2','s17',**linkSSParameters)
		lss10 = self.addLink('s2','s29',**linkSSParameters)
		lss11 = self.addLink('s3','s10',**linkSSParameters)
		lss12 = self.addLink('s3','s11',**linkSSParameters)
		lss13 = self.addLink('s4','s8',**linkSSParameters)
		lss14 = self.addLink('s4','s7',**linkSSParameters)
		...
		lss20 = self.addLink('s12','s15',**linkSSParameters)
		lss21 = self.addLink('s17','s18',**linkSSParameters)
		lss22 = self.addLink('s17','s19',**linkSSParameters)
		lss23 = self.addLink('s17','s20',**linkSSParameters)
		lss24 = self.addLink('s17','s21',**linkSSParameters)
		lss25 = self.addLink('s17','s23',**linkSSParameters)
		lss26 = self.addLink('s17','s24',**linkSSParameters)
		lss27 = self.addLink('s17','s25',**linkSSParameters)
		lss28 = self.addLink('s17','s26',**linkSSParameters)
		lss29 = self.addLink('s17','s27',**linkSSParameters)
		lss30 = self.addLink('s17','s28',**linkSSParameters)
		lss31 = self.addLink('s22','s29',**linkSSParameters)
		lss32 = self.addLink('s29','s32',**linkSSParameters)
		lss33 = self.addLink('s29','s33',**linkSSParameters)
		lss34 = self.addLink('s29','s35',**linkSSParameters)
		lss35 = self.addLink('s29','s36',**linkSSParameters)
		lss36 = self.addLink('s29','s37',**linkSSParameters)
		lss37 = self.addLink('s29','s38',**linkSSParameters)
		lss38 = self.addLink('s29','s39',**linkSSParameters)
		lss39 = self.addLink('s29','s34',**linkSSParameters)
		lss40 = self.addLink('s29','s30',**linkSSParameters)
		lss41 = self.addLink('s29','s31',**linkSSParameters)
		lss42 = self.addLink('s30','s40',**linkSSParameters)
		lss43 = self.addLink('s31','s41',**linkSSParameters)
		lss44 = self.addLink('s32','s42',**linkSSParameters)
		lss45 = self.addLink('s44','s45',**linkSSParameters)
		lss46 = self.addLink('s44','s46',**linkSSParameters)
		lss47 = self.addLink('s44','s47',**linkSSParameters)
		lss48 = self.addLink('s44','s48',**linkSSParameters)
		lss49 = self.addLink('s44','s49',**linkSSParameters)
