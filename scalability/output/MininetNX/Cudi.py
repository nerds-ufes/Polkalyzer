...
class MininetNX( Topo ):
	def build( self ):
		...
		lss3 = self.addLink('s0','s12')
		lss4 = self.addLink('s0','s50')
		lss5 = self.addLink('s1','s2')
		lss6 = self.addLink('s1','s43')
		lss7 = self.addLink('s1','s4')
		lss8 = self.addLink('s2','s5')
		lss9 = self.addLink('s2','s44')
		lss10 = self.addLink('s2','s17')
		lss11 = self.addLink('s2','s29')
		lss12 = self.addLink('s3','s10')
		lss13 = self.addLink('s3','s11')
		lss14 = self.addLink('s4','s8')
		lss15 = self.addLink('s4','s7')
		lss16 = self.addLink('s6','s7')
		lss17 = self.addLink('s8','s9')
		lss18 = self.addLink('s9','s10')
		lss19 = self.addLink('s12','s16')
		lss20 = self.addLink('s12','s13')
		lss21 = self.addLink('s12','s14')
		lss22 = self.addLink('s12','s15')
		lss23 = self.addLink('s17','s18')
		lss24 = self.addLink('s17','s19')
		lss25 = self.addLink('s17','s20')
		lss26 = self.addLink('s17','s21')
		lss27 = self.addLink('s17','s23')
		lss28 = self.addLink('s17','s24')
		lss29 = self.addLink('s17','s25')
		lss30 = self.addLink('s17','s26')
		lss31 = self.addLink('s17','s27')
		lss32 = self.addLink('s17','s28')
		lss33 = self.addLink('s22','s29')
		lss34 = self.addLink('s29','s32')
		lss35 = self.addLink('s29','s33')
		lss36 = self.addLink('s29','s35')
		lss37 = self.addLink('s29','s36')
		lss38 = self.addLink('s29','s37')
		lss39 = self.addLink('s29','s38')
		lss40 = self.addLink('s29','s39')
		lss41 = self.addLink('s29','s34')
		lss42 = self.addLink('s29','s30')
		lss43 = self.addLink('s29','s31')
		lss44 = self.addLink('s30','s40')
		lss45 = self.addLink('s31','s41')
		lss46 = self.addLink('s32','s42')
		lss47 = self.addLink('s44','s45')
		lss48 = self.addLink('s44','s46')
		lss49 = self.addLink('s44','s47')
		lss50 = self.addLink('s44','s48')
		lss51 = self.addLink('s44','s49')
