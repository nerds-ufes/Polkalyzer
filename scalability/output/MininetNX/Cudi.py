...
class MininetNX( Topo ):
	def build( self ):
		...
		lss3 = self.addLink('s0','s12',**linkSSParameters)
		lss4 = self.addLink('s0','s50',**linkSSParameters)
		lss5 = self.addLink('s1','s2',**linkSSParameters)
		lss6 = self.addLink('s1','s43',**linkSSParameters)
		lss7 = self.addLink('s1','s4',**linkSSParameters)
		lss8 = self.addLink('s2','s5',**linkSSParameters)
		lss9 = self.addLink('s2','s44',**linkSSParameters)
		lss10 = self.addLink('s2','s17',**linkSSParameters)
		lss11 = self.addLink('s2','s29',**linkSSParameters)
		lss12 = self.addLink('s3','s10',**linkSSParameters)
		lss13 = self.addLink('s3','s11',**linkSSParameters)
		lss14 = self.addLink('s4','s8',**linkSSParameters)
		lss15 = self.addLink('s4','s7',**linkSSParameters)
		lss16 = self.addLink('s6','s7',**linkSSParameters)
		lss17 = self.addLink('s8','s9',**linkSSParameters)
		lss18 = self.addLink('s9','s10',**linkSSParameters)
		lss19 = self.addLink('s12','s16',**linkSSParameters)
		lss20 = self.addLink('s12','s13',**linkSSParameters)
		lss21 = self.addLink('s12','s14',**linkSSParameters)
		...
		lss25 = self.addLink('s17','s20',**linkSSParameters)
		lss26 = self.addLink('s17','s21',**linkSSParameters)
		lss27 = self.addLink('s17','s23',**linkSSParameters)
		lss28 = self.addLink('s17','s24',**linkSSParameters)
		lss29 = self.addLink('s17','s25',**linkSSParameters)
		lss30 = self.addLink('s17','s26',**linkSSParameters)
		lss31 = self.addLink('s17','s27',**linkSSParameters)
		lss32 = self.addLink('s17','s28',**linkSSParameters)
		lss33 = self.addLink('s22','s29',**linkSSParameters)
		lss34 = self.addLink('s29','s32',**linkSSParameters)
		lss35 = self.addLink('s29','s33',**linkSSParameters)
		lss36 = self.addLink('s29','s35',**linkSSParameters)
		lss37 = self.addLink('s29','s36',**linkSSParameters)
		lss38 = self.addLink('s29','s37',**linkSSParameters)
		lss39 = self.addLink('s29','s38',**linkSSParameters)
		lss40 = self.addLink('s29','s39',**linkSSParameters)
		lss41 = self.addLink('s29','s34',**linkSSParameters)
		lss42 = self.addLink('s29','s30',**linkSSParameters)
		lss43 = self.addLink('s29','s31',**linkSSParameters)
		lss44 = self.addLink('s30','s40',**linkSSParameters)
		lss45 = self.addLink('s31','s41',**linkSSParameters)
		lss46 = self.addLink('s32','s42',**linkSSParameters)
		lss47 = self.addLink('s44','s45',**linkSSParameters)
		lss48 = self.addLink('s44','s46',**linkSSParameters)
		lss49 = self.addLink('s44','s47',**linkSSParameters)
		lss50 = self.addLink('s44','s48',**linkSSParameters)
		lss51 = self.addLink('s44','s49',**linkSSParameters)
		
topos = { 'Cudi': ( lambda: MininetNX() ) }