...
class MininetNX( Topo ):
	def build( self ):
		...
		lss8 = self.addLink('s5','s17',**linkSSParameters)
		...
		lss12 = self.addLink('s7','s9',**linkSSParameters)
		lss13 = self.addLink('s8','s16',**linkSSParameters)
		lss14 = self.addLink('s9','s10',**linkSSParameters)
		lss15 = self.addLink('s10','s16',**linkSSParameters)
		lss16 = self.addLink('s10','s11',**linkSSParameters)
		lss17 = self.addLink('s11','s12',**linkSSParameters)
		lss18 = self.addLink('s12','s15',**linkSSParameters)
		lss19 = self.addLink('s13','s17',**linkSSParameters)
