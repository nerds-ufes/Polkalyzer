...
class MininetNX( Topo ):
	def build( self ):
		...
		lss11 = self.addLink('s8','s15',**linkSSParameters)
		lss12 = self.addLink('s9','s10',**linkSSParameters)
		lss13 = self.addLink('s9','s11',**linkSSParameters)
		lss14 = self.addLink('s10','s15',**linkSSParameters)
		lss15 = self.addLink('s11','s12',**linkSSParameters)
		lss16 = self.addLink('s12','s13',**linkSSParameters)
		lss17 = self.addLink('s12','s15',**linkSSParameters)
		lss18 = self.addLink('s13','s14',**linkSSParameters)
		lss19 = self.addLink('s14','s17',**linkSSParameters)
		...
		lss23 = self.addLink('s17','s23',**linkSSParameters)
		lss24 = self.addLink('s18','s19',**linkSSParameters)
		lss25 = self.addLink('s18','s22',**linkSSParameters)
		lss26 = self.addLink('s19','s34',**linkSSParameters)
		lss27 = self.addLink('s20','s34',**linkSSParameters)
		lss28 = self.addLink('s21','s24',**linkSSParameters)
		lss29 = self.addLink('s22','s23',**linkSSParameters)
		lss30 = self.addLink('s24','s25',**linkSSParameters)
		lss31 = self.addLink('s25','s26',**linkSSParameters)
		lss32 = self.addLink('s26','s27',**linkSSParameters)
		lss33 = self.addLink('s27','s28',**linkSSParameters)
		lss34 = self.addLink('s28','s29',**linkSSParameters)
		lss35 = self.addLink('s29','s30',**linkSSParameters)
		lss36 = self.addLink('s30','s31',**linkSSParameters)
		lss37 = self.addLink('s31','s32',**linkSSParameters)
		lss38 = self.addLink('s32','s33',**linkSSParameters)
		
topos = { 'NetworkUsa': ( lambda: MininetNX() ) }