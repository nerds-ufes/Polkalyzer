...
class MininetNX( Topo ):
	def build( self ):
		...
		lss10 = self.addLink('s8','s15',**linkSSParameters)
		...
		lss16 = self.addLink('s13','s14',**linkSSParameters)
		lss17 = self.addLink('s15','s16',**linkSSParameters)
		lss18 = self.addLink('s16','s17',**linkSSParameters)
		lss19 = self.addLink('s17','s25',**linkSSParameters)
		lss20 = self.addLink('s17','s23',**linkSSParameters)
		lss21 = self.addLink('s18','s19',**linkSSParameters)
		lss22 = self.addLink('s18','s22',**linkSSParameters)
		lss23 = self.addLink('s19','s34',**linkSSParameters)
		lss24 = self.addLink('s20','s34',**linkSSParameters)
		lss25 = self.addLink('s21','s24',**linkSSParameters)
		lss26 = self.addLink('s24','s25',**linkSSParameters)
		lss27 = self.addLink('s26','s27',**linkSSParameters)
		lss28 = self.addLink('s27','s28',**linkSSParameters)
		lss29 = self.addLink('s28','s29',**linkSSParameters)
		lss30 = self.addLink('s29','s30',**linkSSParameters)
		lss31 = self.addLink('s30','s31',**linkSSParameters)
		lss32 = self.addLink('s31','s32',**linkSSParameters)
		lss33 = self.addLink('s32','s33',**linkSSParameters)
