...
class MininetNX( Topo ):
	def build( self ):
		...
		lss1 = self.addLink('s0','s33')
		lss2 = self.addLink('s1','s2')
		lss3 = self.addLink('s2','s3')
		lss4 = self.addLink('s3','s8')
		lss5 = self.addLink('s3','s20')
		lss6 = self.addLink('s3','s4')
		lss7 = self.addLink('s3','s7')
		lss8 = self.addLink('s4','s5')
		lss9 = self.addLink('s5','s6')
		lss10 = self.addLink('s6','s7')
		lss11 = self.addLink('s8','s15')
		lss12 = self.addLink('s9','s10')
		lss13 = self.addLink('s9','s11')
		lss14 = self.addLink('s10','s15')
		lss15 = self.addLink('s11','s12')
		lss16 = self.addLink('s12','s13')
		lss17 = self.addLink('s12','s15')
		lss18 = self.addLink('s13','s14')
		lss19 = self.addLink('s14','s17')
		lss20 = self.addLink('s15','s16')
		lss21 = self.addLink('s16','s17')
		lss22 = self.addLink('s17','s25')
		lss23 = self.addLink('s17','s23')
		lss24 = self.addLink('s18','s19')
		lss25 = self.addLink('s18','s22')
		lss26 = self.addLink('s19','s34')
		lss27 = self.addLink('s20','s34')
		lss28 = self.addLink('s21','s24')
		lss29 = self.addLink('s22','s23')
		lss30 = self.addLink('s24','s25')
		lss31 = self.addLink('s25','s26')
		lss32 = self.addLink('s26','s27')
		lss33 = self.addLink('s27','s28')
		lss34 = self.addLink('s28','s29')
		lss35 = self.addLink('s29','s30')
		lss36 = self.addLink('s30','s31')
		lss37 = self.addLink('s31','s32')
		lss38 = self.addLink('s32','s33')
