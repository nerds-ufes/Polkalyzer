...
class MininetNX( Topo ):
	def build( self ):
		...
		lss5 = self.addLink('s4','s16',**linkSSParameters)
		lss6 = self.addLink('s4','s5',**linkSSParameters)
		lss7 = self.addLink('s4','s6',**linkSSParameters)
		lss8 = self.addLink('s7','s8',**linkSSParameters)
		lss9 = self.addLink('s8','s16',**linkSSParameters)
		lss10 = self.addLink('s9','s16',**linkSSParameters)
		lss11 = self.addLink('s9','s10',**linkSSParameters)
		lss12 = self.addLink('s9','s11',**linkSSParameters)
		lss13 = self.addLink('s12','s16',**linkSSParameters)
		lss14 = self.addLink('s13','s14',**linkSSParameters)
		lss15 = self.addLink('s14','s16',**linkSSParameters)
		lss16 = self.addLink('s16','s22',**linkSSParameters)
		lss17 = self.addLink('s17','s22',**linkSSParameters)
		lss18 = self.addLink('s18','s22',**linkSSParameters)
		lss19 = self.addLink('s19','s22',**linkSSParameters)
		lss20 = self.addLink('s20','s22',**linkSSParameters)
