...
class MininetNX( Topo ):
	def build( self ):
		...
		lss4 = self.addLink('s2','s15',**linkSSParameters)
		lss5 = self.addLink('s3','s16',**linkSSParameters)
		lss6 = self.addLink('s4','s16',**linkSSParameters)
		lss7 = self.addLink('s4','s5',**linkSSParameters)
		lss8 = self.addLink('s4','s6',**linkSSParameters)
		lss9 = self.addLink('s5','s6',**linkSSParameters)
		lss10 = self.addLink('s5','s15',**linkSSParameters)
		lss11 = self.addLink('s7','s8',**linkSSParameters)
		lss12 = self.addLink('s7','s15',**linkSSParameters)
		lss13 = self.addLink('s8','s16',**linkSSParameters)
		lss14 = self.addLink('s9','s16',**linkSSParameters)
		...
		lss18 = self.addLink('s10','s15',**linkSSParameters)
		...
		lss22 = self.addLink('s13','s15',**linkSSParameters)
		lss23 = self.addLink('s14','s16',**linkSSParameters)
		lss24 = self.addLink('s15','s22',**linkSSParameters)
		lss25 = self.addLink('s16','s22',**linkSSParameters)
		lss26 = self.addLink('s17','s22',**linkSSParameters)
		lss27 = self.addLink('s18','s22',**linkSSParameters)
		lss28 = self.addLink('s19','s22',**linkSSParameters)
		lss29 = self.addLink('s20','s22',**linkSSParameters)
		lss30 = self.addLink('s21','s22',**linkSSParameters)
		
topos = { 'Aconet': ( lambda: MininetNX() ) }