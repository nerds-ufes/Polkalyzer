...
class MininetNX( Topo ):
	def build( self ):
		...
		lss4 = self.addLink('s2','s15')
		lss5 = self.addLink('s3','s16')
		lss6 = self.addLink('s4','s16')
		lss7 = self.addLink('s4','s5')
		lss8 = self.addLink('s4','s6')
		lss9 = self.addLink('s5','s6')
		lss10 = self.addLink('s5','s15')
		lss11 = self.addLink('s7','s8')
		lss12 = self.addLink('s7','s15')
		lss13 = self.addLink('s8','s16')
		lss14 = self.addLink('s9','s16')
		lss15 = self.addLink('s9','s10')
		lss16 = self.addLink('s9','s11')
		lss17 = self.addLink('s10','s11')
		lss18 = self.addLink('s10','s15')
		lss19 = self.addLink('s12','s16')
		lss20 = self.addLink('s12','s15')
		lss21 = self.addLink('s13','s14')
		lss22 = self.addLink('s13','s15')
		lss23 = self.addLink('s14','s16')
		lss24 = self.addLink('s15','s22')
		lss25 = self.addLink('s16','s22')
		lss26 = self.addLink('s17','s22')
		lss27 = self.addLink('s18','s22')
		lss28 = self.addLink('s19','s22')
		lss29 = self.addLink('s20','s22')
