...
class MininetNX( Topo ):
	def build( self ):
		...
		lss13 = self.addLink('s10','s13',**linkSSParameters)
		lss14 = self.addLink('s10','s15',**linkSSParameters)
		lss15 = self.addLink('s11','s12',**linkSSParameters)
		lss16 = self.addLink('s11','s14',**linkSSParameters)
		lss17 = self.addLink('s11','s19',**linkSSParameters)
		lss18 = self.addLink('s12','s17',**linkSSParameters)
