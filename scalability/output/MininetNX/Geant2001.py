...
class MininetNX( Topo ):
	def build( self ):
		...
		lss5 = self.addLink('s1','s24',**linkSSParameters)
		lss6 = self.addLink('s1','s26',**linkSSParameters)
		lss7 = self.addLink('s2','s3',**linkSSParameters)
		lss8 = self.addLink('s2','s4',**linkSSParameters)
		lss9 = self.addLink('s2','s5',**linkSSParameters)
		lss10 = self.addLink('s2','s6',**linkSSParameters)
		lss11 = self.addLink('s2','s11',**linkSSParameters)
		lss12 = self.addLink('s6','s12',**linkSSParameters)
		lss13 = self.addLink('s7','s8',**linkSSParameters)
		lss14 = self.addLink('s7','s11',**linkSSParameters)
		lss15 = self.addLink('s8','s9',**linkSSParameters)
		lss16 = self.addLink('s8','s10',**linkSSParameters)
		lss17 = self.addLink('s9','s10',**linkSSParameters)
		lss18 = self.addLink('s10','s11',**linkSSParameters)
		lss19 = self.addLink('s10','s13',**linkSSParameters)
		lss20 = self.addLink('s10','s15',**linkSSParameters)
		lss21 = self.addLink('s11','s12',**linkSSParameters)
		lss22 = self.addLink('s11','s14',**linkSSParameters)
		lss23 = self.addLink('s11','s19',**linkSSParameters)
		lss24 = self.addLink('s11','s24',**linkSSParameters)
		lss25 = self.addLink('s12','s17',**linkSSParameters)
		lss26 = self.addLink('s13','s19',**linkSSParameters)
		lss27 = self.addLink('s13','s14',**linkSSParameters)
