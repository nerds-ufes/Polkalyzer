...
class MininetNX( Topo ):
	def build( self ):
		...
		lss3 = self.addLink('s0','s10',**linkSSParameters)
		lss4 = self.addLink('s0','s11',**linkSSParameters)
		lss5 = self.addLink('s0','s12',**linkSSParameters)
		lss6 = self.addLink('s0','s13',**linkSSParameters)
		lss7 = self.addLink('s0','s15',**linkSSParameters)
		lss8 = self.addLink('s0','s18',**linkSSParameters)
		lss9 = self.addLink('s0','s26',**linkSSParameters)
		lss10 = self.addLink('s0','s27',**linkSSParameters)
		lss11 = self.addLink('s0','s28',**linkSSParameters)
		lss12 = self.addLink('s2','s3',**linkSSParameters)
		lss13 = self.addLink('s2','s4',**linkSSParameters)
		lss14 = self.addLink('s2','s5',**linkSSParameters)
		lss15 = self.addLink('s2','s6',**linkSSParameters)
		lss16 = self.addLink('s2','s7',**linkSSParameters)
		lss17 = self.addLink('s2','s8',**linkSSParameters)
		lss18 = self.addLink('s14','s15',**linkSSParameters)
		lss19 = self.addLink('s15','s16',**linkSSParameters)
		...
		lss24 = self.addLink('s18','s22',**linkSSParameters)
		lss25 = self.addLink('s18','s23',**linkSSParameters)
		lss26 = self.addLink('s18','s24',**linkSSParameters)
		lss27 = self.addLink('s18','s25',**linkSSParameters)
		lss28 = self.addLink('s18','s29',**linkSSParameters)
		
topos = { 'Arn': ( lambda: MininetNX() ) }