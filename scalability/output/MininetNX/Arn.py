...
class MininetNX( Topo ):
	def build( self ):
		...
		lss3 = self.addLink('s0','s10')
		lss4 = self.addLink('s0','s11')
		lss5 = self.addLink('s0','s12')
		lss6 = self.addLink('s0','s13')
		lss7 = self.addLink('s0','s15')
		lss8 = self.addLink('s0','s18')
		lss9 = self.addLink('s0','s26')
		lss10 = self.addLink('s0','s27')
		lss11 = self.addLink('s0','s28')
		lss12 = self.addLink('s2','s3')
		lss13 = self.addLink('s2','s4')
		lss14 = self.addLink('s2','s5')
		lss15 = self.addLink('s2','s6')
		lss16 = self.addLink('s2','s7')
		lss17 = self.addLink('s2','s8')
		lss18 = self.addLink('s14','s15')
		lss19 = self.addLink('s15','s16')
		lss20 = self.addLink('s17','s18')
		lss21 = self.addLink('s18','s19')
		lss22 = self.addLink('s18','s20')
		lss23 = self.addLink('s18','s21')
		lss24 = self.addLink('s18','s22')
		lss25 = self.addLink('s18','s23')
		lss26 = self.addLink('s18','s24')
		lss27 = self.addLink('s18','s25')
		lss28 = self.addLink('s18','s29')
