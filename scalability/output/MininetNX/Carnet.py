...
class MininetNX( Topo ):
	def build( self ):
		...
		lss7 = self.addLink('s0','s12',**linkSSParameters)
		lss8 = self.addLink('s0','s13',**linkSSParameters)
		lss9 = self.addLink('s0','s14',**linkSSParameters)
		lss10 = self.addLink('s0','s16',**linkSSParameters)
		lss11 = self.addLink('s0','s17',**linkSSParameters)
		lss12 = self.addLink('s0','s18',**linkSSParameters)
		lss13 = self.addLink('s0','s19',**linkSSParameters)
		lss14 = self.addLink('s0','s20',**linkSSParameters)
		lss15 = self.addLink('s0','s22',**linkSSParameters)
		lss16 = self.addLink('s0','s23',**linkSSParameters)
		lss17 = self.addLink('s0','s24',**linkSSParameters)
		lss18 = self.addLink('s3','s21',**linkSSParameters)
		...
		lss22 = self.addLink('s7','s9',**linkSSParameters)
		lss23 = self.addLink('s8','s25',**linkSSParameters)
		lss24 = self.addLink('s14','s15',**linkSSParameters)
		lss25 = self.addLink('s22','s35',**linkSSParameters)
		lss26 = self.addLink('s22','s37',**linkSSParameters)
		lss27 = self.addLink('s22','s38',**linkSSParameters)
		lss28 = self.addLink('s22','s39',**linkSSParameters)
		lss29 = self.addLink('s22','s40',**linkSSParameters)
		lss30 = self.addLink('s22','s41',**linkSSParameters)
		lss31 = self.addLink('s22','s42',**linkSSParameters)
		lss32 = self.addLink('s22','s43',**linkSSParameters)
		lss33 = self.addLink('s23','s32',**linkSSParameters)
		lss34 = self.addLink('s23','s34',**linkSSParameters)
		lss35 = self.addLink('s23','s33',**linkSSParameters)
		lss36 = self.addLink('s23','s26',**linkSSParameters)
		lss37 = self.addLink('s23','s27',**linkSSParameters)
		lss38 = self.addLink('s23','s28',**linkSSParameters)
		lss39 = self.addLink('s23','s29',**linkSSParameters)
		lss40 = self.addLink('s23','s31',**linkSSParameters)
		lss41 = self.addLink('s29','s30',**linkSSParameters)
		lss42 = self.addLink('s35','s36',**linkSSParameters)
		
topos = { 'Carnet': ( lambda: MininetNX() ) }