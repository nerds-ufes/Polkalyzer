...
class MininetNX( Topo ):
	def build( self ):
		...
		lss5 = self.addLink('s3','s21',**linkSSParameters)
		lss6 = self.addLink('s3','s22',**linkSSParameters)
		lss7 = self.addLink('s4','s25',**linkSSParameters)
		lss8 = self.addLink('s4','s19',**linkSSParameters)
		lss9 = self.addLink('s4','s5',**linkSSParameters)
		...
		lss18 = self.addLink('s8','s14',**linkSSParameters)
		lss19 = self.addLink('s9','s15',**linkSSParameters)
		lss20 = self.addLink('s10','s11',**linkSSParameters)
		lss21 = self.addLink('s10','s13',**linkSSParameters)
		lss22 = self.addLink('s11','s24',**linkSSParameters)
		lss23 = self.addLink('s11','s18',**linkSSParameters)
		lss24 = self.addLink('s13','s16',**linkSSParameters)
		lss25 = self.addLink('s15','s16',**linkSSParameters)
		lss26 = self.addLink('s20','s21',**linkSSParameters)
		lss27 = self.addLink('s22','s25',**linkSSParameters)
		
topos = { 'Arpanet19723': ( lambda: MininetNX() ) }