...
class MininetNX( Topo ):
	def build( self ):
		...
		lss7 = self.addLink('s4','s19',**linkSSParameters)
		lss8 = self.addLink('s5','s23',**linkSSParameters)
		lss9 = self.addLink('s5','s12',**linkSSParameters)
		lss10 = self.addLink('s6','s7',**linkSSParameters)
		lss11 = self.addLink('s6','s24',**linkSSParameters)
		lss12 = self.addLink('s7','s12',**linkSSParameters)
		lss13 = self.addLink('s7','s14',**linkSSParameters)
		lss14 = self.addLink('s8','s19',**linkSSParameters)
		...
		lss18 = self.addLink('s11','s24',**linkSSParameters)
		lss19 = self.addLink('s11','s18',**linkSSParameters)
		...
		lss23 = self.addLink('s22','s25',**linkSSParameters)
