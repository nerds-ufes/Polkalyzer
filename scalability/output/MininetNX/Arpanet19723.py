...
class MininetNX( Topo ):
	def build( self ):
		...
		lss5 = self.addLink('s3','s21')
		lss6 = self.addLink('s3','s22')
		lss7 = self.addLink('s4','s25')
		lss8 = self.addLink('s4','s19')
		lss9 = self.addLink('s4','s5')
		...
		lss17 = self.addLink('s8','s19')
		lss18 = self.addLink('s8','s14')
		lss19 = self.addLink('s9','s15')
		lss20 = self.addLink('s10','s11')
		lss21 = self.addLink('s10','s13')
		lss22 = self.addLink('s11','s24')
		lss23 = self.addLink('s11','s18')
		lss24 = self.addLink('s13','s16')
		lss25 = self.addLink('s15','s16')
		lss26 = self.addLink('s20','s21')
		lss27 = self.addLink('s22','s25')
