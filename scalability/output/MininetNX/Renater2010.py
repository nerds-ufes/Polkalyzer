...
class MininetNX( Topo ):
	def build( self ):
		...
		lhs60 = self.addLink('s32','h60',**linkHSParameters)
		lhs61 = self.addLink('s32','h61',**linkHSParameters)
		lhs62 = self.addLink('s33','h62',**linkHSParameters)
		lhs63 = self.addLink('s33','h63',**linkHSParameters)
		lhs64 = self.addLink('s34','h64',**linkHSParameters)
		lhs65 = self.addLink('s34','h65',**linkHSParameters)
		lhs66 = self.addLink('s35','h66',**linkHSParameters)
		lhs67 = self.addLink('s35','h67',**linkHSParameters)
		lhs68 = self.addLink('s36','h68',**linkHSParameters)
		lhs69 = self.addLink('s36','h69',**linkHSParameters)
		lhs70 = self.addLink('s37','h70',**linkHSParameters)
		lhs71 = self.addLink('s37','h71',**linkHSParameters)
		lhs72 = self.addLink('s38','h72',**linkHSParameters)
		lhs73 = self.addLink('s38','h73',**linkHSParameters)
		lhs74 = self.addLink('s39','h74',**linkHSParameters)
		lhs75 = self.addLink('s39','h75',**linkHSParameters)
		lhs76 = self.addLink('s40','h76',**linkHSParameters)
		lhs77 = self.addLink('s40','h77',**linkHSParameters)
		lhs78 = self.addLink('s41','h78',**linkHSParameters)
		lhs79 = self.addLink('s41','h79',**linkHSParameters)
		lhs80 = self.addLink('s42','h80',**linkHSParameters)
		lhs81 = self.addLink('s42','h81',**linkHSParameters)
		lhs82 = self.addLink('s43','h82',**linkHSParameters)
		lhs83 = self.addLink('s43','h83',**linkHSParameters)
		lhs84 = self.addLink('s44','h84',**linkHSParameters)
		lhs85 = self.addLink('s44','h85',**linkHSParameters)
		#Add a link of switches of original topology
		lss0 = self.addLink('s0','s1',**linkSSParameters)
		lss1 = self.addLink('s0','s18',**linkSSParameters)
		lss2 = self.addLink('s1','s2',**linkSSParameters)
		lss3 = self.addLink('s2','s26',**linkSSParameters)
		lss4 = self.addLink('s3','s26',**linkSSParameters)
		lss5 = self.addLink('s3','s4',**linkSSParameters)
		lss6 = self.addLink('s4','s26',**linkSSParameters)
		lss7 = self.addLink('s5','s26',**linkSSParameters)
		...
		lss11 = self.addLink('s7','s39',**linkSSParameters)
		lss12 = self.addLink('s8','s36',**linkSSParameters)
		lss13 = self.addLink('s8','s31',**linkSSParameters)
		lss14 = self.addLink('s8','s12',**linkSSParameters)
		lss15 = self.addLink('s9','s10',**linkSSParameters)
		lss16 = self.addLink('s9','s11',**linkSSParameters)
		lss17 = self.addLink('s9','s12',**linkSSParameters)
		lss18 = self.addLink('s10','s34',**linkSSParameters)
		lss19 = self.addLink('s10','s26',**linkSSParameters)
		lss20 = self.addLink('s10','s33',**linkSSParameters)
		lss21 = self.addLink('s11','s16',**linkSSParameters)
		lss22 = self.addLink('s12','s13',**linkSSParameters)
		lss23 = self.addLink('s12','s14',**linkSSParameters)
		lss24 = self.addLink('s12','s16',**linkSSParameters)
		lss25 = self.addLink('s13','s14',**linkSSParameters)
		lss26 = self.addLink('s14','s15',**linkSSParameters)
		lss27 = self.addLink('s15','s21',**linkSSParameters)
		lss28 = self.addLink('s16','s27',**linkSSParameters)
		lss29 = self.addLink('s17','s18',**linkSSParameters)
		lss30 = self.addLink('s17','s27',**linkSSParameters)
		lss31 = self.addLink('s19','s27',**linkSSParameters)
		lss32 = self.addLink('s19','s35',**linkSSParameters)
		lss33 = self.addLink('s19','s22',**linkSSParameters)
		lss34 = self.addLink('s20','s21',**linkSSParameters)
		lss35 = self.addLink('s20','s22',**linkSSParameters)
		lss36 = self.addLink('s21','s23',**linkSSParameters)
		lss37 = self.addLink('s21','s27',**linkSSParameters)
		lss38 = self.addLink('s21','s22',**linkSSParameters)
		lss39 = self.addLink('s26','s43',**linkSSParameters)
		lss40 = self.addLink('s26','s27',**linkSSParameters)
		lss41 = self.addLink('s26','s28',**linkSSParameters)
		lss42 = self.addLink('s26','s29',**linkSSParameters)
		lss43 = self.addLink('s26','s30',**linkSSParameters)
		lss44 = self.addLink('s27','s35',**linkSSParameters)
		lss45 = self.addLink('s27','s44',**linkSSParameters)
		lss46 = self.addLink('s27','s28',**linkSSParameters)
		lss47 = self.addLink('s31','s32',**linkSSParameters)
		lss48 = self.addLink('s32','s33',**linkSSParameters)
		lss49 = self.addLink('s36','s37',**linkSSParameters)
		lss50 = self.addLink('s37','s38',**linkSSParameters)
		lss51 = self.addLink('s38','s41',**linkSSParameters)
		lss52 = self.addLink('s39','s40',**linkSSParameters)
		lss53 = self.addLink('s40','s41',**linkSSParameters)
		lss54 = self.addLink('s42','s43',**linkSSParameters)
		lss55 = self.addLink('s43','s44',**linkSSParameters)
		
topos = { 'Renater2010': ( lambda: MininetNX() ) }