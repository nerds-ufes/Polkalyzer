...
class MininetNX( Topo ):
	def build( self ):
		...
		lhs48 = self.addLink('s26','h48')
		lhs49 = self.addLink('s26','h49')
		lhs50 = self.addLink('s27','h50')
		lhs51 = self.addLink('s27','h51')
		lhs52 = self.addLink('s28','h52')
		lhs53 = self.addLink('s28','h53')
		lhs54 = self.addLink('s29','h54')
		lhs55 = self.addLink('s29','h55')
		lhs56 = self.addLink('s30','h56')
		lhs57 = self.addLink('s30','h57')
		lhs58 = self.addLink('s31','h58')
		lhs59 = self.addLink('s31','h59')
		lhs60 = self.addLink('s32','h60')
		lhs61 = self.addLink('s32','h61')
		lhs62 = self.addLink('s33','h62')
		lhs63 = self.addLink('s33','h63')
		lhs64 = self.addLink('s34','h64')
		lhs65 = self.addLink('s34','h65')
		lhs66 = self.addLink('s35','h66')
		lhs67 = self.addLink('s35','h67')
		lhs68 = self.addLink('s36','h68')
		lhs69 = self.addLink('s36','h69')
		lhs70 = self.addLink('s37','h70')
		lhs71 = self.addLink('s37','h71')
		lhs72 = self.addLink('s38','h72')
		lhs73 = self.addLink('s38','h73')
		lhs74 = self.addLink('s39','h74')
		lhs75 = self.addLink('s39','h75')
		lhs76 = self.addLink('s40','h76')
		lhs77 = self.addLink('s40','h77')
		lhs78 = self.addLink('s41','h78')
		lhs79 = self.addLink('s41','h79')
		lhs80 = self.addLink('s42','h80')
		lhs81 = self.addLink('s42','h81')
		lhs82 = self.addLink('s43','h82')
		lhs83 = self.addLink('s43','h83')
		lhs84 = self.addLink('s44','h84')
		lhs85 = self.addLink('s44','h85')
		#Add a link of switches of original topology
		lss0 = self.addLink('s0','s1')
		lss1 = self.addLink('s0','s18')
		lss2 = self.addLink('s1','s2')
		lss3 = self.addLink('s2','s26')
		lss4 = self.addLink('s3','s26')
		lss5 = self.addLink('s3','s4')
		lss6 = self.addLink('s4','s26')
		lss7 = self.addLink('s5','s26')
		lss8 = self.addLink('s5','s6')
		lss9 = self.addLink('s6','s7')
		lss10 = self.addLink('s7','s8')
		lss11 = self.addLink('s7','s39')
		lss12 = self.addLink('s8','s36')
		lss13 = self.addLink('s8','s31')
		lss14 = self.addLink('s8','s12')
		lss15 = self.addLink('s9','s10')
		lss16 = self.addLink('s9','s11')
		lss17 = self.addLink('s9','s12')
		lss18 = self.addLink('s10','s34')
		lss19 = self.addLink('s10','s26')
		lss20 = self.addLink('s10','s33')
		lss21 = self.addLink('s11','s16')
		lss22 = self.addLink('s12','s13')
		lss23 = self.addLink('s12','s14')
		lss24 = self.addLink('s12','s16')
		lss25 = self.addLink('s13','s14')
		lss26 = self.addLink('s14','s15')
		lss27 = self.addLink('s15','s21')
		lss28 = self.addLink('s16','s27')
		lss29 = self.addLink('s17','s18')
		lss30 = self.addLink('s17','s27')
		lss31 = self.addLink('s19','s27')
		lss32 = self.addLink('s19','s35')
		lss33 = self.addLink('s19','s22')
		lss34 = self.addLink('s20','s21')
		lss35 = self.addLink('s20','s22')
		lss36 = self.addLink('s21','s23')
		lss37 = self.addLink('s21','s27')
		lss38 = self.addLink('s21','s22')
		lss39 = self.addLink('s26','s43')
		lss40 = self.addLink('s26','s27')
		lss41 = self.addLink('s26','s28')
		lss42 = self.addLink('s26','s29')
		lss43 = self.addLink('s26','s30')
		lss44 = self.addLink('s27','s35')
		lss45 = self.addLink('s27','s44')
		lss46 = self.addLink('s27','s28')
		lss47 = self.addLink('s31','s32')
		lss48 = self.addLink('s32','s33')
		lss49 = self.addLink('s36','s37')
		lss50 = self.addLink('s37','s38')
		lss51 = self.addLink('s38','s41')
		lss52 = self.addLink('s39','s40')
		lss53 = self.addLink('s40','s41')
		lss54 = self.addLink('s42','s43')
		lss55 = self.addLink('s43','s44')
