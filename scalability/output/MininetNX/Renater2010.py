...
class MininetNX( Topo ):
	def build( self ):
		...
		lhs24 = self.addLink('s26','h24',**linkHSParameters)
		lhs25 = self.addLink('s27','h25',**linkHSParameters)
		lhs26 = self.addLink('s28','h26',**linkHSParameters)
		lhs27 = self.addLink('s29','h27',**linkHSParameters)
		lhs28 = self.addLink('s30','h28',**linkHSParameters)
		lhs29 = self.addLink('s31','h29',**linkHSParameters)
		lhs30 = self.addLink('s32','h30',**linkHSParameters)
		lhs31 = self.addLink('s33','h31',**linkHSParameters)
		lhs32 = self.addLink('s34','h32',**linkHSParameters)
		lhs33 = self.addLink('s35','h33',**linkHSParameters)
		lhs34 = self.addLink('s36','h34',**linkHSParameters)
		lhs35 = self.addLink('s37','h35',**linkHSParameters)
		lhs36 = self.addLink('s38','h36',**linkHSParameters)
		lhs37 = self.addLink('s39','h37',**linkHSParameters)
		lhs38 = self.addLink('s40','h38',**linkHSParameters)
		lhs39 = self.addLink('s41','h39',**linkHSParameters)
		lhs40 = self.addLink('s42','h40',**linkHSParameters)
		lhs41 = self.addLink('s43','h41',**linkHSParameters)
		lhs42 = self.addLink('s44','h42',**linkHSParameters)
		...
		lss5 = self.addLink('s4','s26',**linkSSParameters)
		lss6 = self.addLink('s5','s26',**linkSSParameters)
		lss7 = self.addLink('s5','s6',**linkSSParameters)
		lss8 = self.addLink('s6','s7',**linkSSParameters)
		lss9 = self.addLink('s7','s39',**linkSSParameters)
		lss10 = self.addLink('s8','s12',**linkSSParameters)
		lss11 = self.addLink('s8','s36',**linkSSParameters)
		lss12 = self.addLink('s9','s10',**linkSSParameters)
		lss13 = self.addLink('s10','s26',**linkSSParameters)
		lss14 = self.addLink('s10','s34',**linkSSParameters)
		lss15 = self.addLink('s10','s33',**linkSSParameters)
		lss16 = self.addLink('s11','s16',**linkSSParameters)
		lss17 = self.addLink('s12','s16',**linkSSParameters)
		lss18 = self.addLink('s12','s13',**linkSSParameters)
		lss19 = self.addLink('s12','s14',**linkSSParameters)
		lss20 = self.addLink('s15','s21',**linkSSParameters)
		lss21 = self.addLink('s16','s27',**linkSSParameters)
		lss22 = self.addLink('s17','s18',**linkSSParameters)
		lss23 = self.addLink('s17','s27',**linkSSParameters)
		lss24 = self.addLink('s19','s27',**linkSSParameters)
		lss25 = self.addLink('s19','s22',**linkSSParameters)
		lss26 = self.addLink('s20','s21',**linkSSParameters)
		lss27 = self.addLink('s21','s27',**linkSSParameters)
		lss28 = self.addLink('s21','s23',**linkSSParameters)
		lss29 = self.addLink('s26','s43',**linkSSParameters)
		lss30 = self.addLink('s26','s28',**linkSSParameters)
		lss31 = self.addLink('s26','s29',**linkSSParameters)
		lss32 = self.addLink('s26','s30',**linkSSParameters)
		lss33 = self.addLink('s27','s35',**linkSSParameters)
		lss34 = self.addLink('s27','s44',**linkSSParameters)
		lss35 = self.addLink('s31','s32',**linkSSParameters)
		lss36 = self.addLink('s32','s33',**linkSSParameters)
		lss37 = self.addLink('s36','s37',**linkSSParameters)
		lss38 = self.addLink('s37','s38',**linkSSParameters)
		lss39 = self.addLink('s39','s40',**linkSSParameters)
		lss40 = self.addLink('s40','s41',**linkSSParameters)
		lss41 = self.addLink('s42','s43',**linkSSParameters)
