...
class MininetNX( Topo ):
	def build( self ):
		...
		lss5 = self.addLink('s3','s9',**linkSSParameters)
		...
		lss11 = self.addLink('s6','s9',**linkSSParameters)
		...
		lss16 = self.addLink('s9','s13',**linkSSParameters)
		...
		lss24 = self.addLink('s17','s18',**linkSSParameters)
		lss25 = self.addLink('s18','s19',**linkSSParameters)
		
topos = { 'Oxford': ( lambda: MininetNX() ) }