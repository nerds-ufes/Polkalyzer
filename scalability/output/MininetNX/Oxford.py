...
class MininetNX( Topo ):
	def build( self ):
		...
		lss10 = self.addLink('s9','s12',**linkSSParameters)
		lss11 = self.addLink('s9','s13',**linkSSParameters)
		lss12 = self.addLink('s10','s11',**linkSSParameters)
		lss13 = self.addLink('s12','s14',**linkSSParameters)
		lss14 = self.addLink('s13','s15',**linkSSParameters)
		lss15 = self.addLink('s14','s16',**linkSSParameters)
		lss16 = self.addLink('s15','s19',**linkSSParameters)
