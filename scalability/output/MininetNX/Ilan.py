...
class MininetNX( Topo ):
	def build( self ):
		...
		lss5 = self.addLink('s3','s12',**linkSSParameters)
		lss6 = self.addLink('s4','s12',**linkSSParameters)
		lss7 = self.addLink('s5','s12',**linkSSParameters)
		lss8 = self.addLink('s6','s12',**linkSSParameters)
		lss9 = self.addLink('s7','s11',**linkSSParameters)
