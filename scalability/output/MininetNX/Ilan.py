...
class MininetNX( Topo ):
	def build( self ):
		...
		lss0 = self.addLink('s0','s11')
		lss1 = self.addLink('s1','s11')
		lss2 = self.addLink('s1','s12')
		lss3 = self.addLink('s2','s12')
		lss4 = self.addLink('s3','s11')
		lss5 = self.addLink('s3','s12')
		lss6 = self.addLink('s4','s12')
		lss7 = self.addLink('s5','s12')
		lss8 = self.addLink('s6','s12')
		lss9 = self.addLink('s7','s11')
		lss10 = self.addLink('s7','s12')
		lss11 = self.addLink('s8','s11')
