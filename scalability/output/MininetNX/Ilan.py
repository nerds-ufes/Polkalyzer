...
class MininetNX( Topo ):
	def build( self ):
		...
		lss0 = self.addLink('s0','s11',**linkSSParameters)
		lss1 = self.addLink('s1','s11',**linkSSParameters)
		lss2 = self.addLink('s1','s12',**linkSSParameters)
		lss3 = self.addLink('s2','s12',**linkSSParameters)
		lss4 = self.addLink('s3','s11',**linkSSParameters)
		lss5 = self.addLink('s4','s12',**linkSSParameters)
		lss6 = self.addLink('s5','s12',**linkSSParameters)
		lss7 = self.addLink('s6','s12',**linkSSParameters)
		lss8 = self.addLink('s7','s11',**linkSSParameters)
		lss9 = self.addLink('s8','s11',**linkSSParameters)
		lss10 = self.addLink('s9','s11',**linkSSParameters)
		lss11 = self.addLink('s10','s11',**linkSSParameters)
		lss12 = self.addLink('s12','s13',**linkSSParameters)
		
topos = { 'Ilan': ( lambda: MininetNX() ) }