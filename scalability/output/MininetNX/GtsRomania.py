...
class MininetNX( Topo ):
	def build( self ):
		...
		lss4 = self.addLink('s3','s19',**linkSSParameters)
		...
		lss9 = self.addLink('s6','s20',**linkSSParameters)
		lss10 = self.addLink('s7','s21',**linkSSParameters)
		lss11 = self.addLink('s8','s12',**linkSSParameters)
		lss12 = self.addLink('s8','s22',**linkSSParameters)
		lss13 = self.addLink('s10','s19',**linkSSParameters)
		lss14 = self.addLink('s11','s19',**linkSSParameters)
		lss15 = self.addLink('s12','s19',**linkSSParameters)
		lss16 = self.addLink('s13','s19',**linkSSParameters)
		lss17 = self.addLink('s14','s19',**linkSSParameters)
		lss18 = self.addLink('s15','s19',**linkSSParameters)
		lss19 = self.addLink('s16','s19',**linkSSParameters)
