...
class MininetNX( Topo ):
	def build( self ):
		...
		lss0 = self.addLink('s0','s19',**linkSSParameters)
		lss1 = self.addLink('s0','s5',**linkSSParameters)
		lss2 = self.addLink('s1','s15',**linkSSParameters)
		lss3 = self.addLink('s2','s19',**linkSSParameters)
		lss4 = self.addLink('s2','s5',**linkSSParameters)
		lss5 = self.addLink('s3','s19',**linkSSParameters)
		lss6 = self.addLink('s4','s10',**linkSSParameters)
		lss7 = self.addLink('s4','s5',**linkSSParameters)
		lss8 = self.addLink('s5','s6',**linkSSParameters)
		lss9 = self.addLink('s5','s7',**linkSSParameters)
		lss10 = self.addLink('s5','s9',**linkSSParameters)
		lss11 = self.addLink('s5','s19',**linkSSParameters)
		lss12 = self.addLink('s6','s20',**linkSSParameters)
		lss13 = self.addLink('s7','s8',**linkSSParameters)
		lss14 = self.addLink('s7','s21',**linkSSParameters)
		lss15 = self.addLink('s8','s12',**linkSSParameters)
		lss16 = self.addLink('s8','s22',**linkSSParameters)
		lss17 = self.addLink('s10','s19',**linkSSParameters)
		lss18 = self.addLink('s11','s19',**linkSSParameters)
		lss19 = self.addLink('s12','s19',**linkSSParameters)
		lss20 = self.addLink('s13','s19',**linkSSParameters)
		lss21 = self.addLink('s14','s19',**linkSSParameters)
		lss22 = self.addLink('s15','s19',**linkSSParameters)
		lss23 = self.addLink('s16','s19',**linkSSParameters)
