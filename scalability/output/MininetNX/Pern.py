...
class MininetNX( Topo ):
	def build( self ):
		...
		lss3 = self.addLink('s2','s6',**linkSSParameters)
		lss4 = self.addLink('s3','s4',**linkSSParameters)
		lss5 = self.addLink('s5','s6',**linkSSParameters)
		lss6 = self.addLink('s5','s8',**linkSSParameters)
		lss7 = self.addLink('s6','s10',**linkSSParameters)
		lss8 = self.addLink('s7','s10',**linkSSParameters)
		lss9 = self.addLink('s9','s10',**linkSSParameters)
		lss10 = self.addLink('s9','s11',**linkSSParameters)
		
topos = { 'Pern': ( lambda: MininetNX() ) }