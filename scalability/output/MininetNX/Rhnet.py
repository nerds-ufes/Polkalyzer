...
class MininetNX( Topo ):
	def build( self ):
		...
		lss1 = self.addLink('s0','s7',**linkSSParameters)
		lss2 = self.addLink('s1','s2',**linkSSParameters)
		lss3 = self.addLink('s2','s3',**linkSSParameters)
		lss4 = self.addLink('s2','s13',**linkSSParameters)
		lss5 = self.addLink('s2','s14',**linkSSParameters)
		...
		lss9 = self.addLink('s6','s7',**linkSSParameters)
		lss10 = self.addLink('s7','s8',**linkSSParameters)
		lss11 = self.addLink('s8','s9',**linkSSParameters)
