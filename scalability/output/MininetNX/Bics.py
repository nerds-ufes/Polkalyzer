...
class MininetNX( Topo ):
	def build( self ):
		...
		lhs22 = self.addLink('s24','h22',**linkHSParameters)
		lhs23 = self.addLink('s25','h23',**linkHSParameters)
		...
		lss7 = self.addLink('s6','s26',**linkSSParameters)
		lss8 = self.addLink('s7','s33',**linkSSParameters)
		lss9 = self.addLink('s8','s29',**linkSSParameters)
		lss10 = self.addLink('s9','s10',**linkSSParameters)
		lss11 = self.addLink('s9','s29',**linkSSParameters)
		lss12 = self.addLink('s10','s12',**linkSSParameters)
		lss13 = self.addLink('s11','s28',**linkSSParameters)
		lss14 = self.addLink('s13','s29',**linkSSParameters)
		lss15 = self.addLink('s13','s24',**linkSSParameters)
		lss16 = self.addLink('s14','s15',**linkSSParameters)
		lss17 = self.addLink('s15','s17',**linkSSParameters)
		lss18 = self.addLink('s16','s31',**linkSSParameters)
		lss19 = self.addLink('s17','s18',**linkSSParameters)
		lss20 = self.addLink('s17','s20',**linkSSParameters)
		lss21 = self.addLink('s18','s19',**linkSSParameters)
		lss22 = self.addLink('s19','s21',**linkSSParameters)
		lss23 = self.addLink('s25','s31',**linkSSParameters)
		lss24 = self.addLink('s26','s30',**linkSSParameters)
		lss25 = self.addLink('s27','s28',**linkSSParameters)
		lss26 = self.addLink('s28','s29',**linkSSParameters)
		lss27 = self.addLink('s29','s33',**linkSSParameters)
		lss28 = self.addLink('s29','s30',**linkSSParameters)
		lss29 = self.addLink('s29','s31',**linkSSParameters)
		lss30 = self.addLink('s31','s32',**linkSSParameters)
		lss31 = self.addLink('s33','s34',**linkSSParameters)
