...
class MininetNX( Topo ):
	def build( self ):
		...
		lss0 = self.addLink('s0','s9',**linkSSParameters)
		lss1 = self.addLink('s0','s18',**linkSSParameters)
		lss2 = self.addLink('s1','s27',**linkSSParameters)
		lss3 = self.addLink('s2','s27',**linkSSParameters)
		...
		lss7 = self.addLink('s5','s24',**linkSSParameters)
		lss8 = self.addLink('s5','s6',**linkSSParameters)
		lss9 = self.addLink('s6','s25',**linkSSParameters)
		lss10 = self.addLink('s6','s26',**linkSSParameters)
		lss11 = self.addLink('s7','s33',**linkSSParameters)
		lss12 = self.addLink('s7','s25',**linkSSParameters)
		lss13 = self.addLink('s8','s29',**linkSSParameters)
		lss14 = self.addLink('s9','s10',**linkSSParameters)
		lss15 = self.addLink('s9','s29',**linkSSParameters)
		lss16 = self.addLink('s10','s12',**linkSSParameters)
		lss17 = self.addLink('s10','s29',**linkSSParameters)
		lss18 = self.addLink('s11','s28',**linkSSParameters)
		lss19 = self.addLink('s11','s30',**linkSSParameters)
		lss20 = self.addLink('s12','s17',**linkSSParameters)
		lss21 = self.addLink('s12','s13',**linkSSParameters)
		lss22 = self.addLink('s13','s24',**linkSSParameters)
		lss23 = self.addLink('s13','s29',**linkSSParameters)
		lss24 = self.addLink('s14','s15',**linkSSParameters)
		lss25 = self.addLink('s15','s17',**linkSSParameters)
		lss26 = self.addLink('s16','s24',**linkSSParameters)
		lss27 = self.addLink('s16','s31',**linkSSParameters)
		lss28 = self.addLink('s17','s20',**linkSSParameters)
		lss29 = self.addLink('s17','s18',**linkSSParameters)
		lss30 = self.addLink('s18','s19',**linkSSParameters)
		lss31 = self.addLink('s19','s21',**linkSSParameters)
		lss32 = self.addLink('s20','s21',**linkSSParameters)
		lss33 = self.addLink('s24','s31',**linkSSParameters)
		lss34 = self.addLink('s25','s26',**linkSSParameters)
		lss35 = self.addLink('s25','s31',**linkSSParameters)
		lss36 = self.addLink('s26','s27',**linkSSParameters)
		lss37 = self.addLink('s26','s30',**linkSSParameters)
		...
		lss42 = self.addLink('s29','s33',**linkSSParameters)
		lss43 = self.addLink('s29','s30',**linkSSParameters)
		lss44 = self.addLink('s29','s31',**linkSSParameters)
		lss45 = self.addLink('s30','s34',**linkSSParameters)
