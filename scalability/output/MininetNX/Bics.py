...
class MininetNX( Topo ):
	def build( self ):
		...
		lhs44 = self.addLink('s24','h44')
		lhs45 = self.addLink('s24','h45')
		lhs46 = self.addLink('s25','h46')
		lhs47 = self.addLink('s25','h47')
		...
		lss2 = self.addLink('s1','s27')
		lss3 = self.addLink('s2','s27')
		lss4 = self.addLink('s3','s26')
		lss5 = self.addLink('s3','s4')
		lss6 = self.addLink('s4','s5')
		lss7 = self.addLink('s5','s24')
		lss8 = self.addLink('s5','s6')
		lss9 = self.addLink('s6','s25')
		lss10 = self.addLink('s6','s26')
		lss11 = self.addLink('s7','s33')
		lss12 = self.addLink('s7','s25')
		lss13 = self.addLink('s8','s29')
		lss14 = self.addLink('s9','s10')
		lss15 = self.addLink('s9','s29')
		lss16 = self.addLink('s10','s12')
		lss17 = self.addLink('s10','s29')
		lss18 = self.addLink('s11','s28')
		lss19 = self.addLink('s11','s30')
		lss20 = self.addLink('s12','s17')
		lss21 = self.addLink('s12','s13')
		lss22 = self.addLink('s13','s24')
		lss23 = self.addLink('s13','s29')
		lss24 = self.addLink('s14','s15')
		lss25 = self.addLink('s15','s17')
		lss26 = self.addLink('s16','s24')
		lss27 = self.addLink('s16','s31')
		lss28 = self.addLink('s17','s20')
		lss29 = self.addLink('s17','s18')
		lss30 = self.addLink('s18','s19')
		lss31 = self.addLink('s19','s21')
		lss32 = self.addLink('s20','s21')
		lss33 = self.addLink('s24','s31')
		lss34 = self.addLink('s25','s26')
		lss35 = self.addLink('s25','s31')
		lss36 = self.addLink('s26','s27')
		lss37 = self.addLink('s26','s30')
		lss38 = self.addLink('s27','s28')
		lss39 = self.addLink('s27','s30')
		lss40 = self.addLink('s28','s29')
		lss41 = self.addLink('s28','s30')
		lss42 = self.addLink('s29','s33')
		lss43 = self.addLink('s29','s30')
		lss44 = self.addLink('s29','s31')
		lss45 = self.addLink('s30','s34')
