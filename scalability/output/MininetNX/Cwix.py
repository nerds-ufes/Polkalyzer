...
class MininetNX( Topo ):
	def build( self ):
		...
		lss7 = self.addLink('s6','s14',**linkSSParameters)
		...
		lss12 = self.addLink('s10','s20',**linkSSParameters)
		lss13 = self.addLink('s11','s19',**linkSSParameters)
		lss14 = self.addLink('s11','s32',**linkSSParameters)
		lss15 = self.addLink('s11','s33',**linkSSParameters)
		lss16 = self.addLink('s11','s34',**linkSSParameters)
		lss17 = self.addLink('s11','s35',**linkSSParameters)
		lss18 = self.addLink('s11','s30',**linkSSParameters)
		lss19 = self.addLink('s11','s31',**linkSSParameters)
		...
		lss23 = self.addLink('s14','s16',**linkSSParameters)
		lss24 = self.addLink('s14','s26',**linkSSParameters)
		lss25 = self.addLink('s14','s27',**linkSSParameters)
		lss26 = self.addLink('s14','s28',**linkSSParameters)
		lss27 = self.addLink('s14','s29',**linkSSParameters)
		lss28 = self.addLink('s17','s19',**linkSSParameters)
		lss29 = self.addLink('s17','s18',**linkSSParameters)
		lss30 = self.addLink('s19','s25',**linkSSParameters)
		lss31 = self.addLink('s20','s21',**linkSSParameters)
		lss32 = self.addLink('s22','s23',**linkSSParameters)
		lss33 = self.addLink('s23','s25',**linkSSParameters)
