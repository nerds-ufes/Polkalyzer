...
class MininetNX( Topo ):
	def build( self ):
		...
		lss7 = self.addLink('s5','s17',**linkSSParameters)
		lss8 = self.addLink('s5','s6',**linkSSParameters)
		lss9 = self.addLink('s6','s8',**linkSSParameters)
		lss10 = self.addLink('s6','s14',**linkSSParameters)
		...
		lss15 = self.addLink('s10','s20',**linkSSParameters)
		lss16 = self.addLink('s11','s32',**linkSSParameters)
		lss17 = self.addLink('s11','s33',**linkSSParameters)
		lss18 = self.addLink('s11','s34',**linkSSParameters)
		lss19 = self.addLink('s11','s35',**linkSSParameters)
		lss20 = self.addLink('s11','s12',**linkSSParameters)
		lss21 = self.addLink('s11','s19',**linkSSParameters)
		lss22 = self.addLink('s11','s30',**linkSSParameters)
		lss23 = self.addLink('s11','s31',**linkSSParameters)
		...
		lss28 = self.addLink('s14','s26',**linkSSParameters)
		lss29 = self.addLink('s14','s27',**linkSSParameters)
		lss30 = self.addLink('s14','s28',**linkSSParameters)
		lss31 = self.addLink('s14','s29',**linkSSParameters)
		lss32 = self.addLink('s15','s16',**linkSSParameters)
		lss33 = self.addLink('s17','s19',**linkSSParameters)
		lss34 = self.addLink('s17','s18',**linkSSParameters)
		lss35 = self.addLink('s19','s25',**linkSSParameters)
		lss36 = self.addLink('s20','s21',**linkSSParameters)
		lss37 = self.addLink('s21','s22',**linkSSParameters)
		lss38 = self.addLink('s22','s23',**linkSSParameters)
		lss39 = self.addLink('s23','s24',**linkSSParameters)
		lss40 = self.addLink('s23','s25',**linkSSParameters)
		
topos = { 'Cwix': ( lambda: MininetNX() ) }