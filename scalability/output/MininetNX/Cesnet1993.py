...
class MininetNX( Topo ):
	def build( self ):
		...
		lss3 = self.addLink('s1','s4',**linkSSParameters)
		lss4 = self.addLink('s1','s5',**linkSSParameters)
		lss5 = self.addLink('s1','s7',**linkSSParameters)
		lss6 = self.addLink('s1','s9',**linkSSParameters)
