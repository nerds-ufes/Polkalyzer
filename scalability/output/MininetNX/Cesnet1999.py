...
class MininetNX( Topo ):
	def build( self ):
		...
		lss0 = self.addLink('s0','s2',**linkSSParameters)
		lss1 = self.addLink('s1','s2',**linkSSParameters)
		lss2 = self.addLink('s2','s3',**linkSSParameters)
		lss3 = self.addLink('s2','s4',**linkSSParameters)
		lss4 = self.addLink('s2','s5',**linkSSParameters)
		lss5 = self.addLink('s2','s6',**linkSSParameters)
		lss6 = self.addLink('s2','s7',**linkSSParameters)
		lss7 = self.addLink('s2','s9',**linkSSParameters)
		lss8 = self.addLink('s2','s12',**linkSSParameters)
...
topos = { 'Cesnet1999': ( lambda: MininetNX() ) }