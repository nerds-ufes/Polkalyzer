...
class MininetNX( Topo ):
	def build( self ):
		...
		lhs8 = self.addLink('s5','h8',**linkHSParameters)
		lhs9 = self.addLink('s5','h9',**linkHSParameters)
		lhs10 = self.addLink('s6','h10',**linkHSParameters)
		lhs11 = self.addLink('s6','h11',**linkHSParameters)
		lhs12 = self.addLink('s7','h12',**linkHSParameters)
		lhs13 = self.addLink('s7','h13',**linkHSParameters)
		lhs14 = self.addLink('s8','h14',**linkHSParameters)
		lhs15 = self.addLink('s8','h15',**linkHSParameters)
		lhs16 = self.addLink('s9','h16',**linkHSParameters)
		lhs17 = self.addLink('s9','h17',**linkHSParameters)
		lhs18 = self.addLink('s10','h18',**linkHSParameters)
		lhs19 = self.addLink('s10','h19',**linkHSParameters)
		lhs20 = self.addLink('s11','h20',**linkHSParameters)
		lhs21 = self.addLink('s11','h21',**linkHSParameters)
		lhs22 = self.addLink('s12','h22',**linkHSParameters)
		lhs23 = self.addLink('s12','h23',**linkHSParameters)
		lhs24 = self.addLink('s13','h24',**linkHSParameters)
		lhs25 = self.addLink('s13','h25',**linkHSParameters)
		...
		lss10 = self.addLink('s9','s13',**linkSSParameters)
		lss11 = self.addLink('s10','s15',**linkSSParameters)
		lss12 = self.addLink('s11','s16',**linkSSParameters)
		lss13 = self.addLink('s11','s12',**linkSSParameters)
		lss14 = self.addLink('s12','s13',**linkSSParameters)
		lss15 = self.addLink('s13','s17',**linkSSParameters)
