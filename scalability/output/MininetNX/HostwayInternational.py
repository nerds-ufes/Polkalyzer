...
class MininetNX( Topo ):
	def build( self ):
		...
		lss1 = self.addLink('s0','s6',**linkSSParameters)
		lss2 = self.addLink('s1','s2',**linkSSParameters)
		lss3 = self.addLink('s2','s8',**linkSSParameters)
		lss4 = self.addLink('s2','s14',**linkSSParameters)
		lss5 = self.addLink('s3','s6',**linkSSParameters)
		lss6 = self.addLink('s3','s4',**linkSSParameters)
		...
		lss11 = self.addLink('s10','s12',**linkSSParameters)
		lss12 = self.addLink('s10','s15',**linkSSParameters)
		lss13 = self.addLink('s11','s12',**linkSSParameters)
		lss14 = self.addLink('s13','s14',**linkSSParameters)
		
topos = { 'HostwayInternational': ( lambda: MininetNX() ) }