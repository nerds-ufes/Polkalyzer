...
class MininetNX( Topo ):
	def build( self ):
		...
		lss6 = self.addLink('s0','s8',**linkSSParameters)
		lss7 = self.addLink('s1','s2',**linkSSParameters)
		...
		lss11 = self.addLink('s7','s14',**linkSSParameters)
		lss12 = self.addLink('s7','s18',**linkSSParameters)
		lss13 = self.addLink('s7','s19',**linkSSParameters)
		lss14 = self.addLink('s7','s20',**linkSSParameters)
		lss15 = self.addLink('s7','s21',**linkSSParameters)
		lss16 = self.addLink('s7','s22',**linkSSParameters)
		lss17 = self.addLink('s7','s23',**linkSSParameters)
		lss18 = self.addLink('s7','s24',**linkSSParameters)
		lss19 = self.addLink('s7','s25',**linkSSParameters)
		lss20 = self.addLink('s7','s26',**linkSSParameters)
		lss21 = self.addLink('s7','s27',**linkSSParameters)
		lss22 = self.addLink('s7','s28',**linkSSParameters)
		lss23 = self.addLink('s7','s29',**linkSSParameters)
		lss24 = self.addLink('s8','s12',**linkSSParameters)
		lss25 = self.addLink('s8','s13',**linkSSParameters)
		lss26 = self.addLink('s14','s17',**linkSSParameters)
		lss27 = self.addLink('s14','s15',**linkSSParameters)
		lss28 = self.addLink('s15','s16',**linkSSParameters)
		
topos = { 'Cynet': ( lambda: MininetNX() ) }