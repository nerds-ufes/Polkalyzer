...
class MininetNX( Topo ):
	def build( self ):
		...
		lss4 = self.addLink('s0','s6')
		lss5 = self.addLink('s0','s7')
		lss6 = self.addLink('s0','s8')
		lss7 = self.addLink('s1','s2')
		lss8 = self.addLink('s6','s9')
		lss9 = self.addLink('s6','s10')
		lss10 = self.addLink('s7','s11')
		lss11 = self.addLink('s7','s14')
		lss12 = self.addLink('s7','s18')
		lss13 = self.addLink('s7','s19')
		lss14 = self.addLink('s7','s20')
		lss15 = self.addLink('s7','s21')
		lss16 = self.addLink('s7','s22')
		lss17 = self.addLink('s7','s23')
		lss18 = self.addLink('s7','s24')
		lss19 = self.addLink('s7','s25')
		lss20 = self.addLink('s7','s26')
		lss21 = self.addLink('s7','s27')
		lss22 = self.addLink('s7','s28')
		lss23 = self.addLink('s7','s29')
		lss24 = self.addLink('s8','s12')
		lss25 = self.addLink('s8','s13')
		lss26 = self.addLink('s14','s17')
