...
class MininetNX( Topo ):
	def build( self ):
		...
		lss8 = self.addLink('s8','s9',**linkSSParameters)
		lss9 = self.addLink('s8','s10',**linkSSParameters)
		lss10 = self.addLink('s8','s11',**linkSSParameters)
		lss11 = self.addLink('s10','s13',**linkSSParameters)
		lss12 = self.addLink('s11','s12',**linkSSParameters)
		lss13 = self.addLink('s13','s14',**linkSSParameters)
		
topos = { 'Spiralight': ( lambda: MininetNX() ) }