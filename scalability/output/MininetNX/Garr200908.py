...
class MininetNX( Topo ):
	def build( self ):
		...
		lss0 = self.addLink('s0','s50')
		lss1 = self.addLink('s1','s45')
		lss2 = self.addLink('s2','s6')
		lss3 = self.addLink('s2','s17')
		lss4 = self.addLink('s2','s44')
		lss5 = self.addLink('s2','s14')
		lss6 = self.addLink('s2','s16')
		lss7 = self.addLink('s2','s49')
		lss8 = self.addLink('s2','s18')
		lss9 = self.addLink('s2','s53')
		lss10 = self.addLink('s2','s22')
		lss11 = self.addLink('s2','s30')
		lss12 = self.addLink('s3','s42')
		lss13 = self.addLink('s3','s43')
		lss14 = self.addLink('s3','s44')
		lss15 = self.addLink('s3','s38')
		lss16 = self.addLink('s4','s49')
		lss17 = self.addLink('s5','s50')
		lss18 = self.addLink('s6','s48')
		lss19 = self.addLink('s6','s45')
		lss20 = self.addLink('s6','s46')
		lss21 = self.addLink('s7','s20')
		lss22 = self.addLink('s8','s44')
		lss23 = self.addLink('s9','s42')
		lss24 = self.addLink('s10','s42')
		lss25 = self.addLink('s11','s44')
		lss26 = self.addLink('s12','s42')
		...
		lss36 = self.addLink('s20','s49')
		lss37 = self.addLink('s23','s30')
		lss38 = self.addLink('s24','s25')
		lss39 = self.addLink('s25','s49')
		...
		lss48 = self.addLink('s32','s51')
		lss49 = self.addLink('s33','s34')
		lss50 = self.addLink('s33','s35')
		lss51 = self.addLink('s36','s44')
		lss52 = self.addLink('s37','s44')
		lss53 = self.addLink('s38','s39')
		lss54 = self.addLink('s39','s40')
		lss55 = self.addLink('s39','s49')
		lss56 = self.addLink('s39','s42')
		lss57 = self.addLink('s41','s50')
		lss58 = self.addLink('s42','s44')
		lss59 = self.addLink('s42','s49')
		lss60 = self.addLink('s42','s50')
		lss61 = self.addLink('s43','s44')
		lss62 = self.addLink('s44','s45')
		lss63 = self.addLink('s44','s46')
		lss64 = self.addLink('s44','s50')
		lss65 = self.addLink('s47','s48')
		lss66 = self.addLink('s48','s49')
		lss67 = self.addLink('s48','s52')
