...
class MininetNX( Topo ):
	def build( self ):
		...
		lss2 = self.addLink('s2','s44',**linkSSParameters)
		lss3 = self.addLink('s2','s6',**linkSSParameters)
		lss4 = self.addLink('s2','s17',**linkSSParameters)
		...
		lss8 = self.addLink('s2','s53',**linkSSParameters)
		lss9 = self.addLink('s2','s22',**linkSSParameters)
		lss10 = self.addLink('s2','s30',**linkSSParameters)
		lss11 = self.addLink('s3','s42',**linkSSParameters)
		lss12 = self.addLink('s3','s38',**linkSSParameters)
		lss13 = self.addLink('s4','s49',**linkSSParameters)
		lss14 = self.addLink('s5','s50',**linkSSParameters)
		lss15 = self.addLink('s7','s20',**linkSSParameters)
		lss16 = self.addLink('s8','s44',**linkSSParameters)
		lss17 = self.addLink('s9','s42',**linkSSParameters)
		lss18 = self.addLink('s10','s42',**linkSSParameters)
		lss19 = self.addLink('s11','s44',**linkSSParameters)
		lss20 = self.addLink('s12','s42',**linkSSParameters)
		lss21 = self.addLink('s13','s16',**linkSSParameters)
		lss22 = self.addLink('s14','s21',**linkSSParameters)
		lss23 = self.addLink('s15','s16',**linkSSParameters)
		lss24 = self.addLink('s18','s33',**linkSSParameters)
		lss25 = self.addLink('s18','s19',**linkSSParameters)
		lss26 = self.addLink('s20','s49',**linkSSParameters)
		lss27 = self.addLink('s23','s30',**linkSSParameters)
		lss28 = self.addLink('s24','s25',**linkSSParameters)
		lss29 = self.addLink('s25','s49',**linkSSParameters)
		...
		lss36 = self.addLink('s32','s51',**linkSSParameters)
		lss37 = self.addLink('s33','s34',**linkSSParameters)
		lss38 = self.addLink('s33','s35',**linkSSParameters)
		lss39 = self.addLink('s36','s44',**linkSSParameters)
		lss40 = self.addLink('s37','s44',**linkSSParameters)
		lss41 = self.addLink('s39','s42',**linkSSParameters)
		lss42 = self.addLink('s39','s40',**linkSSParameters)
		lss43 = self.addLink('s41','s50',**linkSSParameters)
		lss44 = self.addLink('s42','s50',**linkSSParameters)
		lss45 = self.addLink('s42','s49',**linkSSParameters)
		lss46 = self.addLink('s43','s44',**linkSSParameters)
		lss47 = self.addLink('s44','s50',**linkSSParameters)
		lss48 = self.addLink('s44','s45',**linkSSParameters)
		lss49 = self.addLink('s44','s46',**linkSSParameters)
		lss50 = self.addLink('s47','s48',**linkSSParameters)
		lss51 = self.addLink('s48','s49',**linkSSParameters)
		lss52 = self.addLink('s48','s52',**linkSSParameters)
