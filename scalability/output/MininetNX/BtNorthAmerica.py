...
class MininetNX( Topo ):
	def build( self ):
		...
		lss0 = self.addLink('s0','s33',**linkSSParameters)
		lss1 = self.addLink('s0','s35',**linkSSParameters)
		lss2 = self.addLink('s0','s10',**linkSSParameters)
		lss3 = self.addLink('s0','s13',**linkSSParameters)
		lss4 = self.addLink('s0','s18',**linkSSParameters)
		lss5 = self.addLink('s0','s19',**linkSSParameters)
		lss6 = self.addLink('s0','s24',**linkSSParameters)
		lss7 = self.addLink('s0','s28',**linkSSParameters)
		lss8 = self.addLink('s1','s35',**linkSSParameters)
		lss9 = self.addLink('s1','s13',**linkSSParameters)
		lss10 = self.addLink('s2','s3',**linkSSParameters)
		lss11 = self.addLink('s2','s15',**linkSSParameters)
		lss12 = self.addLink('s3','s13',**linkSSParameters)
		lss13 = self.addLink('s4','s5',**linkSSParameters)
		lss14 = self.addLink('s4','s6',**linkSSParameters)
		lss15 = self.addLink('s5','s9',**linkSSParameters)
		lss16 = self.addLink('s5','s27',**linkSSParameters)
		lss17 = self.addLink('s6','s7',**linkSSParameters)
		lss18 = self.addLink('s7','s8',**linkSSParameters)
		lss19 = self.addLink('s7','s9',**linkSSParameters)
		lss20 = self.addLink('s8','s9',**linkSSParameters)
		lss21 = self.addLink('s9','s33',**linkSSParameters)
		lss22 = self.addLink('s9','s10',**linkSSParameters)
		lss23 = self.addLink('s9','s11',**linkSSParameters)
		lss24 = self.addLink('s9','s23',**linkSSParameters)
		lss25 = self.addLink('s9','s27',**linkSSParameters)
		lss26 = self.addLink('s9','s28',**linkSSParameters)
		lss27 = self.addLink('s9','s30',**linkSSParameters)
		lss28 = self.addLink('s10','s11',**linkSSParameters)
		lss29 = self.addLink('s10','s12',**linkSSParameters)
		lss30 = self.addLink('s10','s13',**linkSSParameters)
		lss31 = self.addLink('s10','s20',**linkSSParameters)
		lss32 = self.addLink('s10','s22',**linkSSParameters)
		lss33 = self.addLink('s12','s13',**linkSSParameters)
		lss34 = self.addLink('s13','s14',**linkSSParameters)
		lss35 = self.addLink('s13','s18',**linkSSParameters)
		lss36 = self.addLink('s13','s27',**linkSSParameters)
		lss37 = self.addLink('s14','s15',**linkSSParameters)
		lss38 = self.addLink('s15','s20',**linkSSParameters)
		lss39 = self.addLink('s15','s35',**linkSSParameters)
		lss40 = self.addLink('s15','s28',**linkSSParameters)
		lss41 = self.addLink('s16','s17',**linkSSParameters)
		lss42 = self.addLink('s16','s18',**linkSSParameters)
		lss43 = self.addLink('s16','s35',**linkSSParameters)
		lss44 = self.addLink('s17','s35',**linkSSParameters)
		lss45 = self.addLink('s18','s19',**linkSSParameters)
		lss46 = self.addLink('s18','s20',**linkSSParameters)
		lss47 = self.addLink('s18','s24',**linkSSParameters)
		lss48 = self.addLink('s19','s24',**linkSSParameters)
		lss49 = self.addLink('s20','s21',**linkSSParameters)
		lss50 = self.addLink('s21','s22',**linkSSParameters)
		lss51 = self.addLink('s21','s23',**linkSSParameters)
		lss52 = self.addLink('s23','s24',**linkSSParameters)
		lss53 = self.addLink('s24','s33',**linkSSParameters)
		lss54 = self.addLink('s24','s25',**linkSSParameters)
		lss55 = self.addLink('s24','s26',**linkSSParameters)
		lss56 = self.addLink('s24','s30',**linkSSParameters)
		lss57 = self.addLink('s25','s33',**linkSSParameters)
		lss58 = self.addLink('s25','s26',**linkSSParameters)
		lss59 = self.addLink('s26','s27',**linkSSParameters)
		lss60 = self.addLink('s26','s29',**linkSSParameters)
		lss61 = self.addLink('s26','s33',**linkSSParameters)
		lss62 = self.addLink('s27','s33',**linkSSParameters)
		lss63 = self.addLink('s27','s28',**linkSSParameters)
		lss64 = self.addLink('s28','s29',**linkSSParameters)
		lss65 = self.addLink('s28','s30',**linkSSParameters)
		lss66 = self.addLink('s28','s31',**linkSSParameters)
		lss67 = self.addLink('s29','s33',**linkSSParameters)
		lss68 = self.addLink('s29','s34',**linkSSParameters)
		lss69 = self.addLink('s29','s31',**linkSSParameters)
		lss70 = self.addLink('s30','s32',**linkSSParameters)
		lss71 = self.addLink('s30','s33',**linkSSParameters)
		lss72 = self.addLink('s30','s34',**linkSSParameters)
		lss73 = self.addLink('s30','s31',**linkSSParameters)
		lss74 = self.addLink('s31','s32',**linkSSParameters)
		lss75 = self.addLink('s31','s33',**linkSSParameters)
