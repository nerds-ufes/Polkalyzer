...
class MininetNX( Topo ):
	def build( self ):
		...
		lss10 = self.addLink('s3','s13',**linkSSParameters)
		lss11 = self.addLink('s4','s5',**linkSSParameters)
		lss12 = self.addLink('s5','s9',**linkSSParameters)
		lss13 = self.addLink('s6','s7',**linkSSParameters)
		lss14 = self.addLink('s7','s9',**linkSSParameters)
		lss15 = self.addLink('s8','s9',**linkSSParameters)
		lss16 = self.addLink('s9','s33',**linkSSParameters)
		lss17 = self.addLink('s10','s11',**linkSSParameters)
		lss18 = self.addLink('s10','s12',**linkSSParameters)
		lss19 = self.addLink('s10','s20',**linkSSParameters)
		lss20 = self.addLink('s10','s22',**linkSSParameters)
		lss21 = self.addLink('s13','s14',**linkSSParameters)
		lss22 = self.addLink('s15','s35',**linkSSParameters)
		lss23 = self.addLink('s16','s35',**linkSSParameters)
		lss24 = self.addLink('s17','s35',**linkSSParameters)
		lss25 = self.addLink('s20','s21',**linkSSParameters)
		lss26 = self.addLink('s23','s24',**linkSSParameters)
		lss27 = self.addLink('s25','s33',**linkSSParameters)
		lss28 = self.addLink('s26','s33',**linkSSParameters)
		lss29 = self.addLink('s27','s33',**linkSSParameters)
		lss30 = self.addLink('s29','s33',**linkSSParameters)
		lss31 = self.addLink('s29','s34',**linkSSParameters)
		lss32 = self.addLink('s30','s33',**linkSSParameters)
		lss33 = self.addLink('s30','s32',**linkSSParameters)
