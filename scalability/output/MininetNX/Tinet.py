...
class MininetNX( Topo ):
	def build( self ):
		...
		lss2 = self.addLink('s1','s48',**linkSSParameters)
		lss3 = self.addLink('s1','s50',**linkSSParameters)
		lss4 = self.addLink('s1','s2',**linkSSParameters)
		lss5 = self.addLink('s1','s47',**linkSSParameters)
		lss6 = self.addLink('s2','s5',**linkSSParameters)
		lss7 = self.addLink('s2','s47',**linkSSParameters)
		lss8 = self.addLink('s3','s50',**linkSSParameters)
		lss9 = self.addLink('s3','s51',**linkSSParameters)
		lss10 = self.addLink('s4','s5',**linkSSParameters)
		lss11 = self.addLink('s4','s7',**linkSSParameters)
		lss12 = self.addLink('s4','s9',**linkSSParameters)
		lss13 = self.addLink('s4','s45',**linkSSParameters)
		lss14 = self.addLink('s4','s13',**linkSSParameters)
		lss15 = self.addLink('s4','s51',**linkSSParameters)
		lss16 = self.addLink('s5','s6',**linkSSParameters)
		lss17 = self.addLink('s6','s8',**linkSSParameters)
		lss18 = self.addLink('s6','s7',**linkSSParameters)
		lss19 = self.addLink('s7','s8',**linkSSParameters)
		lss20 = self.addLink('s7','s13',**linkSSParameters)
		lss21 = self.addLink('s9','s13',**linkSSParameters)
		lss22 = self.addLink('s10','s11',**linkSSParameters)
		lss23 = self.addLink('s10','s14',**linkSSParameters)
		lss24 = self.addLink('s12','s13',**linkSSParameters)
		lss25 = self.addLink('s12','s14',**linkSSParameters)
		lss26 = self.addLink('s13','s52',**linkSSParameters)
		lss27 = self.addLink('s14','s16',**linkSSParameters)
		...
		lss31 = self.addLink('s16','s17',**linkSSParameters)
		lss32 = self.addLink('s16','s18',**linkSSParameters)
		lss33 = self.addLink('s16','s20',**linkSSParameters)
		lss34 = self.addLink('s16','s21',**linkSSParameters)
		lss35 = self.addLink('s17','s42',**linkSSParameters)
		lss36 = self.addLink('s17','s43',**linkSSParameters)
		lss37 = self.addLink('s17','s18',**linkSSParameters)
		lss38 = self.addLink('s17','s19',**linkSSParameters)
		lss39 = self.addLink('s17','s28',**linkSSParameters)
		lss40 = self.addLink('s18','s33',**linkSSParameters)
		lss41 = self.addLink('s18','s41',**linkSSParameters)
		lss42 = self.addLink('s18','s44',**linkSSParameters)
		lss43 = self.addLink('s18','s28',**linkSSParameters)
		lss44 = self.addLink('s19','s20',**linkSSParameters)
		lss45 = self.addLink('s20','s21',**linkSSParameters)
		lss46 = self.addLink('s21','s49',**linkSSParameters)
		lss47 = self.addLink('s21','s23',**linkSSParameters)
		lss48 = self.addLink('s21','s24',**linkSSParameters)
		lss49 = self.addLink('s21','s27',**linkSSParameters)
		lss50 = self.addLink('s21','s28',**linkSSParameters)
		lss51 = self.addLink('s22','s49',**linkSSParameters)
		lss52 = self.addLink('s22','s23',**linkSSParameters)
		lss53 = self.addLink('s23','s24',**linkSSParameters)
		lss54 = self.addLink('s23','s25',**linkSSParameters)
		lss55 = self.addLink('s23','s48',**linkSSParameters)
		lss56 = self.addLink('s24','s25',**linkSSParameters)
		lss57 = self.addLink('s24','s34',**linkSSParameters)
		lss58 = self.addLink('s24','s36',**linkSSParameters)
		lss59 = self.addLink('s25','s26',**linkSSParameters)
		lss60 = self.addLink('s25','s28',**linkSSParameters)
		lss61 = self.addLink('s25','s37',**linkSSParameters)
		lss62 = self.addLink('s26','s27',**linkSSParameters)
		lss63 = self.addLink('s27','s28',**linkSSParameters)
		lss64 = self.addLink('s27','s29',**linkSSParameters)
		lss65 = self.addLink('s28','s32',**linkSSParameters)
		lss66 = self.addLink('s28','s33',**linkSSParameters)
		lss67 = self.addLink('s28','s39',**linkSSParameters)
		lss68 = self.addLink('s28','s46',**linkSSParameters)
		lss69 = self.addLink('s28','s29',**linkSSParameters)
		lss70 = self.addLink('s28','s30',**linkSSParameters)
		lss71 = self.addLink('s29','s30',**linkSSParameters)
		lss72 = self.addLink('s30','s39',**linkSSParameters)
		lss73 = self.addLink('s30','s46',**linkSSParameters)
		lss74 = self.addLink('s30','s31',**linkSSParameters)
		lss75 = self.addLink('s31','s32',**linkSSParameters)
		lss76 = self.addLink('s32','s33',**linkSSParameters)
		lss77 = self.addLink('s34','s35',**linkSSParameters)
		lss78 = self.addLink('s35','s36',**linkSSParameters)
		lss79 = self.addLink('s35','s37',**linkSSParameters)
		lss80 = self.addLink('s37','s38',**linkSSParameters)
		lss81 = self.addLink('s40','s46',**linkSSParameters)
		lss82 = self.addLink('s41','s42',**linkSSParameters)
		lss83 = self.addLink('s42','s43',**linkSSParameters)
		lss84 = self.addLink('s42','s44',**linkSSParameters)
		lss85 = self.addLink('s43','s44',**linkSSParameters)
		lss86 = self.addLink('s47','s48',**linkSSParameters)
		lss87 = self.addLink('s50','s52',**linkSSParameters)
		lss88 = self.addLink('s51','s52',**linkSSParameters)
		
topos = { 'Tinet': ( lambda: MininetNX() ) }