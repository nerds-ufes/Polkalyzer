...
class MininetNX( Topo ):
	def build( self ):
		...
		lss7 = self.addLink('s3','s50',**linkSSParameters)
		lss8 = self.addLink('s4','s9',**linkSSParameters)
		lss9 = self.addLink('s4','s7',**linkSSParameters)
		lss10 = self.addLink('s4','s45',**linkSSParameters)
		lss11 = self.addLink('s4','s51',**linkSSParameters)
		lss12 = self.addLink('s5','s6',**linkSSParameters)
		lss13 = self.addLink('s7','s8',**linkSSParameters)
		lss14 = self.addLink('s9','s13',**linkSSParameters)
		lss15 = self.addLink('s10','s14',**linkSSParameters)
		lss16 = self.addLink('s10','s11',**linkSSParameters)
		lss17 = self.addLink('s12','s13',**linkSSParameters)
		lss18 = self.addLink('s12','s14',**linkSSParameters)
		lss19 = self.addLink('s14','s15',**linkSSParameters)
		lss20 = self.addLink('s16','s21',**linkSSParameters)
		lss21 = self.addLink('s16','s17',**linkSSParameters)
		lss22 = self.addLink('s16','s18',**linkSSParameters)
		lss23 = self.addLink('s17','s42',**linkSSParameters)
		lss24 = self.addLink('s17','s43',**linkSSParameters)
		lss25 = self.addLink('s18','s41',**linkSSParameters)
		lss26 = self.addLink('s18','s44',**linkSSParameters)
		lss27 = self.addLink('s19','s20',**linkSSParameters)
		lss28 = self.addLink('s20','s21',**linkSSParameters)
		lss29 = self.addLink('s21','s23',**linkSSParameters)
		lss30 = self.addLink('s21','s49',**linkSSParameters)
		lss31 = self.addLink('s21','s27',**linkSSParameters)
		lss32 = self.addLink('s21','s28',**linkSSParameters)
		lss33 = self.addLink('s22','s23',**linkSSParameters)
		lss34 = self.addLink('s23','s48',**linkSSParameters)
		lss35 = self.addLink('s23','s24',**linkSSParameters)
		lss36 = self.addLink('s23','s25',**linkSSParameters)
		lss37 = self.addLink('s24','s34',**linkSSParameters)
		lss38 = self.addLink('s24','s36',**linkSSParameters)
		lss39 = self.addLink('s25','s26',**linkSSParameters)
		lss40 = self.addLink('s25','s37',**linkSSParameters)
		lss41 = self.addLink('s27','s29',**linkSSParameters)
		lss42 = self.addLink('s28','s32',**linkSSParameters)
		lss43 = self.addLink('s28','s33',**linkSSParameters)
		lss44 = self.addLink('s28','s39',**linkSSParameters)
		lss45 = self.addLink('s28','s46',**linkSSParameters)
		lss46 = self.addLink('s28','s30',**linkSSParameters)
		lss47 = self.addLink('s31','s32',**linkSSParameters)
		lss48 = self.addLink('s34','s35',**linkSSParameters)
		lss49 = self.addLink('s37','s38',**linkSSParameters)
		lss50 = self.addLink('s40','s46',**linkSSParameters)
		lss51 = self.addLink('s50','s52',**linkSSParameters)
