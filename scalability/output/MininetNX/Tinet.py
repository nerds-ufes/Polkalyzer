...
class MininetNX( Topo ):
	def build( self ):
		...
		lss1 = self.addLink('s0','s9')
		lss2 = self.addLink('s1','s48')
		lss3 = self.addLink('s1','s50')
		lss4 = self.addLink('s1','s2')
		lss5 = self.addLink('s1','s47')
		lss6 = self.addLink('s2','s5')
		lss7 = self.addLink('s2','s47')
		lss8 = self.addLink('s3','s50')
		lss9 = self.addLink('s3','s51')
		lss10 = self.addLink('s4','s5')
		lss11 = self.addLink('s4','s7')
		lss12 = self.addLink('s4','s9')
		lss13 = self.addLink('s4','s45')
		lss14 = self.addLink('s4','s13')
		lss15 = self.addLink('s4','s51')
		lss16 = self.addLink('s5','s6')
		lss17 = self.addLink('s6','s8')
		lss18 = self.addLink('s6','s7')
		lss19 = self.addLink('s7','s8')
		lss20 = self.addLink('s7','s13')
		lss21 = self.addLink('s9','s13')
		lss22 = self.addLink('s10','s11')
		lss23 = self.addLink('s10','s14')
		lss24 = self.addLink('s12','s13')
		lss25 = self.addLink('s12','s14')
		lss26 = self.addLink('s13','s52')
		lss27 = self.addLink('s14','s16')
		lss28 = self.addLink('s14','s15')
		lss29 = self.addLink('s15','s16')
		lss30 = self.addLink('s15','s17')
		lss31 = self.addLink('s16','s17')
		lss32 = self.addLink('s16','s18')
		lss33 = self.addLink('s16','s20')
		lss34 = self.addLink('s16','s21')
		lss35 = self.addLink('s17','s42')
		lss36 = self.addLink('s17','s43')
		lss37 = self.addLink('s17','s18')
		lss38 = self.addLink('s17','s19')
		lss39 = self.addLink('s17','s28')
		lss40 = self.addLink('s18','s33')
		lss41 = self.addLink('s18','s41')
		lss42 = self.addLink('s18','s44')
		lss43 = self.addLink('s18','s28')
		lss44 = self.addLink('s19','s20')
		lss45 = self.addLink('s20','s21')
		lss46 = self.addLink('s21','s49')
		lss47 = self.addLink('s21','s23')
		lss48 = self.addLink('s21','s24')
		lss49 = self.addLink('s21','s27')
		lss50 = self.addLink('s21','s28')
		lss51 = self.addLink('s22','s49')
		lss52 = self.addLink('s22','s23')
		lss53 = self.addLink('s23','s24')
		lss54 = self.addLink('s23','s25')
		lss55 = self.addLink('s23','s48')
		lss56 = self.addLink('s24','s25')
		lss57 = self.addLink('s24','s34')
		lss58 = self.addLink('s24','s36')
		lss59 = self.addLink('s25','s26')
		lss60 = self.addLink('s25','s28')
		lss61 = self.addLink('s25','s37')
		lss62 = self.addLink('s26','s27')
		lss63 = self.addLink('s27','s28')
		lss64 = self.addLink('s27','s29')
		lss65 = self.addLink('s28','s32')
		lss66 = self.addLink('s28','s33')
		lss67 = self.addLink('s28','s39')
		lss68 = self.addLink('s28','s46')
		lss69 = self.addLink('s28','s29')
		lss70 = self.addLink('s28','s30')
		lss71 = self.addLink('s29','s30')
		lss72 = self.addLink('s30','s39')
		lss73 = self.addLink('s30','s46')
		lss74 = self.addLink('s30','s31')
		lss75 = self.addLink('s31','s32')
		lss76 = self.addLink('s32','s33')
		lss77 = self.addLink('s34','s35')
		lss78 = self.addLink('s35','s36')
		lss79 = self.addLink('s35','s37')
		lss80 = self.addLink('s37','s38')
		lss81 = self.addLink('s40','s46')
		lss82 = self.addLink('s41','s42')
		lss83 = self.addLink('s42','s43')
		lss84 = self.addLink('s42','s44')
		lss85 = self.addLink('s43','s44')
		lss86 = self.addLink('s47','s48')
		lss87 = self.addLink('s50','s52')
		lss88 = self.addLink('s51','s52')
