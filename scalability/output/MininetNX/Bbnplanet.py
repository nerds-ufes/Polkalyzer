...
class MininetNX( Topo ):
	def build( self ):
		...
		lss1 = self.addLink('s1','s8',**linkSSParameters)
		...
		lss24 = self.addLink('s22','s25',**linkSSParameters)
		lss25 = self.addLink('s22','s23',**linkSSParameters)
		lss26 = self.addLink('s24','s25',**linkSSParameters)
		lss27 = self.addLink('s25','s26',**linkSSParameters)
		
topos = { 'Bbnplanet': ( lambda: MininetNX() ) }