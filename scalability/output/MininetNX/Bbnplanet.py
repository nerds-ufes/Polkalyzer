...
class MininetNX( Topo ):
	def build( self ):
		...
		lss1 = self.addLink('s1','s8')
		lss2 = self.addLink('s1','s2')
		lss3 = self.addLink('s1','s4')
		lss4 = self.addLink('s3','s4')
		lss5 = self.addLink('s4','s5')
		lss6 = self.addLink('s4','s25')
		lss7 = self.addLink('s5','s9')
		lss8 = self.addLink('s5','s6')
		lss9 = self.addLink('s5','s7')
		lss10 = self.addLink('s8','s18')
		lss11 = self.addLink('s9','s10')
		lss12 = self.addLink('s9','s11')
		lss13 = self.addLink('s9','s13')
		lss14 = self.addLink('s12','s13')
		lss15 = self.addLink('s13','s25')
		lss16 = self.addLink('s14','s15')
		lss17 = self.addLink('s15','s16')
		lss18 = self.addLink('s15','s17')
		lss19 = self.addLink('s15','s18')
		lss20 = self.addLink('s15','s22')
		lss21 = self.addLink('s18','s19')
		lss22 = self.addLink('s18','s20')
		lss23 = self.addLink('s21','s22')
		lss24 = self.addLink('s22','s25')
		lss25 = self.addLink('s22','s23')
		lss26 = self.addLink('s24','s25')
		lss27 = self.addLink('s25','s26')
