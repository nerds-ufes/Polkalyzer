...
class MininetNX( Topo ):
	def build( self ):
		...
		lss14 = self.addLink('s13','s25',**linkSSParameters)
		lss15 = self.addLink('s14','s15',**linkSSParameters)
		lss16 = self.addLink('s15','s18',**linkSSParameters)
		...
		lss20 = self.addLink('s18','s20',**linkSSParameters)
		lss21 = self.addLink('s21','s22',**linkSSParameters)
		lss22 = self.addLink('s22','s25',**linkSSParameters)
		lss23 = self.addLink('s22','s23',**linkSSParameters)
		lss24 = self.addLink('s24','s25',**linkSSParameters)
