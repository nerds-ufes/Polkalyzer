...
class MininetNX( Topo ):
	def build( self ):
		...
		lss11 = self.addLink('s4','s15',**linkSSParameters)
		lss12 = self.addLink('s4','s22',**linkSSParameters)
		lss13 = self.addLink('s4','s25',**linkSSParameters)
		lss14 = self.addLink('s4','s26',**linkSSParameters)
		lss15 = self.addLink('s5','s12',**linkSSParameters)
		lss16 = self.addLink('s6','s28',**linkSSParameters)
		lss17 = self.addLink('s7','s24',**linkSSParameters)
		lss18 = self.addLink('s7','s10',**linkSSParameters)
		lss19 = self.addLink('s7','s15',**linkSSParameters)
		lss20 = self.addLink('s7','s23',**linkSSParameters)
		lss21 = self.addLink('s11','s12',**linkSSParameters)
		lss22 = self.addLink('s11','s27',**linkSSParameters)
		lss23 = self.addLink('s12','s19',**linkSSParameters)
		lss24 = self.addLink('s12','s13',**linkSSParameters)
		lss25 = self.addLink('s14','s17',**linkSSParameters)
		lss26 = self.addLink('s14','s19',**linkSSParameters)
		lss27 = self.addLink('s14','s15',**linkSSParameters)
		lss28 = self.addLink('s15','s16',**linkSSParameters)
		lss29 = self.addLink('s15','s17',**linkSSParameters)
		lss30 = self.addLink('s15','s18',**linkSSParameters)
		lss31 = self.addLink('s19','s20',**linkSSParameters)
		lss32 = self.addLink('s19','s21',**linkSSParameters)
		
topos = { 'Cesnet200304': ( lambda: MininetNX() ) }