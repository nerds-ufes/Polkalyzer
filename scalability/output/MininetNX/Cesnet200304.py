...
class MininetNX( Topo ):
	def build( self ):
		...
		lss9 = self.addLink('s4','s11',**linkSSParameters)
		lss10 = self.addLink('s4','s15',**linkSSParameters)
		lss11 = self.addLink('s4','s22',**linkSSParameters)
		lss12 = self.addLink('s4','s25',**linkSSParameters)
		lss13 = self.addLink('s4','s26',**linkSSParameters)
		lss14 = self.addLink('s5','s12',**linkSSParameters)
		lss15 = self.addLink('s6','s28',**linkSSParameters)
		lss16 = self.addLink('s7','s24',**linkSSParameters)
		lss17 = self.addLink('s7','s10',**linkSSParameters)
		lss18 = self.addLink('s7','s23',**linkSSParameters)
		lss19 = self.addLink('s11','s27',**linkSSParameters)
		lss20 = self.addLink('s12','s19',**linkSSParameters)
		...
		lss27 = self.addLink('s19','s21',**linkSSParameters)
