...
class MininetNX( Topo ):
	def build( self ):
		...
		lss18 = self.addLink('s5','s12',**linkSSParameters)
		lss19 = self.addLink('s6','s28',**linkSSParameters)
		lss20 = self.addLink('s7','s24',**linkSSParameters)
		lss21 = self.addLink('s7','s10',**linkSSParameters)
		lss22 = self.addLink('s7','s15',**linkSSParameters)
		lss23 = self.addLink('s7','s23',**linkSSParameters)
		lss24 = self.addLink('s11','s12',**linkSSParameters)
		lss25 = self.addLink('s11','s27',**linkSSParameters)
		lss26 = self.addLink('s11','s36',**linkSSParameters)
		lss27 = self.addLink('s12','s33',**linkSSParameters)
		lss28 = self.addLink('s12','s13',**linkSSParameters)
		lss29 = self.addLink('s12','s14',**linkSSParameters)
		lss30 = self.addLink('s14','s17',**linkSSParameters)
		lss31 = self.addLink('s14','s19',**linkSSParameters)
		lss32 = self.addLink('s14','s15',**linkSSParameters)
		lss33 = self.addLink('s15','s35',**linkSSParameters)
		lss34 = self.addLink('s15','s37',**linkSSParameters)
		lss35 = self.addLink('s15','s16',**linkSSParameters)
		lss36 = self.addLink('s15','s17',**linkSSParameters)
		lss37 = self.addLink('s15','s18',**linkSSParameters)
		lss38 = self.addLink('s15','s19',**linkSSParameters)
		lss39 = self.addLink('s19','s21',**linkSSParameters)
		lss40 = self.addLink('s19','s20',**linkSSParameters)
		lss41 = self.addLink('s19','s38',**linkSSParameters)
		lss42 = self.addLink('s21','s34',**linkSSParameters)
		lss43 = self.addLink('s29','s36',**linkSSParameters)
		
topos = { 'Cesnet200511': ( lambda: MininetNX() ) }