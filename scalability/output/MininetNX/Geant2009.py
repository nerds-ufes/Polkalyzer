...
class MininetNX( Topo ):
	def build( self ):
		...
		lss2 = self.addLink('s2','s13',**linkSSParameters)
		lss3 = self.addLink('s2','s21',**linkSSParameters)
		lss4 = self.addLink('s3','s10',**linkSSParameters)
		...
		lss12 = self.addLink('s10','s16',**linkSSParameters)
		lss13 = self.addLink('s11','s16',**linkSSParameters)
		lss14 = self.addLink('s12','s33',**linkSSParameters)
		lss15 = self.addLink('s12','s13',**linkSSParameters)
		lss16 = self.addLink('s14','s16',**linkSSParameters)
		lss17 = self.addLink('s14','s15',**linkSSParameters)
		lss18 = self.addLink('s16','s32',**linkSSParameters)
		lss19 = self.addLink('s16','s17',**linkSSParameters)
		lss20 = self.addLink('s16','s18',**linkSSParameters)
		lss21 = self.addLink('s16','s24',**linkSSParameters)
		lss22 = self.addLink('s17','s22',**linkSSParameters)
		lss23 = self.addLink('s18','s20',**linkSSParameters)
		lss24 = self.addLink('s19','s33',**linkSSParameters)
		lss25 = self.addLink('s19','s31',**linkSSParameters)
		lss26 = self.addLink('s22','s23',**linkSSParameters)
		lss27 = self.addLink('s23','s28',**linkSSParameters)
		lss28 = self.addLink('s24','s25',**linkSSParameters)
		lss29 = self.addLink('s24','s30',**linkSSParameters)
		lss30 = self.addLink('s25','s26',**linkSSParameters)
		lss31 = self.addLink('s27','s30',**linkSSParameters)
		lss32 = self.addLink('s27','s29',**linkSSParameters)
