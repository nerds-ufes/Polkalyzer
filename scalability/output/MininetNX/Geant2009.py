...
class MininetNX( Topo ):
	def build( self ):
		...
		lss0 = self.addLink('s0','s10')
		lss1 = self.addLink('s1','s2')
		lss2 = self.addLink('s2','s15')
		lss3 = self.addLink('s2','s21')
		lss4 = self.addLink('s2','s13')
		lss5 = self.addLink('s3','s10')
		lss6 = self.addLink('s3','s4')
		lss7 = self.addLink('s4','s10')
		lss8 = self.addLink('s4','s5')
		lss9 = self.addLink('s6','s10')
		lss10 = self.addLink('s6','s7')
		lss11 = self.addLink('s7','s8')
		lss12 = self.addLink('s8','s11')
		lss13 = self.addLink('s9','s16')
		lss14 = self.addLink('s9','s10')
		lss15 = self.addLink('s10','s12')
		lss16 = self.addLink('s10','s16')
		lss17 = self.addLink('s11','s17')
		lss18 = self.addLink('s11','s16')
		lss19 = self.addLink('s12','s16')
		lss20 = self.addLink('s12','s33')
		lss21 = self.addLink('s12','s13')
		lss22 = self.addLink('s14','s16')
		lss23 = self.addLink('s14','s15')
		lss24 = self.addLink('s15','s20')
		lss25 = self.addLink('s15','s18')
		lss26 = self.addLink('s16','s32')
		lss27 = self.addLink('s16','s17')
		lss28 = self.addLink('s16','s18')
		lss29 = self.addLink('s16','s24')
		lss30 = self.addLink('s17','s22')
		lss31 = self.addLink('s18','s19')
		lss32 = self.addLink('s18','s20')
		lss33 = self.addLink('s19','s33')
		lss34 = self.addLink('s19','s20')
		lss35 = self.addLink('s19','s24')
		lss36 = self.addLink('s19','s30')
		lss37 = self.addLink('s19','s31')
		lss38 = self.addLink('s20','s21')
		lss39 = self.addLink('s22','s24')
		lss40 = self.addLink('s22','s23')
		lss41 = self.addLink('s23','s26')
		lss42 = self.addLink('s23','s27')
		lss43 = self.addLink('s23','s28')
		lss44 = self.addLink('s24','s25')
		lss45 = self.addLink('s24','s30')
		lss46 = self.addLink('s25','s26')
		lss47 = self.addLink('s27','s28')
		lss48 = self.addLink('s27','s29')
		lss49 = self.addLink('s27','s30')
		lss50 = self.addLink('s28','s29')
