...
class MininetNX( Topo ):
	def build( self ):
		...
		lss0 = self.addLink('s0','s10',**linkSSParameters)
		lss1 = self.addLink('s1','s2',**linkSSParameters)
		lss2 = self.addLink('s2','s15',**linkSSParameters)
		lss3 = self.addLink('s2','s21',**linkSSParameters)
		...
		lss7 = self.addLink('s4','s10',**linkSSParameters)
		lss8 = self.addLink('s4','s5',**linkSSParameters)
		...
		lss12 = self.addLink('s8','s11',**linkSSParameters)
		lss13 = self.addLink('s9','s16',**linkSSParameters)
		lss14 = self.addLink('s9','s10',**linkSSParameters)
		lss15 = self.addLink('s10','s12',**linkSSParameters)
		lss16 = self.addLink('s10','s16',**linkSSParameters)
		lss17 = self.addLink('s11','s17',**linkSSParameters)
		lss18 = self.addLink('s11','s16',**linkSSParameters)
		lss19 = self.addLink('s12','s16',**linkSSParameters)
		lss20 = self.addLink('s12','s33',**linkSSParameters)
		lss21 = self.addLink('s12','s13',**linkSSParameters)
		lss22 = self.addLink('s14','s16',**linkSSParameters)
		lss23 = self.addLink('s14','s15',**linkSSParameters)
		lss24 = self.addLink('s15','s20',**linkSSParameters)
		lss25 = self.addLink('s15','s18',**linkSSParameters)
		lss26 = self.addLink('s16','s32',**linkSSParameters)
		lss27 = self.addLink('s16','s17',**linkSSParameters)
		lss28 = self.addLink('s16','s18',**linkSSParameters)
		lss29 = self.addLink('s16','s24',**linkSSParameters)
		lss30 = self.addLink('s17','s22',**linkSSParameters)
		lss31 = self.addLink('s18','s19',**linkSSParameters)
		lss32 = self.addLink('s18','s20',**linkSSParameters)
		lss33 = self.addLink('s19','s33',**linkSSParameters)
		lss34 = self.addLink('s19','s20',**linkSSParameters)
		lss35 = self.addLink('s19','s24',**linkSSParameters)
		lss36 = self.addLink('s19','s30',**linkSSParameters)
		lss37 = self.addLink('s19','s31',**linkSSParameters)
		lss38 = self.addLink('s20','s21',**linkSSParameters)
		lss39 = self.addLink('s22','s24',**linkSSParameters)
		lss40 = self.addLink('s22','s23',**linkSSParameters)
		lss41 = self.addLink('s23','s26',**linkSSParameters)
		lss42 = self.addLink('s23','s27',**linkSSParameters)
		lss43 = self.addLink('s23','s28',**linkSSParameters)
		lss44 = self.addLink('s24','s25',**linkSSParameters)
		lss45 = self.addLink('s24','s30',**linkSSParameters)
		lss46 = self.addLink('s25','s26',**linkSSParameters)
		lss47 = self.addLink('s27','s28',**linkSSParameters)
		lss48 = self.addLink('s27','s29',**linkSSParameters)
		lss49 = self.addLink('s27','s30',**linkSSParameters)
		lss50 = self.addLink('s28','s29',**linkSSParameters)
		lss51 = self.addLink('s30','s31',**linkSSParameters)
		
topos = { 'Geant2009': ( lambda: MininetNX() ) }