...
class MininetNX( Topo ):
	def build( self ):
		...
		lss10 = self.addLink('s8','s29',**linkSSParameters)
		...
		lss15 = self.addLink('s12','s14',**linkSSParameters)
		lss16 = self.addLink('s12','s19',**linkSSParameters)
		lss17 = self.addLink('s12','s20',**linkSSParameters)
		lss18 = self.addLink('s12','s24',**linkSSParameters)
		lss19 = self.addLink('s12','s25',**linkSSParameters)
		lss20 = self.addLink('s13','s28',**linkSSParameters)
		lss21 = self.addLink('s14','s15',**linkSSParameters)
		lss22 = self.addLink('s15','s33',**linkSSParameters)
		lss23 = self.addLink('s16','s17',**linkSSParameters)
		lss24 = self.addLink('s16','s22',**linkSSParameters)
		lss25 = self.addLink('s17','s18',**linkSSParameters)
		lss26 = self.addLink('s20','s21',**linkSSParameters)
		lss27 = self.addLink('s23','s33',**linkSSParameters)
		lss28 = self.addLink('s26','s30',**linkSSParameters)
		lss29 = self.addLink('s27','s30',**linkSSParameters)
		lss30 = self.addLink('s28','s29',**linkSSParameters)
		lss31 = self.addLink('s30','s33',**linkSSParameters)
