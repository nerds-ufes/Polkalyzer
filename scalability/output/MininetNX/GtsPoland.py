...
class MininetNX( Topo ):
	def build( self ):
		...
		lss7 = self.addLink('s6','s34',**linkSSParameters)
		lss8 = self.addLink('s6','s18',**linkSSParameters)
		...
		lss12 = self.addLink('s8','s29',**linkSSParameters)
		...
		lss17 = self.addLink('s12','s14',**linkSSParameters)
		lss18 = self.addLink('s12','s19',**linkSSParameters)
		lss19 = self.addLink('s12','s20',**linkSSParameters)
		lss20 = self.addLink('s12','s24',**linkSSParameters)
		lss21 = self.addLink('s12','s25',**linkSSParameters)
		lss22 = self.addLink('s13','s28',**linkSSParameters)
		lss23 = self.addLink('s14','s15',**linkSSParameters)
		lss24 = self.addLink('s15','s33',**linkSSParameters)
		lss25 = self.addLink('s16','s17',**linkSSParameters)
		lss26 = self.addLink('s16','s22',**linkSSParameters)
		lss27 = self.addLink('s17','s18',**linkSSParameters)
		lss28 = self.addLink('s18','s19',**linkSSParameters)
		lss29 = self.addLink('s20','s21',**linkSSParameters)
		lss30 = self.addLink('s21','s33',**linkSSParameters)
		lss31 = self.addLink('s22','s30',**linkSSParameters)
		lss32 = self.addLink('s23','s33',**linkSSParameters)
		lss33 = self.addLink('s26','s30',**linkSSParameters)
		lss34 = self.addLink('s27','s30',**linkSSParameters)
		lss35 = self.addLink('s28','s29',**linkSSParameters)
		lss36 = self.addLink('s30','s33',**linkSSParameters)
		
topos = { 'GtsPoland': ( lambda: MininetNX() ) }