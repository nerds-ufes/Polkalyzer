...
class MininetNX( Topo ):
	def build( self ):
		...
		lss5 = self.addLink('s4','s7')
		lss6 = self.addLink('s5','s6')
		lss7 = self.addLink('s6','s34')
		lss8 = self.addLink('s6','s18')
		lss9 = self.addLink('s6','s7')
		lss10 = self.addLink('s7','s8')
		lss11 = self.addLink('s8','s9')
		lss12 = self.addLink('s8','s29')
		lss13 = self.addLink('s9','s10')
		lss14 = self.addLink('s10','s11')
		lss15 = self.addLink('s11','s12')
		lss16 = self.addLink('s12','s13')
		lss17 = self.addLink('s12','s14')
		lss18 = self.addLink('s12','s19')
		lss19 = self.addLink('s12','s20')
		lss20 = self.addLink('s12','s24')
		lss21 = self.addLink('s12','s25')
		lss22 = self.addLink('s13','s28')
		lss23 = self.addLink('s14','s15')
		lss24 = self.addLink('s15','s33')
		lss25 = self.addLink('s16','s17')
		lss26 = self.addLink('s16','s22')
		lss27 = self.addLink('s17','s18')
		lss28 = self.addLink('s18','s19')
		lss29 = self.addLink('s20','s21')
		lss30 = self.addLink('s21','s33')
		lss31 = self.addLink('s22','s30')
		lss32 = self.addLink('s23','s33')
		lss33 = self.addLink('s26','s30')
		lss34 = self.addLink('s27','s30')
		lss35 = self.addLink('s28','s29')
		lss36 = self.addLink('s30','s33')
