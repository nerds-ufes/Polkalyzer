...
class MininetNX( Topo ):
	def build( self ):
		...
		lss7 = self.addLink('s6','s25',**linkSSParameters)
		...
		lss11 = self.addLink('s8','s10',**linkSSParameters)
		lss12 = self.addLink('s8','s11',**linkSSParameters)
		lss13 = self.addLink('s8','s12',**linkSSParameters)
		lss14 = self.addLink('s8','s13',**linkSSParameters)
		lss15 = self.addLink('s8','s14',**linkSSParameters)
		lss16 = self.addLink('s8','s16',**linkSSParameters)
		lss17 = self.addLink('s8','s17',**linkSSParameters)
		lss18 = self.addLink('s8','s19',**linkSSParameters)
		lss19 = self.addLink('s8','s20',**linkSSParameters)
		lss20 = self.addLink('s8','s21',**linkSSParameters)
		lss21 = self.addLink('s8','s22',**linkSSParameters)
		lss22 = self.addLink('s8','s27',**linkSSParameters)
		lss23 = self.addLink('s8','s31',**linkSSParameters)
		lss24 = self.addLink('s15','s16',**linkSSParameters)
		lss25 = self.addLink('s15','s23',**linkSSParameters)
		lss26 = self.addLink('s17','s18',**linkSSParameters)
		lss27 = self.addLink('s23','s24',**linkSSParameters)
		lss28 = self.addLink('s23','s28',**linkSSParameters)
