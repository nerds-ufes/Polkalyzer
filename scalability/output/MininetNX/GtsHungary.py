...
class MininetNX( Topo ):
	def build( self ):
		...
		lss1 = self.addLink('s0','s26')
		lss2 = self.addLink('s0','s6')
		lss3 = self.addLink('s1','s2')
		lss4 = self.addLink('s2','s5')
		lss5 = self.addLink('s3','s8')
		lss6 = self.addLink('s4','s8')
		lss7 = self.addLink('s4','s5')
		lss8 = self.addLink('s6','s25')
		...
		lss16 = self.addLink('s8','s14')
		lss17 = self.addLink('s8','s16')
		lss18 = self.addLink('s8','s17')
		lss19 = self.addLink('s8','s19')
		lss20 = self.addLink('s8','s20')
		lss21 = self.addLink('s8','s21')
		lss22 = self.addLink('s8','s22')
		lss23 = self.addLink('s8','s27')
		lss24 = self.addLink('s8','s31')
		lss25 = self.addLink('s15','s16')
		lss26 = self.addLink('s15','s23')
		lss27 = self.addLink('s17','s18')
		lss28 = self.addLink('s18','s23')
		lss29 = self.addLink('s23','s24')
		lss30 = self.addLink('s23','s28')
