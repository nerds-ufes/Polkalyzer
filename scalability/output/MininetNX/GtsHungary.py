...
class MininetNX( Topo ):
	def build( self ):
		...
		lss1 = self.addLink('s0','s26',**linkSSParameters)
		lss2 = self.addLink('s0','s6',**linkSSParameters)
		lss3 = self.addLink('s1','s2',**linkSSParameters)
		lss4 = self.addLink('s2','s5',**linkSSParameters)
		lss5 = self.addLink('s3','s8',**linkSSParameters)
		lss6 = self.addLink('s4','s8',**linkSSParameters)
		lss7 = self.addLink('s4','s5',**linkSSParameters)
		lss8 = self.addLink('s6','s25',**linkSSParameters)
		...
		lss16 = self.addLink('s8','s14',**linkSSParameters)
		lss17 = self.addLink('s8','s16',**linkSSParameters)
		lss18 = self.addLink('s8','s17',**linkSSParameters)
		lss19 = self.addLink('s8','s19',**linkSSParameters)
		lss20 = self.addLink('s8','s20',**linkSSParameters)
		lss21 = self.addLink('s8','s21',**linkSSParameters)
		lss22 = self.addLink('s8','s22',**linkSSParameters)
		lss23 = self.addLink('s8','s27',**linkSSParameters)
		lss24 = self.addLink('s8','s31',**linkSSParameters)
		lss25 = self.addLink('s15','s16',**linkSSParameters)
		lss26 = self.addLink('s15','s23',**linkSSParameters)
		...
		lss30 = self.addLink('s23','s28',**linkSSParameters)
		
topos = { 'GtsHungary': ( lambda: MininetNX() ) }