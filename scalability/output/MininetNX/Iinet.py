...
class MininetNX( Topo ):
	def build( self ):
		...
		lss8 = self.addLink('s2','s10',**linkSSParameters)
		lss9 = self.addLink('s2','s11',**linkSSParameters)
		lss10 = self.addLink('s2','s12',**linkSSParameters)
		lss11 = self.addLink('s2','s13',**linkSSParameters)
		lss12 = self.addLink('s3','s24',**linkSSParameters)
		lss13 = self.addLink('s3','s25',**linkSSParameters)
		lss14 = self.addLink('s3','s4',**linkSSParameters)
		lss15 = self.addLink('s3','s5',**linkSSParameters)
		lss16 = self.addLink('s4','s7',**linkSSParameters)
		lss17 = self.addLink('s4','s26',**linkSSParameters)
		lss18 = self.addLink('s4','s27',**linkSSParameters)
		lss19 = self.addLink('s4','s29',**linkSSParameters)
		lss20 = self.addLink('s5','s6',**linkSSParameters)
		lss21 = self.addLink('s5','s7',**linkSSParameters)
		lss22 = self.addLink('s5','s8',**linkSSParameters)
		lss23 = self.addLink('s5','s21',**linkSSParameters)
		lss24 = self.addLink('s5','s22',**linkSSParameters)
		lss25 = self.addLink('s5','s23',**linkSSParameters)
		lss26 = self.addLink('s5','s28',**linkSSParameters)
		lss27 = self.addLink('s5','s29',**linkSSParameters)
		lss28 = self.addLink('s5','s30',**linkSSParameters)
		lss29 = self.addLink('s6','s16',**linkSSParameters)
		lss30 = self.addLink('s6','s17',**linkSSParameters)
		lss31 = self.addLink('s6','s15',**linkSSParameters)
		lss32 = self.addLink('s7','s18',**linkSSParameters)
		lss33 = self.addLink('s7','s19',**linkSSParameters)
		lss34 = self.addLink('s8','s20',**linkSSParameters)
		
topos = { 'Iinet': ( lambda: MininetNX() ) }