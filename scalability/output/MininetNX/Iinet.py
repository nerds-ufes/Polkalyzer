...
class MininetNX( Topo ):
	def build( self ):
		...
		lss7 = self.addLink('s2','s9')
		lss8 = self.addLink('s2','s10')
		lss9 = self.addLink('s2','s11')
		lss10 = self.addLink('s2','s12')
		lss11 = self.addLink('s2','s13')
		lss12 = self.addLink('s3','s24')
		lss13 = self.addLink('s3','s25')
		lss14 = self.addLink('s3','s4')
		lss15 = self.addLink('s3','s5')
		lss16 = self.addLink('s4','s7')
		lss17 = self.addLink('s4','s26')
		lss18 = self.addLink('s4','s27')
		lss19 = self.addLink('s4','s29')
		lss20 = self.addLink('s5','s6')
		lss21 = self.addLink('s5','s7')
		lss22 = self.addLink('s5','s8')
		lss23 = self.addLink('s5','s21')
		lss24 = self.addLink('s5','s22')
		lss25 = self.addLink('s5','s23')
		lss26 = self.addLink('s5','s28')
		lss27 = self.addLink('s5','s29')
		lss28 = self.addLink('s5','s30')
		lss29 = self.addLink('s6','s16')
		lss30 = self.addLink('s6','s17')
		lss31 = self.addLink('s6','s15')
		lss32 = self.addLink('s7','s18')
		lss33 = self.addLink('s7','s19')
		lss34 = self.addLink('s8','s20')
