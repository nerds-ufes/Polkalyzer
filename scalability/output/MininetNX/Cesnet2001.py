...
class MininetNX( Topo ):
	def build( self ):
		...
		lss7 = self.addLink('s4','s8')
		lss8 = self.addLink('s4','s10')
		lss9 = self.addLink('s4','s11')
		lss10 = self.addLink('s4','s13')
		lss11 = self.addLink('s4','s17')
		lss12 = self.addLink('s4','s20')
		lss13 = self.addLink('s4','s22')
		lss14 = self.addLink('s6','s9')
		lss15 = self.addLink('s6','s21')
		lss16 = self.addLink('s12','s17')
		lss17 = self.addLink('s12','s13')
		lss18 = self.addLink('s13','s16')
