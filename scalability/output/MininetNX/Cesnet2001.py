...
class MininetNX( Topo ):
	def build( self ):
		...
		lss10 = self.addLink('s4','s13',**linkSSParameters)
		lss11 = self.addLink('s4','s17',**linkSSParameters)
		lss12 = self.addLink('s4','s20',**linkSSParameters)
		lss13 = self.addLink('s4','s22',**linkSSParameters)
		lss14 = self.addLink('s6','s9',**linkSSParameters)
		lss15 = self.addLink('s6','s21',**linkSSParameters)
		lss16 = self.addLink('s12','s17',**linkSSParameters)
		lss17 = self.addLink('s12','s13',**linkSSParameters)
		lss18 = self.addLink('s13','s16',**linkSSParameters)
...
topos = { 'Cesnet2001': ( lambda: MininetNX() ) }