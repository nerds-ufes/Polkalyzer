...
class MininetNX( Topo ):
	def build( self ):
		...
		lhs20 = self.addLink('s24','h20',**linkHSParameters)
		lhs21 = self.addLink('s25','h21',**linkHSParameters)
		lhs22 = self.addLink('s27','h22',**linkHSParameters)
		lhs23 = self.addLink('s28','h23',**linkHSParameters)
		lhs24 = self.addLink('s29','h24',**linkHSParameters)
		lhs25 = self.addLink('s30','h25',**linkHSParameters)
		lhs26 = self.addLink('s31','h26',**linkHSParameters)
		lhs27 = self.addLink('s32','h27',**linkHSParameters)
		...
		lss22 = self.addLink('s11','s16',**linkSSParameters)
		lss23 = self.addLink('s11','s27',**linkSSParameters)
		lss24 = self.addLink('s11','s28',**linkSSParameters)
		lss25 = self.addLink('s30','s31',**linkSSParameters)
		lss26 = self.addLink('s31','s32',**linkSSParameters)
