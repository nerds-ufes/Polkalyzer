...
class MininetNX( Topo ):
	def build( self ):
		...
		lss1 = self.addLink('s1','s9',**linkSSParameters)
		lss2 = self.addLink('s1','s2',**linkSSParameters)
		lss3 = self.addLink('s1','s11',**linkSSParameters)
		lss4 = self.addLink('s1','s10',**linkSSParameters)
		lss5 = self.addLink('s3','s10',**linkSSParameters)
		lss6 = self.addLink('s4','s11',**linkSSParameters)
		lss7 = self.addLink('s5','s11',**linkSSParameters)
		lss8 = self.addLink('s6','s12',**linkSSParameters)
		lss9 = self.addLink('s6','s8',**linkSSParameters)
		lss10 = self.addLink('s7','s12',**linkSSParameters)
