...
class MininetNX( Topo ):
	def build( self ):
		...
		lss6 = self.addLink('s5','s27',**linkSSParameters)
		lss7 = self.addLink('s5','s37',**linkSSParameters)
		lss8 = self.addLink('s5','s6',**linkSSParameters)
		lss9 = self.addLink('s5','s7',**linkSSParameters)
		lss10 = self.addLink('s5','s8',**linkSSParameters)
		lss11 = self.addLink('s5','s9',**linkSSParameters)
		lss12 = self.addLink('s5','s12',**linkSSParameters)
		lss13 = self.addLink('s5','s13',**linkSSParameters)
		lss14 = self.addLink('s5','s14',**linkSSParameters)
		lss15 = self.addLink('s5','s15',**linkSSParameters)
		lss16 = self.addLink('s5','s18',**linkSSParameters)
		lss17 = self.addLink('s5','s20',**linkSSParameters)
		lss18 = self.addLink('s5','s22',**linkSSParameters)
		lss19 = self.addLink('s5','s36',**linkSSParameters)
		lss20 = self.addLink('s5','s38',**linkSSParameters)
		lss21 = self.addLink('s5','s28',**linkSSParameters)
		lss22 = self.addLink('s9','s10',**linkSSParameters)
		lss23 = self.addLink('s11','s12',**linkSSParameters)
		lss24 = self.addLink('s16','s18',**linkSSParameters)
		lss25 = self.addLink('s18','s39',**linkSSParameters)
		lss26 = self.addLink('s18','s19',**linkSSParameters)
		lss27 = self.addLink('s18','s21',**linkSSParameters)
		lss28 = self.addLink('s18','s23',**linkSSParameters)
		lss29 = self.addLink('s18','s24',**linkSSParameters)
		lss30 = self.addLink('s20','s25',**linkSSParameters)
		lss31 = self.addLink('s22','s31',**linkSSParameters)
		lss32 = self.addLink('s26','s27',**linkSSParameters)
		lss33 = self.addLink('s27','s32',**linkSSParameters)
		lss34 = self.addLink('s27','s33',**linkSSParameters)
		lss35 = self.addLink('s27','s34',**linkSSParameters)
		lss36 = self.addLink('s27','s35',**linkSSParameters)
		lss37 = self.addLink('s27','s40',**linkSSParameters)
		lss38 = self.addLink('s27','s29',**linkSSParameters)
		lss39 = self.addLink('s27','s30',**linkSSParameters)
		lss40 = self.addLink('s28','s41',**linkSSParameters)
