...
class MininetNX( Topo ):
	def build( self ):
		...
		lss4 = self.addLink('s4','s27',**linkSSParameters)
		lss5 = self.addLink('s4','s17',**linkSSParameters)
		lss6 = self.addLink('s4','s18',**linkSSParameters)
		lss7 = self.addLink('s4','s5',**linkSSParameters)
		lss8 = self.addLink('s5','s27',**linkSSParameters)
		lss9 = self.addLink('s5','s37',**linkSSParameters)
		lss10 = self.addLink('s5','s6',**linkSSParameters)
		lss11 = self.addLink('s5','s7',**linkSSParameters)
		lss12 = self.addLink('s5','s8',**linkSSParameters)
		lss13 = self.addLink('s5','s9',**linkSSParameters)
		lss14 = self.addLink('s5','s12',**linkSSParameters)
		lss15 = self.addLink('s5','s13',**linkSSParameters)
		lss16 = self.addLink('s5','s14',**linkSSParameters)
		lss17 = self.addLink('s5','s15',**linkSSParameters)
		lss18 = self.addLink('s5','s18',**linkSSParameters)
		lss19 = self.addLink('s5','s20',**linkSSParameters)
		lss20 = self.addLink('s5','s22',**linkSSParameters)
		lss21 = self.addLink('s5','s36',**linkSSParameters)
		lss22 = self.addLink('s5','s38',**linkSSParameters)
		lss23 = self.addLink('s5','s28',**linkSSParameters)
		lss24 = self.addLink('s6','s36',**linkSSParameters)
		lss25 = self.addLink('s7','s36',**linkSSParameters)
		lss26 = self.addLink('s8','s36',**linkSSParameters)
		lss27 = self.addLink('s9','s10',**linkSSParameters)
		lss28 = self.addLink('s9','s36',**linkSSParameters)
		lss29 = self.addLink('s11','s12',**linkSSParameters)
		lss30 = self.addLink('s12','s34',**linkSSParameters)
		lss31 = self.addLink('s13','s36',**linkSSParameters)
		lss32 = self.addLink('s14','s36',**linkSSParameters)
		lss33 = self.addLink('s16','s18',**linkSSParameters)
		lss34 = self.addLink('s18','s34',**linkSSParameters)
		lss35 = self.addLink('s18','s36',**linkSSParameters)
		lss36 = self.addLink('s18','s39',**linkSSParameters)
		lss37 = self.addLink('s18','s19',**linkSSParameters)
		lss38 = self.addLink('s18','s20',**linkSSParameters)
		lss39 = self.addLink('s18','s21',**linkSSParameters)
		lss40 = self.addLink('s18','s22',**linkSSParameters)
		lss41 = self.addLink('s18','s23',**linkSSParameters)
		lss42 = self.addLink('s18','s24',**linkSSParameters)
		lss43 = self.addLink('s18','s27',**linkSSParameters)
		lss44 = self.addLink('s18','s28',**linkSSParameters)
		lss45 = self.addLink('s19','s20',**linkSSParameters)
		lss46 = self.addLink('s20','s34',**linkSSParameters)
		lss47 = self.addLink('s20','s36',**linkSSParameters)
		lss48 = self.addLink('s20','s22',**linkSSParameters)
		lss49 = self.addLink('s20','s25',**linkSSParameters)
		lss50 = self.addLink('s22','s36',**linkSSParameters)
		lss51 = self.addLink('s22','s29',**linkSSParameters)
		lss52 = self.addLink('s22','s31',**linkSSParameters)
		lss53 = self.addLink('s26','s27',**linkSSParameters)
		lss54 = self.addLink('s27','s32',**linkSSParameters)
		lss55 = self.addLink('s27','s33',**linkSSParameters)
		lss56 = self.addLink('s27','s34',**linkSSParameters)
		lss57 = self.addLink('s27','s35',**linkSSParameters)
		lss58 = self.addLink('s27','s40',**linkSSParameters)
		lss59 = self.addLink('s27','s36',**linkSSParameters)
		lss60 = self.addLink('s27','s28',**linkSSParameters)
		lss61 = self.addLink('s27','s29',**linkSSParameters)
		lss62 = self.addLink('s27','s30',**linkSSParameters)
		lss63 = self.addLink('s28','s41',**linkSSParameters)
		lss64 = self.addLink('s32','s34',**linkSSParameters)
		lss65 = self.addLink('s33','s34',**linkSSParameters)
		
topos = { 'Chinanet': ( lambda: MininetNX() ) }