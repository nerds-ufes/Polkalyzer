...
class MininetNX( Topo ):
	def build( self ):
		...
		lss0 = self.addLink('s0','s5')
		lss1 = self.addLink('s1','s5')
		lss2 = self.addLink('s2','s5')
		lss3 = self.addLink('s3','s4')
		lss4 = self.addLink('s4','s27')
		lss5 = self.addLink('s4','s17')
		lss6 = self.addLink('s4','s18')
		lss7 = self.addLink('s4','s5')
		lss8 = self.addLink('s5','s27')
		lss9 = self.addLink('s5','s37')
		lss10 = self.addLink('s5','s6')
		lss11 = self.addLink('s5','s7')
		lss12 = self.addLink('s5','s8')
		lss13 = self.addLink('s5','s9')
		lss14 = self.addLink('s5','s12')
		lss15 = self.addLink('s5','s13')
		lss16 = self.addLink('s5','s14')
		lss17 = self.addLink('s5','s15')
		lss18 = self.addLink('s5','s18')
		lss19 = self.addLink('s5','s20')
		lss20 = self.addLink('s5','s22')
		lss21 = self.addLink('s5','s36')
		lss22 = self.addLink('s5','s38')
		lss23 = self.addLink('s5','s28')
		lss24 = self.addLink('s6','s36')
		lss25 = self.addLink('s7','s36')
		lss26 = self.addLink('s8','s36')
		lss27 = self.addLink('s9','s10')
		lss28 = self.addLink('s9','s36')
		lss29 = self.addLink('s11','s12')
		lss30 = self.addLink('s12','s34')
		lss31 = self.addLink('s13','s36')
		lss32 = self.addLink('s14','s36')
		lss33 = self.addLink('s16','s18')
		lss34 = self.addLink('s18','s34')
		lss35 = self.addLink('s18','s36')
		lss36 = self.addLink('s18','s39')
		lss37 = self.addLink('s18','s19')
		lss38 = self.addLink('s18','s20')
		lss39 = self.addLink('s18','s21')
		lss40 = self.addLink('s18','s22')
		lss41 = self.addLink('s18','s23')
		lss42 = self.addLink('s18','s24')
		lss43 = self.addLink('s18','s27')
		lss44 = self.addLink('s18','s28')
		lss45 = self.addLink('s19','s20')
		lss46 = self.addLink('s20','s34')
		lss47 = self.addLink('s20','s36')
		lss48 = self.addLink('s20','s22')
		lss49 = self.addLink('s20','s25')
		lss50 = self.addLink('s22','s36')
		lss51 = self.addLink('s22','s29')
		lss52 = self.addLink('s22','s31')
		lss53 = self.addLink('s26','s27')
		lss54 = self.addLink('s27','s32')
		lss55 = self.addLink('s27','s33')
		lss56 = self.addLink('s27','s34')
		lss57 = self.addLink('s27','s35')
		lss58 = self.addLink('s27','s40')
		lss59 = self.addLink('s27','s36')
		lss60 = self.addLink('s27','s28')
		lss61 = self.addLink('s27','s29')
		lss62 = self.addLink('s27','s30')
		lss63 = self.addLink('s28','s41')
		lss64 = self.addLink('s32','s34')
		lss65 = self.addLink('s33','s34')
