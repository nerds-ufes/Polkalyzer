...
class MininetNX( Topo ):
	def build( self ):
		...
		lss1 = self.addLink('s0','s19',**linkSSParameters)
		lss2 = self.addLink('s1','s2',**linkSSParameters)
		lss3 = self.addLink('s1','s19',**linkSSParameters)
		...
		lss7 = self.addLink('s2','s12',**linkSSParameters)
		lss8 = self.addLink('s3','s19',**linkSSParameters)
		lss9 = self.addLink('s3','s4',**linkSSParameters)
		lss10 = self.addLink('s4','s10',**linkSSParameters)
		...
		lss15 = self.addLink('s7','s10',**linkSSParameters)
		...
		lss20 = self.addLink('s11','s13',**linkSSParameters)
		...
		lss24 = self.addLink('s14','s18',**linkSSParameters)
		lss25 = self.addLink('s14','s15',**linkSSParameters)
		lss26 = self.addLink('s15','s16',**linkSSParameters)
...
topos = { 'EliBackbone': ( lambda: MininetNX() ) }