...
class MininetNX( Topo ):
	def build( self ):
		...
		lss5 = self.addLink('s2','s7')
		lss6 = self.addLink('s3','s5')
		lss7 = self.addLink('s3','s6')
		lss8 = self.addLink('s4','s8')
		lss9 = self.addLink('s4','s10')
		lss10 = self.addLink('s4','s5')
		lss11 = self.addLink('s5','s8')
		lss12 = self.addLink('s5','s11')
		lss13 = self.addLink('s6','s7')
		lss14 = self.addLink('s9','s10')
		lss15 = self.addLink('s9','s12')
		lss16 = self.addLink('s11','s18')
