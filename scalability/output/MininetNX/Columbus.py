...
class MininetNX( Topo ):
	def build( self ):
		...
		lhs128 = self.addLink('s66','h128')
		lhs129 = self.addLink('s66','h129')
		lhs130 = self.addLink('s72','h130')
		lhs131 = self.addLink('s72','h131')
		lhs132 = self.addLink('s73','h132')
		lhs133 = self.addLink('s73','h133')
		lhs134 = self.addLink('s74','h134')
		lhs135 = self.addLink('s74','h135')
		lhs136 = self.addLink('s75','h136')
		lhs137 = self.addLink('s75','h137')
		lhs138 = self.addLink('s76','h138')
		lhs139 = self.addLink('s76','h139')
		#Add a link of switches of original topology
		lss0 = self.addLink('s0','s1')
		lss1 = self.addLink('s1','s2')
		lss2 = self.addLink('s1','s3')
		lss3 = self.addLink('s3','s59')
		lss4 = self.addLink('s4','s59')
		lss5 = self.addLink('s4','s52')
		lss6 = self.addLink('s5','s59')
		lss7 = self.addLink('s5','s54')
		lss8 = self.addLink('s5','s6')
		lss9 = self.addLink('s6','s8')
		lss10 = self.addLink('s7','s8')
		lss11 = self.addLink('s7','s9')
		lss12 = self.addLink('s9','s10')
		lss13 = self.addLink('s10','s11')
		lss14 = self.addLink('s10','s57')
		lss15 = self.addLink('s11','s58')
		lss16 = self.addLink('s11','s63')
		lss17 = self.addLink('s12','s58')
		lss18 = self.addLink('s12','s13')
		lss19 = self.addLink('s13','s60')
		lss20 = self.addLink('s13','s15')
		lss21 = self.addLink('s13','s14')
		lss22 = self.addLink('s13','s63')
		lss23 = self.addLink('s14','s41')
		lss24 = self.addLink('s15','s16')
		lss25 = self.addLink('s16','s17')
		lss26 = self.addLink('s17','s24')
		lss27 = self.addLink('s17','s18')
		lss28 = self.addLink('s17','s19')
		lss29 = self.addLink('s19','s20')
		lss30 = self.addLink('s20','s37')
		lss31 = self.addLink('s20','s62')
		lss32 = self.addLink('s21','s62')
		lss33 = self.addLink('s22','s62')
		lss34 = self.addLink('s23','s56')
		lss35 = self.addLink('s23','s24')
		lss36 = self.addLink('s23','s27')
		lss37 = self.addLink('s24','s28')
		lss38 = self.addLink('s24','s25')
		lss39 = self.addLink('s25','s26')
		lss40 = self.addLink('s26','s40')
		lss41 = self.addLink('s26','s38')
		lss42 = self.addLink('s27','s56')
		lss43 = self.addLink('s27','s34')
		lss44 = self.addLink('s28','s56')
		lss45 = self.addLink('s28','s29')
		lss46 = self.addLink('s29','s32')
		lss47 = self.addLink('s29','s30')
		lss48 = self.addLink('s30','s31')
		lss49 = self.addLink('s31','s32')
		lss50 = self.addLink('s32','s33')
		lss51 = self.addLink('s33','s34')
		lss52 = self.addLink('s34','s36')
		lss53 = self.addLink('s34','s35')
		lss54 = self.addLink('s36','s37')
		lss55 = self.addLink('s38','s39')
		lss56 = self.addLink('s39','s46')
		lss57 = self.addLink('s40','s43')
		lss58 = self.addLink('s41','s42')
		lss59 = self.addLink('s41','s45')
		lss60 = self.addLink('s42','s43')
		lss61 = self.addLink('s44','s55')
		lss62 = self.addLink('s45','s66')
		lss63 = self.addLink('s46','s73')
		lss64 = self.addLink('s47','s72')
		lss65 = self.addLink('s47','s48')
		lss66 = self.addLink('s47','s75')
		lss67 = self.addLink('s47','s73')
		lss68 = self.addLink('s48','s49')
		lss69 = self.addLink('s48','s76')
		lss70 = self.addLink('s48','s53')
		lss71 = self.addLink('s49','s51')
		lss72 = self.addLink('s50','s53')
		lss73 = self.addLink('s51','s52')
		lss74 = self.addLink('s53','s54')
		lss75 = self.addLink('s54','s55')
		lss76 = self.addLink('s55','s57')
		lss77 = self.addLink('s57','s58')
		lss78 = self.addLink('s60','s61')
		lss79 = self.addLink('s66','s75')
		lss80 = self.addLink('s66','s76')
		lss81 = self.addLink('s72','s73')
		lss82 = self.addLink('s73','s74')
		lss83 = self.addLink('s74','s75')
		lss84 = self.addLink('s75','s76')
