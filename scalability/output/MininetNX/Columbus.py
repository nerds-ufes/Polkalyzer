...
class MininetNX( Topo ):
	def build( self ):
		...
		lhs64 = self.addLink('s66','h64',**linkHSParameters)
		lhs65 = self.addLink('s72','h65',**linkHSParameters)
		lhs66 = self.addLink('s73','h66',**linkHSParameters)
		lhs67 = self.addLink('s74','h67',**linkHSParameters)
		lhs68 = self.addLink('s75','h68',**linkHSParameters)
		lhs69 = self.addLink('s76','h69',**linkHSParameters)
		...
		lss12 = self.addLink('s10','s57',**linkSSParameters)
		lss13 = self.addLink('s10','s11',**linkSSParameters)
		lss14 = self.addLink('s11','s63',**linkSSParameters)
		lss15 = self.addLink('s12','s58',**linkSSParameters)
		lss16 = self.addLink('s12','s13',**linkSSParameters)
		lss17 = self.addLink('s13','s60',**linkSSParameters)
		lss18 = self.addLink('s13','s15',**linkSSParameters)
		lss19 = self.addLink('s13','s14',**linkSSParameters)
		lss20 = self.addLink('s15','s16',**linkSSParameters)
		lss21 = self.addLink('s16','s17',**linkSSParameters)
		lss22 = self.addLink('s17','s24',**linkSSParameters)
		lss23 = self.addLink('s17','s18',**linkSSParameters)
		lss24 = self.addLink('s17','s19',**linkSSParameters)
		lss25 = self.addLink('s19','s20',**linkSSParameters)
		lss26 = self.addLink('s20','s37',**linkSSParameters)
		lss27 = self.addLink('s20','s62',**linkSSParameters)
		lss28 = self.addLink('s21','s62',**linkSSParameters)
		lss29 = self.addLink('s22','s62',**linkSSParameters)
		lss30 = self.addLink('s23','s24',**linkSSParameters)
		lss31 = self.addLink('s23','s56',**linkSSParameters)
		lss32 = self.addLink('s23','s27',**linkSSParameters)
		lss33 = self.addLink('s24','s28',**linkSSParameters)
		lss34 = self.addLink('s25','s26',**linkSSParameters)
		lss35 = self.addLink('s26','s38',**linkSSParameters)
		lss36 = self.addLink('s26','s40',**linkSSParameters)
		lss37 = self.addLink('s27','s34',**linkSSParameters)
		lss38 = self.addLink('s28','s29',**linkSSParameters)
		lss39 = self.addLink('s29','s32',**linkSSParameters)
		lss40 = self.addLink('s29','s30',**linkSSParameters)
		lss41 = self.addLink('s31','s32',**linkSSParameters)
		lss42 = self.addLink('s33','s34',**linkSSParameters)
		lss43 = self.addLink('s34','s35',**linkSSParameters)
		lss44 = self.addLink('s36','s37',**linkSSParameters)
		lss45 = self.addLink('s38','s39',**linkSSParameters)
		lss46 = self.addLink('s39','s46',**linkSSParameters)
		lss47 = self.addLink('s41','s45',**linkSSParameters)
		lss48 = self.addLink('s41','s42',**linkSSParameters)
		lss49 = self.addLink('s42','s43',**linkSSParameters)
		lss50 = self.addLink('s44','s55',**linkSSParameters)
		lss51 = self.addLink('s45','s66',**linkSSParameters)
		lss52 = self.addLink('s46','s73',**linkSSParameters)
		lss53 = self.addLink('s47','s48',**linkSSParameters)
		lss54 = self.addLink('s47','s72',**linkSSParameters)
		lss55 = self.addLink('s47','s75',**linkSSParameters)
		lss56 = self.addLink('s47','s73',**linkSSParameters)
		lss57 = self.addLink('s48','s53',**linkSSParameters)
		lss58 = self.addLink('s48','s76',**linkSSParameters)
		lss59 = self.addLink('s49','s51',**linkSSParameters)
		lss60 = self.addLink('s50','s53',**linkSSParameters)
		lss61 = self.addLink('s51','s52',**linkSSParameters)
		lss62 = self.addLink('s53','s54',**linkSSParameters)
		lss63 = self.addLink('s54','s55',**linkSSParameters)
		lss64 = self.addLink('s55','s57',**linkSSParameters)
		lss65 = self.addLink('s57','s58',**linkSSParameters)
		lss66 = self.addLink('s60','s61',**linkSSParameters)
		lss67 = self.addLink('s66','s76',**linkSSParameters)
		lss68 = self.addLink('s74','s75',**linkSSParameters)
