...
class MininetNX( Topo ):
	def build( self ):
		...
		lss2 = self.addLink('s2','s8',**linkSSParameters)
		lss3 = self.addLink('s2','s9',**linkSSParameters)
		lss4 = self.addLink('s3','s8',**linkSSParameters)
		...
		lss10 = self.addLink('s7','s30',**linkSSParameters)
		lss11 = self.addLink('s7','s13',**linkSSParameters)
		lss12 = self.addLink('s7','s29',**linkSSParameters)
		lss13 = self.addLink('s8','s11',**linkSSParameters)
		lss14 = self.addLink('s8','s10',**linkSSParameters)
		lss15 = self.addLink('s8','s13',**linkSSParameters)
		...
		lss20 = self.addLink('s11','s15',**linkSSParameters)
		lss21 = self.addLink('s12','s15',**linkSSParameters)
		lss22 = self.addLink('s13','s14',**linkSSParameters)
		lss23 = self.addLink('s13','s26',**linkSSParameters)
		lss24 = self.addLink('s13','s27',**linkSSParameters)
		lss25 = self.addLink('s13','s28',**linkSSParameters)
		lss26 = self.addLink('s14','s15',**linkSSParameters)
		lss27 = self.addLink('s15','s16',**linkSSParameters)
		lss28 = self.addLink('s15','s22',**linkSSParameters)
		lss29 = self.addLink('s16','s17',**linkSSParameters)
		lss30 = self.addLink('s17','s18',**linkSSParameters)
		lss31 = self.addLink('s17','s20',**linkSSParameters)
		lss32 = self.addLink('s17','s31',**linkSSParameters)
		lss33 = self.addLink('s18','s19',**linkSSParameters)
		lss34 = self.addLink('s19','s20',**linkSSParameters)
		lss35 = self.addLink('s20','s21',**linkSSParameters)
		lss36 = self.addLink('s20','s22',**linkSSParameters)
		lss37 = self.addLink('s21','s23',**linkSSParameters)
		lss38 = self.addLink('s22','s24',**linkSSParameters)
		lss39 = self.addLink('s22','s25',**linkSSParameters)
		lss40 = self.addLink('s22','s31',**linkSSParameters)
		
topos = { 'Canerie': ( lambda: MininetNX() ) }