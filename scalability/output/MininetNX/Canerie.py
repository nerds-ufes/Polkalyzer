...
class MininetNX( Topo ):
	def build( self ):
		...
		lss8 = self.addLink('s7','s13',**linkSSParameters)
		lss9 = self.addLink('s7','s30',**linkSSParameters)
		lss10 = self.addLink('s7','s29',**linkSSParameters)
		lss11 = self.addLink('s8','s11',**linkSSParameters)
		lss12 = self.addLink('s8','s10',**linkSSParameters)
		lss13 = self.addLink('s8','s13',**linkSSParameters)
		...
		lss17 = self.addLink('s13','s26',**linkSSParameters)
		lss18 = self.addLink('s13','s27',**linkSSParameters)
		lss19 = self.addLink('s13','s28',**linkSSParameters)
		...
		lss25 = self.addLink('s20','s22',**linkSSParameters)
		lss26 = self.addLink('s20','s21',**linkSSParameters)
		lss27 = self.addLink('s21','s23',**linkSSParameters)
		lss28 = self.addLink('s22','s24',**linkSSParameters)
		lss29 = self.addLink('s22','s25',**linkSSParameters)
		lss30 = self.addLink('s22','s31',**linkSSParameters)
