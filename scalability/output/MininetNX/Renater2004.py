...
class MininetNX( Topo ):
	def build( self ):
		...
		lss10 = self.addLink('s9','s24',**linkSSParameters)
		lss11 = self.addLink('s9','s11',**linkSSParameters)
		lss12 = self.addLink('s9','s12',**linkSSParameters)
		lss13 = self.addLink('s10','s24',**linkSSParameters)
		lss14 = self.addLink('s13','s14',**linkSSParameters)
		lss15 = self.addLink('s14','s25',**linkSSParameters)
		lss16 = self.addLink('s15','s25',**linkSSParameters)
		lss17 = self.addLink('s16','s24',**linkSSParameters)
		lss18 = self.addLink('s17','s25',**linkSSParameters)
		lss19 = self.addLink('s18','s25',**linkSSParameters)
		lss20 = self.addLink('s18','s19',**linkSSParameters)
		lss21 = self.addLink('s19','s21',**linkSSParameters)
		lss22 = self.addLink('s20','s25',**linkSSParameters)
		lss23 = self.addLink('s24','s26',**linkSSParameters)
		lss24 = self.addLink('s24','s27',**linkSSParameters)
		lss25 = self.addLink('s24','s28',**linkSSParameters)
		lss26 = self.addLink('s24','s29',**linkSSParameters)
		lss27 = self.addLink('s24','s30',**linkSSParameters)
		lss28 = self.addLink('s24','s31',**linkSSParameters)
