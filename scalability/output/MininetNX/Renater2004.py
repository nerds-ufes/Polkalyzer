...
class MininetNX( Topo ):
	def build( self ):
		...
		lss1 = self.addLink('s0','s17')
		lss2 = self.addLink('s1','s24')
		lss3 = self.addLink('s2','s24')
		lss4 = self.addLink('s3','s24')
		lss5 = self.addLink('s4','s24')
		lss6 = self.addLink('s5','s24')
		lss7 = self.addLink('s5','s6')
		lss8 = self.addLink('s6','s7')
		lss9 = self.addLink('s7','s8')
		lss10 = self.addLink('s8','s9')
		lss11 = self.addLink('s9','s24')
		lss12 = self.addLink('s9','s11')
		lss13 = self.addLink('s9','s12')
		lss14 = self.addLink('s10','s24')
		lss15 = self.addLink('s11','s15')
		lss16 = self.addLink('s12','s13')
		lss17 = self.addLink('s13','s14')
		lss18 = self.addLink('s14','s25')
		lss19 = self.addLink('s14','s20')
		lss20 = self.addLink('s15','s25')
		lss21 = self.addLink('s16','s24')
		lss22 = self.addLink('s17','s25')
		lss23 = self.addLink('s18','s25')
		lss24 = self.addLink('s18','s19')
		lss25 = self.addLink('s19','s20')
		lss26 = self.addLink('s19','s21')
		lss27 = self.addLink('s20','s25')
		lss28 = self.addLink('s24','s25')
		lss29 = self.addLink('s24','s26')
		lss30 = self.addLink('s24','s27')
		lss31 = self.addLink('s24','s28')
		lss32 = self.addLink('s24','s29')
		lss33 = self.addLink('s24','s30')
		lss34 = self.addLink('s24','s31')
