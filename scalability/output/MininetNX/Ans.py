...
class MininetNX( Topo ):
	def build( self ):
		...
		lss11 = self.addLink('s7','s17',**linkSSParameters)
		lss12 = self.addLink('s8','s15',**linkSSParameters)
		lss13 = self.addLink('s8','s9',**linkSSParameters)
		lss14 = self.addLink('s9','s10',**linkSSParameters)
		lss15 = self.addLink('s9','s15',**linkSSParameters)
		...
		lss21 = self.addLink('s13','s15',**linkSSParameters)
