...
class MininetNX( Topo ):
	def build( self ):
		...
		lss2 = self.addLink('s2','s50')
		lss3 = self.addLink('s2','s6')
		lss4 = self.addLink('s2','s45')
		lss5 = self.addLink('s2','s14')
		lss6 = self.addLink('s2','s16')
		lss7 = self.addLink('s2','s17')
		lss8 = self.addLink('s2','s18')
		lss9 = self.addLink('s2','s22')
		lss10 = self.addLink('s2','s30')
		lss11 = self.addLink('s3','s43')
		lss12 = self.addLink('s3','s44')
		lss13 = self.addLink('s3','s45')
		lss14 = self.addLink('s3','s39')
		lss15 = self.addLink('s4','s50')
		lss16 = self.addLink('s5','s51')
		lss17 = self.addLink('s6','s49')
		lss18 = self.addLink('s6','s46')
		lss19 = self.addLink('s6','s47')
		lss20 = self.addLink('s7','s20')
		lss21 = self.addLink('s8','s45')
		lss22 = self.addLink('s9','s43')
		lss23 = self.addLink('s10','s43')
		lss24 = self.addLink('s11','s45')
		lss25 = self.addLink('s12','s43')
		lss26 = self.addLink('s13','s16')
		lss27 = self.addLink('s14','s21')
		lss28 = self.addLink('s15','s16')
		lss29 = self.addLink('s16','s18')
		lss30 = self.addLink('s18','s33')
		lss31 = self.addLink('s18','s19')
		lss32 = self.addLink('s18','s20')
		lss33 = self.addLink('s18','s21')
		lss34 = self.addLink('s18','s22')
		lss35 = self.addLink('s20','s50')
		lss36 = self.addLink('s23','s30')
		lss37 = self.addLink('s24','s25')
		lss38 = self.addLink('s25','s50')
		lss39 = self.addLink('s25','s26')
		lss40 = self.addLink('s25','s27')
		lss41 = self.addLink('s25','s28')
		lss42 = self.addLink('s25','s30')
		lss43 = self.addLink('s29','s30')
		lss44 = self.addLink('s30','s33')
		lss45 = self.addLink('s31','s33')
		lss46 = self.addLink('s32','s33')
		lss47 = self.addLink('s32','s52')
		lss48 = self.addLink('s33','s34')
		lss49 = self.addLink('s33','s35')
		lss50 = self.addLink('s36','s45')
		lss51 = self.addLink('s37','s45')
		lss52 = self.addLink('s38','s40')
		lss53 = self.addLink('s39','s40')
		lss54 = self.addLink('s40','s41')
		lss55 = self.addLink('s40','s50')
		lss56 = self.addLink('s40','s43')
		lss57 = self.addLink('s42','s51')
		lss58 = self.addLink('s43','s45')
		lss59 = self.addLink('s43','s50')
		lss60 = self.addLink('s43','s51')
		lss61 = self.addLink('s44','s45')
		lss62 = self.addLink('s45','s46')
		lss63 = self.addLink('s45','s47')
		lss64 = self.addLink('s45','s51')
		lss65 = self.addLink('s48','s49')
		lss66 = self.addLink('s49','s50')
		lss67 = self.addLink('s49','s53')
