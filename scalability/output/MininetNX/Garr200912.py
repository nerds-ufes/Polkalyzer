...
class MininetNX( Topo ):
	def build( self ):
		...
		lss2 = self.addLink('s2','s45',**linkSSParameters)
		lss3 = self.addLink('s2','s6',**linkSSParameters)
		lss4 = self.addLink('s2','s14',**linkSSParameters)
		lss5 = self.addLink('s2','s16',**linkSSParameters)
		lss6 = self.addLink('s2','s17',**linkSSParameters)
		lss7 = self.addLink('s2','s18',**linkSSParameters)
		lss8 = self.addLink('s2','s22',**linkSSParameters)
		lss9 = self.addLink('s2','s30',**linkSSParameters)
		lss10 = self.addLink('s3','s43',**linkSSParameters)
		lss11 = self.addLink('s3','s39',**linkSSParameters)
		lss12 = self.addLink('s4','s50',**linkSSParameters)
		lss13 = self.addLink('s5','s51',**linkSSParameters)
		lss14 = self.addLink('s7','s20',**linkSSParameters)
		lss15 = self.addLink('s8','s45',**linkSSParameters)
		lss16 = self.addLink('s9','s43',**linkSSParameters)
		lss17 = self.addLink('s10','s43',**linkSSParameters)
		lss18 = self.addLink('s11','s45',**linkSSParameters)
		lss19 = self.addLink('s12','s43',**linkSSParameters)
		lss20 = self.addLink('s13','s16',**linkSSParameters)
		lss21 = self.addLink('s14','s21',**linkSSParameters)
		lss22 = self.addLink('s15','s16',**linkSSParameters)
		lss23 = self.addLink('s18','s33',**linkSSParameters)
		lss24 = self.addLink('s18','s19',**linkSSParameters)
		lss25 = self.addLink('s20','s50',**linkSSParameters)
		lss26 = self.addLink('s23','s30',**linkSSParameters)
		lss27 = self.addLink('s24','s25',**linkSSParameters)
		lss28 = self.addLink('s25','s50',**linkSSParameters)
		lss29 = self.addLink('s25','s26',**linkSSParameters)
		lss30 = self.addLink('s25','s27',**linkSSParameters)
		lss31 = self.addLink('s25','s28',**linkSSParameters)
		lss32 = self.addLink('s29','s30',**linkSSParameters)
		lss33 = self.addLink('s31','s33',**linkSSParameters)
		lss34 = self.addLink('s32','s33',**linkSSParameters)
		lss35 = self.addLink('s32','s52',**linkSSParameters)
		lss36 = self.addLink('s33','s34',**linkSSParameters)
		lss37 = self.addLink('s33','s35',**linkSSParameters)
		lss38 = self.addLink('s36','s45',**linkSSParameters)
		lss39 = self.addLink('s37','s45',**linkSSParameters)
		lss40 = self.addLink('s38','s40',**linkSSParameters)
		lss41 = self.addLink('s40','s43',**linkSSParameters)
		lss42 = self.addLink('s40','s41',**linkSSParameters)
		lss43 = self.addLink('s42','s51',**linkSSParameters)
		lss44 = self.addLink('s43','s51',**linkSSParameters)
		lss45 = self.addLink('s43','s50',**linkSSParameters)
		lss46 = self.addLink('s44','s45',**linkSSParameters)
		lss47 = self.addLink('s45','s51',**linkSSParameters)
		lss48 = self.addLink('s45','s46',**linkSSParameters)
		lss49 = self.addLink('s45','s47',**linkSSParameters)
		lss50 = self.addLink('s48','s49',**linkSSParameters)
		lss51 = self.addLink('s49','s50',**linkSSParameters)
		lss52 = self.addLink('s49','s53',**linkSSParameters)
