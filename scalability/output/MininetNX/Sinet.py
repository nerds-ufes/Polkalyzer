...
class MininetNX( Topo ):
	def build( self ):
		...
		lss2 = self.addLink('s1','s9',**linkSSParameters)
		...
		lss7 = self.addLink('s5','s7',**linkSSParameters)
		lss8 = self.addLink('s6','s8',**linkSSParameters)
		lss9 = self.addLink('s8','s10',**linkSSParameters)
		lss10 = self.addLink('s10','s11',**linkSSParameters)
		lss11 = self.addLink('s10','s12',**linkSSParameters)
		
topos = { 'Sinet': ( lambda: MininetNX() ) }