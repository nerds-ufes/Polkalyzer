...
class MininetNX( Topo ):
	def build( self ):
		...
		lhs9 = self.addLink('s11','h9',**linkHSParameters)
		...
		lhs16 = self.addLink('s18','h16',**linkHSParameters)
		lhs17 = self.addLink('s19','h17',**linkHSParameters)
		lhs18 = self.addLink('s20','h18',**linkHSParameters)
		lhs19 = self.addLink('s21','h19',**linkHSParameters)
		lhs20 = self.addLink('s22','h20',**linkHSParameters)
		lhs21 = self.addLink('s23','h21',**linkHSParameters)
		...
		lss4 = self.addLink('s1','s20',**linkSSParameters)
		lss5 = self.addLink('s2','s19',**linkSSParameters)
		lss6 = self.addLink('s2','s17',**linkSSParameters)
		lss7 = self.addLink('s3','s5',**linkSSParameters)
		lss8 = self.addLink('s3','s7',**linkSSParameters)
		lss9 = self.addLink('s3','s11',**linkSSParameters)
		lss10 = self.addLink('s3','s12',**linkSSParameters)
		lss11 = self.addLink('s3','s14',**linkSSParameters)
		lss12 = self.addLink('s4','s5',**linkSSParameters)
		lss13 = self.addLink('s4','s24',**linkSSParameters)
		lss14 = self.addLink('s4','s8',**linkSSParameters)
		lss15 = self.addLink('s4','s22',**linkSSParameters)
		lss16 = self.addLink('s5','s25',**linkSSParameters)
		lss17 = self.addLink('s6','s7',**linkSSParameters)
		lss18 = self.addLink('s7','s18',**linkSSParameters)
		lss19 = self.addLink('s7','s13',**linkSSParameters)
		lss20 = self.addLink('s12','s23',**linkSSParameters)
		lss21 = self.addLink('s14','s15',**linkSSParameters)
		lss22 = self.addLink('s20','s21',**linkSSParameters)
