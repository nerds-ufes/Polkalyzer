...
class MininetNX( Topo ):
	def build( self ):
		...
		lss4 = self.addLink('s3','s73',**linkSSParameters)
		...
		lss17 = self.addLink('s15','s70',**linkSSParameters)
		lss18 = self.addLink('s15','s71',**linkSSParameters)
		lss19 = self.addLink('s15','s72',**linkSSParameters)
		lss20 = self.addLink('s15','s43',**linkSSParameters)
		lss21 = self.addLink('s15','s44',**linkSSParameters)
		...
		lss27 = self.addLink('s20','s21',**linkSSParameters)
		lss28 = self.addLink('s20','s69',**linkSSParameters)
		...
		lss43 = self.addLink('s35','s37',**linkSSParameters)
		lss44 = self.addLink('s35','s36',**linkSSParameters)
		lss45 = self.addLink('s37','s38',**linkSSParameters)
		lss46 = self.addLink('s37','s65',**linkSSParameters)
		...
		lss52 = self.addLink('s46','s68',**linkSSParameters)
		lss53 = self.addLink('s46','s48',**linkSSParameters)
		...
		lss61 = self.addLink('s55','s56',**linkSSParameters)
		lss62 = self.addLink('s56','s57',**linkSSParameters)
		lss63 = self.addLink('s57','s58',**linkSSParameters)
		lss64 = self.addLink('s57','s61',**linkSSParameters)
		lss65 = self.addLink('s58','s60',**linkSSParameters)
		lss66 = self.addLink('s58','s59',**linkSSParameters)
		lss67 = self.addLink('s60','s63',**linkSSParameters)
		lss68 = self.addLink('s62','s67',**linkSSParameters)
		lss69 = self.addLink('s63','s65',**linkSSParameters)
		lss70 = self.addLink('s63','s67',**linkSSParameters)
		lss71 = self.addLink('s64','s65',**linkSSParameters)
		lss72 = self.addLink('s66','s67',**linkSSParameters)
