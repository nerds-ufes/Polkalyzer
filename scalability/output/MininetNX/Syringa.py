...
class MininetNX( Topo ):
	def build( self ):
		...
		lss14 = self.addLink('s12','s15',**linkSSParameters)
		lss15 = self.addLink('s13','s14',**linkSSParameters)
		lss16 = self.addLink('s15','s70',**linkSSParameters)
		lss17 = self.addLink('s15','s71',**linkSSParameters)
		lss18 = self.addLink('s15','s72',**linkSSParameters)
		lss19 = self.addLink('s15','s43',**linkSSParameters)
		lss20 = self.addLink('s15','s44',**linkSSParameters)
		lss21 = self.addLink('s15','s16',**linkSSParameters)
		lss22 = self.addLink('s15','s17',**linkSSParameters)
		lss23 = self.addLink('s16','s18',**linkSSParameters)
		lss24 = self.addLink('s17','s42',**linkSSParameters)
		lss25 = self.addLink('s18','s69',**linkSSParameters)
		lss26 = self.addLink('s19','s69',**linkSSParameters)
		lss27 = self.addLink('s20','s69',**linkSSParameters)
		lss28 = self.addLink('s20','s21',**linkSSParameters)
		lss29 = self.addLink('s21','s22',**linkSSParameters)
		lss30 = self.addLink('s22','s23',**linkSSParameters)
		lss31 = self.addLink('s23','s24',**linkSSParameters)
		lss32 = self.addLink('s24','s25',**linkSSParameters)
		lss33 = self.addLink('s25','s26',**linkSSParameters)
		lss34 = self.addLink('s26','s27',**linkSSParameters)
		lss35 = self.addLink('s27','s28',**linkSSParameters)
		lss36 = self.addLink('s28','s29',**linkSSParameters)
		lss37 = self.addLink('s29','s40',**linkSSParameters)
		lss38 = self.addLink('s29','s30',**linkSSParameters)
		lss39 = self.addLink('s31','s32',**linkSSParameters)
		lss40 = self.addLink('s32','s33',**linkSSParameters)
		lss41 = self.addLink('s33','s39',**linkSSParameters)
		lss42 = self.addLink('s34','s35',**linkSSParameters)
		lss43 = self.addLink('s35','s36',**linkSSParameters)
		lss44 = self.addLink('s35','s37',**linkSSParameters)
		lss45 = self.addLink('s37','s65',**linkSSParameters)
		lss46 = self.addLink('s37','s38',**linkSSParameters)
		lss47 = self.addLink('s38','s39',**linkSSParameters)
		lss48 = self.addLink('s39','s40',**linkSSParameters)
		lss49 = self.addLink('s41','s48',**linkSSParameters)
		lss50 = self.addLink('s42','s68',**linkSSParameters)
		lss51 = self.addLink('s45','s46',**linkSSParameters)
		lss52 = self.addLink('s46','s48',**linkSSParameters)
		lss53 = self.addLink('s46','s68',**linkSSParameters)
		lss54 = self.addLink('s47','s51',**linkSSParameters)
		lss55 = self.addLink('s48','s51',**linkSSParameters)
		lss56 = self.addLink('s48','s49',**linkSSParameters)
		lss57 = self.addLink('s50','s51',**linkSSParameters)
		lss58 = self.addLink('s50','s52',**linkSSParameters)
		lss59 = self.addLink('s52','s53',**linkSSParameters)
		lss60 = self.addLink('s53','s54',**linkSSParameters)
		lss61 = self.addLink('s54','s55',**linkSSParameters)
		lss62 = self.addLink('s55','s56',**linkSSParameters)
		lss63 = self.addLink('s56','s57',**linkSSParameters)
		lss64 = self.addLink('s57','s58',**linkSSParameters)
		lss65 = self.addLink('s57','s61',**linkSSParameters)
		lss66 = self.addLink('s58','s59',**linkSSParameters)
		lss67 = self.addLink('s58','s60',**linkSSParameters)
		lss68 = self.addLink('s60','s63',**linkSSParameters)
		lss69 = self.addLink('s62','s67',**linkSSParameters)
		lss70 = self.addLink('s63','s65',**linkSSParameters)
		lss71 = self.addLink('s63','s67',**linkSSParameters)
		lss72 = self.addLink('s64','s65',**linkSSParameters)
		lss73 = self.addLink('s66','s67',**linkSSParameters)
