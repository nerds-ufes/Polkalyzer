...
class MininetNX( Topo ):
	def build( self ):
		...
		lss4 = self.addLink('s4','s5')
		lss5 = self.addLink('s4','s6')
		lss6 = self.addLink('s4','s7')
		lss7 = self.addLink('s4','s12')
		lss8 = self.addLink('s4','s15')
		lss9 = self.addLink('s4','s16')
		lss10 = self.addLink('s4','s20')
		lss11 = self.addLink('s4','s24')
		lss12 = self.addLink('s4','s26')
		lss13 = self.addLink('s4','s31')
		lss14 = self.addLink('s7','s8')
		lss15 = self.addLink('s7','s9')
		lss16 = self.addLink('s9','s31')
		lss17 = self.addLink('s9','s35')
		lss18 = self.addLink('s10','s16')
		lss19 = self.addLink('s11','s12')
		lss20 = self.addLink('s12','s13')
		lss21 = self.addLink('s12','s15')
		lss22 = self.addLink('s14','s15')
		lss23 = self.addLink('s15','s22')
		lss24 = self.addLink('s16','s17')
		lss25 = self.addLink('s17','s18')
		lss26 = self.addLink('s18','s19')
		lss27 = self.addLink('s19','s20')
		lss28 = self.addLink('s21','s22')
		lss29 = self.addLink('s22','s23')
		lss30 = self.addLink('s23','s24')
		lss31 = self.addLink('s24','s25')
		lss32 = self.addLink('s24','s26')
		lss33 = self.addLink('s26','s28')
		lss34 = self.addLink('s26','s27')
		lss35 = self.addLink('s26','s29')
		lss36 = self.addLink('s29','s33')
		lss37 = self.addLink('s30','s31')
		lss38 = self.addLink('s31','s32')
		lss39 = self.addLink('s33','s34')
		lss40 = self.addLink('s34','s35')
