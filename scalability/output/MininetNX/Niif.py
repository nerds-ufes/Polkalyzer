...
class MininetNX( Topo ):
	def build( self ):
		...
		lss5 = self.addLink('s4','s6',**linkSSParameters)
		lss6 = self.addLink('s4','s7',**linkSSParameters)
		lss7 = self.addLink('s4','s12',**linkSSParameters)
		lss8 = self.addLink('s4','s15',**linkSSParameters)
		lss9 = self.addLink('s4','s16',**linkSSParameters)
		lss10 = self.addLink('s4','s20',**linkSSParameters)
		lss11 = self.addLink('s4','s24',**linkSSParameters)
		lss12 = self.addLink('s4','s26',**linkSSParameters)
		lss13 = self.addLink('s4','s31',**linkSSParameters)
		lss14 = self.addLink('s7','s8',**linkSSParameters)
		lss15 = self.addLink('s7','s9',**linkSSParameters)
		lss16 = self.addLink('s9','s31',**linkSSParameters)
		lss17 = self.addLink('s9','s35',**linkSSParameters)
		lss18 = self.addLink('s10','s16',**linkSSParameters)
		...
		lss22 = self.addLink('s14','s15',**linkSSParameters)
		lss23 = self.addLink('s15','s22',**linkSSParameters)
		lss24 = self.addLink('s16','s17',**linkSSParameters)
		lss25 = self.addLink('s17','s18',**linkSSParameters)
		lss26 = self.addLink('s18','s19',**linkSSParameters)
		lss27 = self.addLink('s19','s20',**linkSSParameters)
		lss28 = self.addLink('s21','s22',**linkSSParameters)
		lss29 = self.addLink('s22','s23',**linkSSParameters)
		lss30 = self.addLink('s23','s24',**linkSSParameters)
		lss31 = self.addLink('s24','s25',**linkSSParameters)
		lss32 = self.addLink('s24','s26',**linkSSParameters)
		lss33 = self.addLink('s26','s28',**linkSSParameters)
		lss34 = self.addLink('s26','s27',**linkSSParameters)
		lss35 = self.addLink('s26','s29',**linkSSParameters)
		lss36 = self.addLink('s29','s33',**linkSSParameters)
		lss37 = self.addLink('s30','s31',**linkSSParameters)
		lss38 = self.addLink('s31','s32',**linkSSParameters)
		lss39 = self.addLink('s33','s34',**linkSSParameters)
		lss40 = self.addLink('s34','s35',**linkSSParameters)
		
topos = { 'Niif': ( lambda: MininetNX() ) }