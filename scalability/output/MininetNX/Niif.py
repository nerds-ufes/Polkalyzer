...
class MininetNX( Topo ):
	def build( self ):
		...
		lss16 = self.addLink('s9','s35',**linkSSParameters)
		lss17 = self.addLink('s10','s16',**linkSSParameters)
		...
		lss21 = self.addLink('s15','s22',**linkSSParameters)
		lss22 = self.addLink('s16','s17',**linkSSParameters)
		lss23 = self.addLink('s17','s18',**linkSSParameters)
		lss24 = self.addLink('s19','s20',**linkSSParameters)
		lss25 = self.addLink('s21','s22',**linkSSParameters)
		lss26 = self.addLink('s23','s24',**linkSSParameters)
		lss27 = self.addLink('s24','s25',**linkSSParameters)
		lss28 = self.addLink('s26','s28',**linkSSParameters)
		lss29 = self.addLink('s26','s27',**linkSSParameters)
		lss30 = self.addLink('s26','s29',**linkSSParameters)
		lss31 = self.addLink('s29','s33',**linkSSParameters)
		lss32 = self.addLink('s30','s31',**linkSSParameters)
		lss33 = self.addLink('s31','s32',**linkSSParameters)
		lss34 = self.addLink('s34','s35',**linkSSParameters)
