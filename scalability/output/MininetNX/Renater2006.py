...
class MininetNX( Topo ):
	def build( self ):
		...
		lss5 = self.addLink('s4','s27',**linkSSParameters)
		...
		lss10 = self.addLink('s9','s27',**linkSSParameters)
		lss11 = self.addLink('s9','s12',**linkSSParameters)
		lss12 = self.addLink('s10','s27',**linkSSParameters)
		lss13 = self.addLink('s11','s16',**linkSSParameters)
		lss14 = self.addLink('s13','s14',**linkSSParameters)
		lss15 = self.addLink('s14','s15',**linkSSParameters)
		lss16 = self.addLink('s15','s28',**linkSSParameters)
		lss17 = self.addLink('s15','s22',**linkSSParameters)
		lss18 = self.addLink('s16','s28',**linkSSParameters)
		lss19 = self.addLink('s17','s18',**linkSSParameters)
		lss20 = self.addLink('s18','s28',**linkSSParameters)
		lss21 = self.addLink('s19','s28',**linkSSParameters)
		lss22 = self.addLink('s20','s28',**linkSSParameters)
		lss23 = self.addLink('s20','s21',**linkSSParameters)
		lss24 = self.addLink('s22','s24',**linkSSParameters)
		lss25 = self.addLink('s22','s23',**linkSSParameters)
		lss26 = self.addLink('s27','s33',**linkSSParameters)
		lss27 = self.addLink('s27','s34',**linkSSParameters)
		lss28 = self.addLink('s27','s31',**linkSSParameters)
		lss29 = self.addLink('s28','s32',**linkSSParameters)
		lss30 = self.addLink('s28','s29',**linkSSParameters)
		lss31 = self.addLink('s30','s31',**linkSSParameters)
