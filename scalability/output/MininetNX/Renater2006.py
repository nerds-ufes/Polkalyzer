...
class MininetNX( Topo ):
	def build( self ):
		...
		lss4 = self.addLink('s3','s27')
		lss5 = self.addLink('s3','s4')
		lss6 = self.addLink('s4','s27')
		lss7 = self.addLink('s5','s27')
		lss8 = self.addLink('s5','s6')
		lss9 = self.addLink('s6','s7')
		lss10 = self.addLink('s7','s8')
		lss11 = self.addLink('s8','s9')
		lss12 = self.addLink('s9','s27')
		lss13 = self.addLink('s9','s10')
		lss14 = self.addLink('s9','s11')
		lss15 = self.addLink('s9','s12')
		lss16 = self.addLink('s10','s27')
		lss17 = self.addLink('s11','s16')
		lss18 = self.addLink('s12','s13')
		lss19 = self.addLink('s12','s14')
		lss20 = self.addLink('s13','s14')
		lss21 = self.addLink('s14','s15')
		lss22 = self.addLink('s15','s28')
		lss23 = self.addLink('s15','s22')
		lss24 = self.addLink('s16','s28')
		lss25 = self.addLink('s17','s18')
		lss26 = self.addLink('s17','s28')
		lss27 = self.addLink('s18','s28')
		lss28 = self.addLink('s19','s28')
		lss29 = self.addLink('s20','s28')
		lss30 = self.addLink('s20','s21')
		lss31 = self.addLink('s21','s22')
		lss32 = self.addLink('s22','s24')
		lss33 = self.addLink('s22','s23')
		lss34 = self.addLink('s27','s33')
		lss35 = self.addLink('s27','s34')
		lss36 = self.addLink('s27','s28')
		lss37 = self.addLink('s27','s29')
		lss38 = self.addLink('s27','s31')
		lss39 = self.addLink('s28','s32')
		lss40 = self.addLink('s28','s29')
		lss41 = self.addLink('s30','s31')
		lss42 = self.addLink('s31','s32')
