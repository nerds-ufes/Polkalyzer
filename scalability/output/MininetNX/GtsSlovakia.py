...
class MininetNX( Topo ):
	def build( self ):
		...
		lss2 = self.addLink('s0','s12')
		lss3 = self.addLink('s0','s13')
		lss4 = self.addLink('s0','s14')
		lss5 = self.addLink('s0','s15')
		lss6 = self.addLink('s0','s16')
		lss7 = self.addLink('s0','s17')
		lss8 = self.addLink('s0','s19')
		lss9 = self.addLink('s0','s20')
		lss10 = self.addLink('s0','s21')
		lss11 = self.addLink('s1','s32')
		lss12 = self.addLink('s1','s34')
		lss13 = self.addLink('s1','s33')
		lss14 = self.addLink('s1','s2')
		lss15 = self.addLink('s1','s22')
		lss16 = self.addLink('s1','s23')
		lss17 = self.addLink('s1','s24')
		lss18 = self.addLink('s1','s25')
		lss19 = self.addLink('s1','s26')
		lss20 = self.addLink('s1','s27')
		lss21 = self.addLink('s1','s28')
		lss22 = self.addLink('s1','s29')
		lss23 = self.addLink('s1','s30')
		lss24 = self.addLink('s1','s31')
		lss25 = self.addLink('s2','s3')
		lss26 = self.addLink('s2','s5')
		lss27 = self.addLink('s2','s6')
		lss28 = self.addLink('s2','s7')
		lss29 = self.addLink('s2','s8')
		lss30 = self.addLink('s2','s10')
		lss31 = self.addLink('s3','s9')
		lss32 = self.addLink('s3','s4')
		lss33 = self.addLink('s8','s9')
		lss34 = self.addLink('s9','s14')
		lss35 = self.addLink('s14','s23')
		lss36 = self.addLink('s16','s18')
