...
class MininetNX( Topo ):
	def build( self ):
		...
		lss31 = self.addLink('s3','s9',**linkSSParameters)
		lss32 = self.addLink('s3','s4',**linkSSParameters)
		lss33 = self.addLink('s8','s9',**linkSSParameters)
		lss34 = self.addLink('s9','s14',**linkSSParameters)
		lss35 = self.addLink('s14','s23',**linkSSParameters)
		lss36 = self.addLink('s16','s18',**linkSSParameters)
