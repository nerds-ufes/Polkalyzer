...
class MininetNX( Topo ):
	def build( self ):
		...
		self.addLink('s11','h17')
		self.addLink('s11','h18')
		self.addLink('s12','h19')
		self.addLink('s12','h20')
		self.addLink('s13','h21')
		self.addLink('s13','h22')
		self.addLink('s14','h23')
		self.addLink('s14','h24')
		self.addLink('s15','h25')
		self.addLink('s15','h26')
		self.addLink('s16','h27')
		self.addLink('s16','h28')
		self.addLink('s17','h29')
		self.addLink('s17','h30')
		...
		self.addLink('s23','h41')
		self.addLink('s23','h42')
		self.addLink('s24','h43')
		self.addLink('s24','h44')
		self.addLink('s25','h45')
		self.addLink('s25','h46')
		self.addLink('s26','h47')
		self.addLink('s26','h48')
		self.addLink('s27','h49')
		self.addLink('s27','h50')
		self.addLink('s28','h51')
		self.addLink('s28','h52')
		self.addLink('s29','h53')
		self.addLink('s29','h54')
		self.addLink('s30','h55')
		self.addLink('s30','h56')
		self.addLink('s31','h57')
		self.addLink('s31','h58')
		self.addLink('s32','h59')
		self.addLink('s32','h60')
		self.addLink('s33','h61')
		self.addLink('s33','h62')
		self.addLink('s34','h63')
		self.addLink('s34','h64')
		self.addLink('s35','h65')
		self.addLink('s35','h66')
		self.addLink('s36','h67')
		self.addLink('s36','h68')
		self.addLink('s37','h69')
		self.addLink('s37','h70')
		self.addLink('s38','h71')
		self.addLink('s38','h72')
		self.addLink('s39','h73')
		self.addLink('s39','h74')
