...
class MininetNX( Topo ):
	def build( self ):
		...
		lss12 = self.addLink('s6','s8',**linkSSParameters)
		lss13 = self.addLink('s6','s7',**linkSSParameters)
		lss14 = self.addLink('s7','s26',**linkSSParameters)
		lss15 = self.addLink('s8','s10',**linkSSParameters)
		lss16 = self.addLink('s9','s10',**linkSSParameters)
		lss17 = self.addLink('s10','s27',**linkSSParameters)
		lss18 = self.addLink('s10','s11',**linkSSParameters)
		lss19 = self.addLink('s12','s15',**linkSSParameters)
		lss20 = self.addLink('s14','s62',**linkSSParameters)
		lss21 = self.addLink('s15','s62',**linkSSParameters)
		lss22 = self.addLink('s16','s18',**linkSSParameters)
		lss23 = self.addLink('s16','s17',**linkSSParameters)
		lss24 = self.addLink('s16','s19',**linkSSParameters)
		lss25 = self.addLink('s17','s23',**linkSSParameters)
		lss26 = self.addLink('s19','s24',**linkSSParameters)
		lss27 = self.addLink('s19','s50',**linkSSParameters)
		lss28 = self.addLink('s20','s21',**linkSSParameters)
		lss29 = self.addLink('s21','s22',**linkSSParameters)
		lss30 = self.addLink('s22','s38',**linkSSParameters)
		lss31 = self.addLink('s24','s49',**linkSSParameters)
		lss32 = self.addLink('s25','s26',**linkSSParameters)
		lss33 = self.addLink('s25','s29',**linkSSParameters)
		lss34 = self.addLink('s26','s28',**linkSSParameters)
		lss35 = self.addLink('s28','s30',**linkSSParameters)
		lss36 = self.addLink('s30','s31',**linkSSParameters)
		lss37 = self.addLink('s31','s32',**linkSSParameters)
		lss38 = self.addLink('s33','s63',**linkSSParameters)
		lss39 = self.addLink('s34','s63',**linkSSParameters)
		lss40 = self.addLink('s35','s42',**linkSSParameters)
		lss41 = self.addLink('s36','s37',**linkSSParameters)
		lss42 = self.addLink('s37','s38',**linkSSParameters)
		lss43 = self.addLink('s38','s39',**linkSSParameters)
		lss44 = self.addLink('s39','s40',**linkSSParameters)
		lss45 = self.addLink('s39','s44',**linkSSParameters)
		lss46 = self.addLink('s40','s41',**linkSSParameters)
		lss47 = self.addLink('s41','s63',**linkSSParameters)
		lss48 = self.addLink('s42','s43',**linkSSParameters)
		lss49 = self.addLink('s43','s44',**linkSSParameters)
		lss50 = self.addLink('s45','s48',**linkSSParameters)
		lss51 = self.addLink('s45','s64',**linkSSParameters)
		lss52 = self.addLink('s45','s46',**linkSSParameters)
		lss53 = self.addLink('s47','s48',**linkSSParameters)
		lss54 = self.addLink('s48','s50',**linkSSParameters)
		lss55 = self.addLink('s48','s54',**linkSSParameters)
		lss56 = self.addLink('s51','s54',**linkSSParameters)
		lss57 = self.addLink('s51','s52',**linkSSParameters)
		lss58 = self.addLink('s51','s53',**linkSSParameters)
		lss59 = self.addLink('s55','s60',**linkSSParameters)
		lss60 = self.addLink('s55','s56',**linkSSParameters)
		lss61 = self.addLink('s57','s64',**linkSSParameters)
		lss62 = self.addLink('s57','s58',**linkSSParameters)
		lss63 = self.addLink('s58','s59',**linkSSParameters)
		lss64 = self.addLink('s60','s65',**linkSSParameters)
		lss65 = self.addLink('s61','s65',**linkSSParameters)
