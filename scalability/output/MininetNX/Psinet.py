...
class MininetNX( Topo ):
	def build( self ):
		...
		lss3 = self.addLink('s3','s8',**linkSSParameters)
		lss4 = self.addLink('s4','s7',**linkSSParameters)
		lss5 = self.addLink('s5','s6',**linkSSParameters)
		lss6 = self.addLink('s6','s8',**linkSSParameters)
		lss7 = self.addLink('s6','s7',**linkSSParameters)
		lss8 = self.addLink('s7','s15',**linkSSParameters)
		...
		lss12 = self.addLink('s10','s13',**linkSSParameters)
		lss13 = self.addLink('s11','s12',**linkSSParameters)
		lss14 = self.addLink('s11','s13',**linkSSParameters)
		lss15 = self.addLink('s13','s16',**linkSSParameters)
		lss16 = self.addLink('s14','s21',**linkSSParameters)
		...
		lss24 = self.addLink('s21','s23',**linkSSParameters)
		
topos = { 'Psinet': ( lambda: MininetNX() ) }