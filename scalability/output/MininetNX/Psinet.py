...
class MininetNX( Topo ):
	def build( self ):
		...
		lss3 = self.addLink('s3','s8')
		lss4 = self.addLink('s4','s7')
		lss5 = self.addLink('s5','s6')
		lss6 = self.addLink('s6','s8')
		lss7 = self.addLink('s6','s7')
		lss8 = self.addLink('s7','s15')
		lss9 = self.addLink('s8','s9')
		lss10 = self.addLink('s9','s10')
		lss11 = self.addLink('s10','s11')
		lss12 = self.addLink('s10','s13')
		lss13 = self.addLink('s11','s12')
		lss14 = self.addLink('s11','s13')
		lss15 = self.addLink('s13','s16')
		lss16 = self.addLink('s14','s21')
		lss17 = self.addLink('s14','s15')
		lss18 = self.addLink('s16','s17')
		lss19 = self.addLink('s17','s18')
		lss20 = self.addLink('s18','s19')
		lss21 = self.addLink('s19','s20')
		lss22 = self.addLink('s20','s21')
		lss23 = self.addLink('s21','s22')
		lss24 = self.addLink('s21','s23')
