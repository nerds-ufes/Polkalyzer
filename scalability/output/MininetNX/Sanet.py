...
class MininetNX( Topo ):
	def build( self ):
		...
		lss16 = self.addLink('s7','s30',**linkSSParameters)
		...
		lss22 = self.addLink('s12','s34',**linkSSParameters)
		lss23 = self.addLink('s13','s14',**linkSSParameters)
		lss24 = self.addLink('s13','s30',**linkSSParameters)
		lss25 = self.addLink('s14','s15',**linkSSParameters)
		lss26 = self.addLink('s14','s29',**linkSSParameters)
		lss27 = self.addLink('s14','s31',**linkSSParameters)
		lss28 = self.addLink('s15','s17',**linkSSParameters)
		lss29 = self.addLink('s16','s17',**linkSSParameters)
		lss30 = self.addLink('s17','s18',**linkSSParameters)
		lss31 = self.addLink('s18','s20',**linkSSParameters)
		lss32 = self.addLink('s19','s20',**linkSSParameters)
		lss33 = self.addLink('s20','s27',**linkSSParameters)
		lss34 = self.addLink('s21','s25',**linkSSParameters)
		lss35 = self.addLink('s21','s27',**linkSSParameters)
		lss36 = self.addLink('s22','s23',**linkSSParameters)
		...
		lss40 = self.addLink('s26','s28',**linkSSParameters)
		...
		lss44 = self.addLink('s34','s35',**linkSSParameters)
