...
class MininetNX( Topo ):
	def build( self ):
		...
		lss0 = self.addLink('s0','s34',**linkSSParameters)
		lss1 = self.addLink('s1','s3',**linkSSParameters)
		lss2 = self.addLink('s1','s36',**linkSSParameters)
		lss3 = self.addLink('s1','s37',**linkSSParameters)
		lss4 = self.addLink('s2','s3',**linkSSParameters)
		lss5 = self.addLink('s2','s38',**linkSSParameters)
		lss6 = self.addLink('s2','s39',**linkSSParameters)
		lss7 = self.addLink('s3','s4',**linkSSParameters)
		lss8 = self.addLink('s3','s33',**linkSSParameters)
		lss9 = self.addLink('s3','s40',**linkSSParameters)
		lss10 = self.addLink('s3','s41',**linkSSParameters)
		lss11 = self.addLink('s3','s42',**linkSSParameters)
		lss12 = self.addLink('s4','s8',**linkSSParameters)
		lss13 = self.addLink('s4','s7',**linkSSParameters)
		lss14 = self.addLink('s5','s6',**linkSSParameters)
		lss15 = self.addLink('s6','s7',**linkSSParameters)
		lss16 = self.addLink('s8','s9',**linkSSParameters)
		lss17 = self.addLink('s9','s10',**linkSSParameters)
		lss18 = self.addLink('s10','s11',**linkSSParameters)
		lss19 = self.addLink('s11','s12',**linkSSParameters)
		lss20 = self.addLink('s12','s34',**linkSSParameters)
		lss21 = self.addLink('s12','s16',**linkSSParameters)
		lss22 = self.addLink('s13','s14',**linkSSParameters)
		lss23 = self.addLink('s13','s30',**linkSSParameters)
		lss24 = self.addLink('s14','s15',**linkSSParameters)
		lss25 = self.addLink('s14','s29',**linkSSParameters)
		lss26 = self.addLink('s14','s31',**linkSSParameters)
		lss27 = self.addLink('s15','s17',**linkSSParameters)
		lss28 = self.addLink('s16','s17',**linkSSParameters)
		lss29 = self.addLink('s17','s18',**linkSSParameters)
		lss30 = self.addLink('s18','s20',**linkSSParameters)
		lss31 = self.addLink('s19','s20',**linkSSParameters)
		lss32 = self.addLink('s20','s27',**linkSSParameters)
		lss33 = self.addLink('s21','s27',**linkSSParameters)
		lss34 = self.addLink('s21','s25',**linkSSParameters)
		lss35 = self.addLink('s22','s23',**linkSSParameters)
		lss36 = self.addLink('s23','s24',**linkSSParameters)
		lss37 = self.addLink('s24','s25',**linkSSParameters)
		lss38 = self.addLink('s26','s28',**linkSSParameters)
