...
class MininetNX( Topo ):
	def build( self ):
		...
		lss0 = self.addLink('s0','s34')
		lss1 = self.addLink('s1','s3')
		lss2 = self.addLink('s1','s36')
		lss3 = self.addLink('s1','s37')
		lss4 = self.addLink('s2','s3')
		lss5 = self.addLink('s2','s38')
		lss6 = self.addLink('s2','s39')
		lss7 = self.addLink('s3','s4')
		lss8 = self.addLink('s3','s33')
		lss9 = self.addLink('s3','s40')
		lss10 = self.addLink('s3','s41')
		lss11 = self.addLink('s3','s42')
		lss12 = self.addLink('s4','s8')
		lss13 = self.addLink('s4','s7')
		lss14 = self.addLink('s5','s6')
		lss15 = self.addLink('s6','s7')
		lss16 = self.addLink('s7','s30')
		...
		lss22 = self.addLink('s12','s34')
		lss23 = self.addLink('s13','s14')
		lss24 = self.addLink('s13','s30')
		lss25 = self.addLink('s14','s15')
		lss26 = self.addLink('s14','s29')
		lss27 = self.addLink('s14','s31')
		lss28 = self.addLink('s15','s17')
		lss29 = self.addLink('s16','s17')
		lss30 = self.addLink('s17','s18')
		lss31 = self.addLink('s18','s20')
		lss32 = self.addLink('s19','s20')
		lss33 = self.addLink('s20','s27')
		lss34 = self.addLink('s21','s25')
		lss35 = self.addLink('s21','s27')
		lss36 = self.addLink('s22','s23')
		lss37 = self.addLink('s23','s24')
		lss38 = self.addLink('s24','s25')
		lss39 = self.addLink('s25','s26')
		lss40 = self.addLink('s26','s28')
		lss41 = self.addLink('s28','s29')
		lss42 = self.addLink('s31','s32')
		lss43 = self.addLink('s32','s33')
		lss44 = self.addLink('s34','s35')
