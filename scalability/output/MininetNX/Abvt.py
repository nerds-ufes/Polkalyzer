...
class MininetNX( Topo ):
	def build( self ):
		...
		lss8 = self.addLink('s6','s21')
		lss9 = self.addLink('s7','s13')
		lss10 = self.addLink('s7','s21')
		lss11 = self.addLink('s8','s9')
		lss12 = self.addLink('s8','s21')
		lss13 = self.addLink('s8','s22')
		lss14 = self.addLink('s9','s22')
		lss15 = self.addLink('s10','s11')
		lss16 = self.addLink('s10','s12')
		lss17 = self.addLink('s10','s22')
		lss18 = self.addLink('s11','s22')
		lss19 = self.addLink('s12','s16')
		lss20 = self.addLink('s12','s17')
		lss21 = self.addLink('s12','s15')
		lss22 = self.addLink('s13','s16')
		lss23 = self.addLink('s13','s17')
		lss24 = self.addLink('s13','s18')
		lss25 = self.addLink('s13','s14')
		lss26 = self.addLink('s14','s15')
		lss27 = self.addLink('s17','s20')
