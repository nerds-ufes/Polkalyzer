...
class MininetNX( Topo ):
	def build( self ):
		...
		lss7 = self.addLink('s5','s22',**linkSSParameters)
		lss8 = self.addLink('s6','s21',**linkSSParameters)
		lss9 = self.addLink('s7','s13',**linkSSParameters)
		lss10 = self.addLink('s7','s21',**linkSSParameters)
		lss11 = self.addLink('s8','s9',**linkSSParameters)
		lss12 = self.addLink('s8','s21',**linkSSParameters)
		lss13 = self.addLink('s8','s22',**linkSSParameters)
		lss14 = self.addLink('s9','s22',**linkSSParameters)
		lss15 = self.addLink('s10','s11',**linkSSParameters)
		lss16 = self.addLink('s10','s12',**linkSSParameters)
		lss17 = self.addLink('s10','s22',**linkSSParameters)
		lss18 = self.addLink('s11','s22',**linkSSParameters)
		...
		lss22 = self.addLink('s13','s16',**linkSSParameters)
		lss23 = self.addLink('s13','s17',**linkSSParameters)
		lss24 = self.addLink('s13','s18',**linkSSParameters)
		lss25 = self.addLink('s13','s14',**linkSSParameters)
		lss26 = self.addLink('s14','s15',**linkSSParameters)
		lss27 = self.addLink('s17','s20',**linkSSParameters)
		lss28 = self.addLink('s17','s18',**linkSSParameters)
		lss29 = self.addLink('s18','s19',**linkSSParameters)
		lss30 = self.addLink('s19','s20',**linkSSParameters)
		
topos = { 'Abvt': ( lambda: MininetNX() ) }