...
class MininetNX( Topo ):
	def build( self ):
		...
		lss8 = self.addLink('s7','s21',**linkSSParameters)
		lss9 = self.addLink('s8','s21',**linkSSParameters)
		lss10 = self.addLink('s8','s9',**linkSSParameters)
		lss11 = self.addLink('s8','s22',**linkSSParameters)
		lss12 = self.addLink('s10','s12',**linkSSParameters)
		lss13 = self.addLink('s11','s22',**linkSSParameters)
		lss14 = self.addLink('s12','s16',**linkSSParameters)
		lss15 = self.addLink('s13','s16',**linkSSParameters)
		lss16 = self.addLink('s13','s17',**linkSSParameters)
		lss17 = self.addLink('s13','s18',**linkSSParameters)
