...
class MininetNX( Topo ):
	def build( self ):
		...
		lss2 = self.addLink('s0','s19')
		lss3 = self.addLink('s1','s2')
		lss4 = self.addLink('s2','s3')
		lss5 = self.addLink('s3','s4')
		lss6 = self.addLink('s3','s5')
		lss7 = self.addLink('s3','s15')
		lss8 = self.addLink('s3','s16')
		lss9 = self.addLink('s3','s18')
		lss10 = self.addLink('s3','s20')
		lss11 = self.addLink('s3','s23')
		lss12 = self.addLink('s5','s9')
		lss13 = self.addLink('s5','s6')
		lss14 = self.addLink('s6','s21')
