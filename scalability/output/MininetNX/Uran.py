...
class MininetNX( Topo ):
	def build( self ):
		...
		lss2 = self.addLink('s0','s19',**linkSSParameters)
		...
		lss7 = self.addLink('s3','s15',**linkSSParameters)
		lss8 = self.addLink('s3','s16',**linkSSParameters)
		lss9 = self.addLink('s3','s18',**linkSSParameters)
		lss10 = self.addLink('s3','s20',**linkSSParameters)
		lss11 = self.addLink('s3','s23',**linkSSParameters)
		lss12 = self.addLink('s5','s9',**linkSSParameters)
		lss13 = self.addLink('s5','s6',**linkSSParameters)
		lss14 = self.addLink('s6','s21',**linkSSParameters)
		...
		lss20 = self.addLink('s13','s23',**linkSSParameters)
		lss21 = self.addLink('s13','s14',**linkSSParameters)
		lss22 = self.addLink('s14','s22',**linkSSParameters)
