...
class MininetNX( Topo ):
	def build( self ):
		...
		lhs14 = self.addLink('s18','h14',**linkHSParameters)
		lhs15 = self.addLink('s19','h15',**linkHSParameters)
		lhs16 = self.addLink('s20','h16',**linkHSParameters)
