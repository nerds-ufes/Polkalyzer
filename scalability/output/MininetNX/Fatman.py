...
class MininetNX( Topo ):
	def build( self ):
		...
		lhs28 = self.addLink('s18','h28')
		lhs29 = self.addLink('s18','h29')
		lhs30 = self.addLink('s19','h30')
		lhs31 = self.addLink('s19','h31')
		lhs32 = self.addLink('s20','h32')
		lhs33 = self.addLink('s20','h33')
		#Add a link of switches of original topology
		lss0 = self.addLink('s0','s1')
		lss1 = self.addLink('s0','s3')
		lss2 = self.addLink('s0','s20')
		lss3 = self.addLink('s1','s2')
		lss4 = self.addLink('s1','s19')
		lss5 = self.addLink('s2','s3')
		lss6 = self.addLink('s2','s4')
		lss7 = self.addLink('s2','s5')
		lss8 = self.addLink('s2','s6')
		lss9 = self.addLink('s2','s7')
		lss10 = self.addLink('s2','s8')
		lss11 = self.addLink('s2','s9')
		lss12 = self.addLink('s2','s18')
		lss13 = self.addLink('s3','s4')
		lss14 = self.addLink('s3','s5')
		lss15 = self.addLink('s3','s6')
		lss16 = self.addLink('s3','s18')
		lss17 = self.addLink('s10','s18')
		lss18 = self.addLink('s10','s11')
		lss19 = self.addLink('s10','s12')
		lss20 = self.addLink('s10','s13')
