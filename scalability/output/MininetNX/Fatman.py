...
class MininetNX( Topo ):
	def build( self ):
		...
		lhs28 = self.addLink('s18','h28',**linkHSParameters)
		lhs29 = self.addLink('s18','h29',**linkHSParameters)
		lhs30 = self.addLink('s19','h30',**linkHSParameters)
		lhs31 = self.addLink('s19','h31',**linkHSParameters)
		lhs32 = self.addLink('s20','h32',**linkHSParameters)
		lhs33 = self.addLink('s20','h33',**linkHSParameters)
		...
		lss2 = self.addLink('s0','s20',**linkSSParameters)
		lss3 = self.addLink('s1','s2',**linkSSParameters)
		lss4 = self.addLink('s1','s19',**linkSSParameters)
		lss5 = self.addLink('s2','s3',**linkSSParameters)
		lss6 = self.addLink('s2','s4',**linkSSParameters)
		lss7 = self.addLink('s2','s5',**linkSSParameters)
		lss8 = self.addLink('s2','s6',**linkSSParameters)
		lss9 = self.addLink('s2','s7',**linkSSParameters)
		lss10 = self.addLink('s2','s8',**linkSSParameters)
		lss11 = self.addLink('s2','s9',**linkSSParameters)
		lss12 = self.addLink('s2','s18',**linkSSParameters)
		lss13 = self.addLink('s3','s4',**linkSSParameters)
		lss14 = self.addLink('s3','s5',**linkSSParameters)
		lss15 = self.addLink('s3','s6',**linkSSParameters)
		lss16 = self.addLink('s3','s18',**linkSSParameters)
		lss17 = self.addLink('s10','s18',**linkSSParameters)
		lss18 = self.addLink('s10','s11',**linkSSParameters)
		lss19 = self.addLink('s10','s12',**linkSSParameters)
		lss20 = self.addLink('s10','s13',**linkSSParameters)
		
topos = { 'Fatman': ( lambda: MininetNX() ) }