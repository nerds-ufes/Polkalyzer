...
class MininetNX( Topo ):
	def build( self ):
		...
		lss5 = self.addLink('s5','s19',**linkSSParameters)
		lss6 = self.addLink('s6','s22',**linkSSParameters)
		lss7 = self.addLink('s7','s16',**linkSSParameters)
		lss8 = self.addLink('s7','s8',**linkSSParameters)
		lss9 = self.addLink('s7','s9',**linkSSParameters)
		lss10 = self.addLink('s7','s10',**linkSSParameters)
		lss11 = self.addLink('s7','s11',**linkSSParameters)
		lss12 = self.addLink('s11','s13',**linkSSParameters)
		lss13 = self.addLink('s12','s21',**linkSSParameters)
		lss14 = self.addLink('s13','s14',**linkSSParameters)
		lss15 = self.addLink('s13','s15',**linkSSParameters)
		lss16 = self.addLink('s16','s20',**linkSSParameters)
		lss17 = self.addLink('s16','s17',**linkSSParameters)
		lss18 = self.addLink('s16','s18',**linkSSParameters)
		lss19 = self.addLink('s19','s20',**linkSSParameters)
		lss20 = self.addLink('s19','s21',**linkSSParameters)
		lss21 = self.addLink('s21','s22',**linkSSParameters)
		lss22 = self.addLink('s21','s23',**linkSSParameters)
