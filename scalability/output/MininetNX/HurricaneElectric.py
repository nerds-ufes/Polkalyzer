...
class MininetNX( Topo ):
	def build( self ):
		...
		lss2 = self.addLink('s2','s19',**linkSSParameters)
		...
		lss6 = self.addLink('s4','s8',**linkSSParameters)
		lss7 = self.addLink('s4','s5',**linkSSParameters)
		lss8 = self.addLink('s4','s7',**linkSSParameters)
		lss9 = self.addLink('s5','s19',**linkSSParameters)
		lss10 = self.addLink('s5','s21',**linkSSParameters)
		lss11 = self.addLink('s6','s22',**linkSSParameters)
		lss12 = self.addLink('s7','s8',**linkSSParameters)
		lss13 = self.addLink('s7','s9',**linkSSParameters)
		lss14 = self.addLink('s7','s10',**linkSSParameters)
		lss15 = self.addLink('s7','s11',**linkSSParameters)
		lss16 = self.addLink('s7','s16',**linkSSParameters)
		lss17 = self.addLink('s7','s21',**linkSSParameters)
		lss18 = self.addLink('s10','s12',**linkSSParameters)
		lss19 = self.addLink('s10','s21',**linkSSParameters)
		lss20 = self.addLink('s11','s12',**linkSSParameters)
		lss21 = self.addLink('s11','s13',**linkSSParameters)
		lss22 = self.addLink('s12','s13',**linkSSParameters)
		lss23 = self.addLink('s12','s21',**linkSSParameters)
		lss24 = self.addLink('s13','s14',**linkSSParameters)
		lss25 = self.addLink('s13','s15',**linkSSParameters)
		...
		lss29 = self.addLink('s16','s20',**linkSSParameters)
		lss30 = self.addLink('s17','s19',**linkSSParameters)
		...
		lss34 = self.addLink('s21','s22',**linkSSParameters)
		lss35 = self.addLink('s21','s23',**linkSSParameters)
		lss36 = self.addLink('s22','s23',**linkSSParameters)
		
topos = { 'HurricaneElectric': ( lambda: MininetNX() ) }