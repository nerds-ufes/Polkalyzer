...
class MininetNX( Topo ):
	def build( self ):
		...
		lss2 = self.addLink('s2','s19')
		lss3 = self.addLink('s3','s16')
		lss4 = self.addLink('s3','s4')
		lss5 = self.addLink('s3','s21')
		lss6 = self.addLink('s4','s8')
		lss7 = self.addLink('s4','s5')
		lss8 = self.addLink('s4','s7')
		lss9 = self.addLink('s5','s19')
		lss10 = self.addLink('s5','s21')
		lss11 = self.addLink('s6','s22')
		lss12 = self.addLink('s7','s8')
		lss13 = self.addLink('s7','s9')
		lss14 = self.addLink('s7','s10')
		lss15 = self.addLink('s7','s11')
		lss16 = self.addLink('s7','s16')
		lss17 = self.addLink('s7','s21')
		lss18 = self.addLink('s10','s12')
		lss19 = self.addLink('s10','s21')
		lss20 = self.addLink('s11','s12')
		lss21 = self.addLink('s11','s13')
		lss22 = self.addLink('s12','s13')
		lss23 = self.addLink('s12','s21')
		...
		lss29 = self.addLink('s16','s20')
		lss30 = self.addLink('s17','s19')
		lss31 = self.addLink('s18','s19')
		lss32 = self.addLink('s19','s20')
		lss33 = self.addLink('s19','s21')
		lss34 = self.addLink('s21','s22')
		lss35 = self.addLink('s21','s23')
