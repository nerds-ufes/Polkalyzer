...
class MininetNX( Topo ):
	def build( self ):
		...
		lss8 = self.addLink('s7','s17',**linkSSParameters)
		...
		lss15 = self.addLink('s15','s17',**linkSSParameters)
		lss16 = self.addLink('s16','s17',**linkSSParameters)
		lss17 = self.addLink('s16','s30',**linkSSParameters)
		lss18 = self.addLink('s17','s20',**linkSSParameters)
		lss19 = self.addLink('s18','s19',**linkSSParameters)
		lss20 = self.addLink('s19','s20',**linkSSParameters)
		lss21 = self.addLink('s20','s21',**linkSSParameters)
		lss22 = self.addLink('s20','s23',**linkSSParameters)
		lss23 = self.addLink('s21','s22',**linkSSParameters)
		lss24 = self.addLink('s23','s24',**linkSSParameters)
		lss25 = self.addLink('s24','s28',**linkSSParameters)
		lss26 = self.addLink('s25','s29',**linkSSParameters)
