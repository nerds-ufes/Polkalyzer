...
class MininetNX( Topo ):
	def build( self ):
		...
		lss0 = self.addLink('s0','s20',**linkSSParameters)
		lss1 = self.addLink('s1','s20',**linkSSParameters)
		lss2 = self.addLink('s2','s20',**linkSSParameters)
		lss3 = self.addLink('s3','s16',**linkSSParameters)
		lss4 = self.addLink('s4','s16',**linkSSParameters)
		lss5 = self.addLink('s5','s8',**linkSSParameters)
		lss6 = self.addLink('s5','s6',**linkSSParameters)
		lss7 = self.addLink('s6','s7',**linkSSParameters)
		lss8 = self.addLink('s7','s9',**linkSSParameters)
		lss9 = self.addLink('s7','s17',**linkSSParameters)
		...
		lss13 = self.addLink('s10','s12',**linkSSParameters)
		lss14 = self.addLink('s13','s14',**linkSSParameters)
		lss15 = self.addLink('s14','s15',**linkSSParameters)
		lss16 = self.addLink('s15','s17',**linkSSParameters)
		lss17 = self.addLink('s15','s18',**linkSSParameters)
		lss18 = self.addLink('s16','s19',**linkSSParameters)
		lss19 = self.addLink('s16','s17',**linkSSParameters)
		lss20 = self.addLink('s16','s30',**linkSSParameters)
		lss21 = self.addLink('s17','s20',**linkSSParameters)
		lss22 = self.addLink('s18','s19',**linkSSParameters)
		lss23 = self.addLink('s19','s20',**linkSSParameters)
		lss24 = self.addLink('s20','s21',**linkSSParameters)
		lss25 = self.addLink('s20','s23',**linkSSParameters)
		lss26 = self.addLink('s21','s22',**linkSSParameters)
		lss27 = self.addLink('s22','s23',**linkSSParameters)
		lss28 = self.addLink('s23','s24',**linkSSParameters)
		lss29 = self.addLink('s24','s28',**linkSSParameters)
		lss30 = self.addLink('s25','s29',**linkSSParameters)
		lss31 = self.addLink('s26','s27',**linkSSParameters)
		lss32 = self.addLink('s27','s28',**linkSSParameters)
		lss33 = self.addLink('s28','s29',**linkSSParameters)
