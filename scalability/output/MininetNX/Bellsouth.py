...
class MininetNX( Topo ):
	def build( self ):
		...
		lss0 = self.addLink('s0','s21')
		lss1 = self.addLink('s0','s29')
		lss2 = self.addLink('s1','s2')
		lss3 = self.addLink('s1','s26')
		lss4 = self.addLink('s1','s21')
		lss5 = self.addLink('s3','s17')
		lss6 = self.addLink('s3','s18')
		lss7 = self.addLink('s3','s19')
		lss8 = self.addLink('s3','s20')
		lss9 = self.addLink('s3','s50')
		lss10 = self.addLink('s4','s42')
		lss11 = self.addLink('s5','s12')
		lss12 = self.addLink('s5','s21')
		lss13 = self.addLink('s5','s6')
		lss14 = self.addLink('s5','s15')
		lss15 = self.addLink('s6','s16')
		lss16 = self.addLink('s6','s7')
		lss17 = self.addLink('s6','s21')
		lss18 = self.addLink('s6','s29')
		lss19 = self.addLink('s7','s8')
		lss20 = self.addLink('s7','s9')
		lss21 = self.addLink('s7','s11')
		lss22 = self.addLink('s9','s10')
		lss23 = self.addLink('s13','s16')
		lss24 = self.addLink('s14','s42')
		lss25 = self.addLink('s14','s29')
		lss26 = self.addLink('s16','s21')
		lss27 = self.addLink('s21','s34')
		lss28 = self.addLink('s21','s39')
		lss29 = self.addLink('s21','s42')
		lss30 = self.addLink('s21','s43')
		lss31 = self.addLink('s21','s45')
		lss32 = self.addLink('s21','s50')
		lss33 = self.addLink('s21','s22')
		lss34 = self.addLink('s21','s24')
		lss35 = self.addLink('s21','s38')
		lss36 = self.addLink('s21','s29')
		lss37 = self.addLink('s21','s37')
		lss38 = self.addLink('s22','s29')
		lss39 = self.addLink('s23','s24')
		lss40 = self.addLink('s24','s29')
		lss41 = self.addLink('s25','s50')
		lss42 = self.addLink('s25','s29')
		lss43 = self.addLink('s26','s29')
		lss44 = self.addLink('s27','s29')
		lss45 = self.addLink('s28','s29')
		lss46 = self.addLink('s29','s34')
		lss47 = self.addLink('s29','s35')
		lss48 = self.addLink('s29','s37')
		lss49 = self.addLink('s29','s39')
		lss50 = self.addLink('s29','s38')
		lss51 = self.addLink('s29','s43')
		lss52 = self.addLink('s29','s45')
		lss53 = self.addLink('s29','s48')
		lss54 = self.addLink('s30','s32')
		lss55 = self.addLink('s31','s32')
		lss56 = self.addLink('s32','s33')
		lss57 = self.addLink('s32','s50')
		lss58 = self.addLink('s36','s37')
		lss59 = self.addLink('s37','s49')
		lss60 = self.addLink('s40','s42')
		lss61 = self.addLink('s41','s42')
		lss62 = self.addLink('s43','s48')
		lss63 = self.addLink('s44','s45')
		lss64 = self.addLink('s45','s47')
		lss65 = self.addLink('s45','s46')
