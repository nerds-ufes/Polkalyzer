...
class MininetNX( Topo ):
	def build( self ):
		...
		lss2 = self.addLink('s1','s21',**linkSSParameters)
		lss3 = self.addLink('s1','s2',**linkSSParameters)
		lss4 = self.addLink('s3','s50',**linkSSParameters)
		...
		lss9 = self.addLink('s4','s42',**linkSSParameters)
		lss10 = self.addLink('s5','s21',**linkSSParameters)
		lss11 = self.addLink('s5','s12',**linkSSParameters)
		lss12 = self.addLink('s5','s15',**linkSSParameters)
		lss13 = self.addLink('s6','s21',**linkSSParameters)
		lss14 = self.addLink('s6','s7',**linkSSParameters)
		lss15 = self.addLink('s7','s8',**linkSSParameters)
		lss16 = self.addLink('s7','s9',**linkSSParameters)
		lss17 = self.addLink('s7','s11',**linkSSParameters)
		lss18 = self.addLink('s9','s10',**linkSSParameters)
		lss19 = self.addLink('s13','s16',**linkSSParameters)
		lss20 = self.addLink('s14','s29',**linkSSParameters)
		lss21 = self.addLink('s16','s21',**linkSSParameters)
		lss22 = self.addLink('s21','s34',**linkSSParameters)
		lss23 = self.addLink('s21','s39',**linkSSParameters)
		lss24 = self.addLink('s21','s42',**linkSSParameters)
		lss25 = self.addLink('s21','s43',**linkSSParameters)
		lss26 = self.addLink('s21','s45',**linkSSParameters)
		lss27 = self.addLink('s21','s50',**linkSSParameters)
		lss28 = self.addLink('s21','s22',**linkSSParameters)
		lss29 = self.addLink('s21','s24',**linkSSParameters)
		lss30 = self.addLink('s21','s38',**linkSSParameters)
		lss31 = self.addLink('s21','s37',**linkSSParameters)
		lss32 = self.addLink('s23','s24',**linkSSParameters)
		lss33 = self.addLink('s25','s29',**linkSSParameters)
		lss34 = self.addLink('s26','s29',**linkSSParameters)
		lss35 = self.addLink('s27','s29',**linkSSParameters)
		lss36 = self.addLink('s28','s29',**linkSSParameters)
		lss37 = self.addLink('s29','s35',**linkSSParameters)
		lss38 = self.addLink('s29','s48',**linkSSParameters)
		lss39 = self.addLink('s30','s32',**linkSSParameters)
		lss40 = self.addLink('s31','s32',**linkSSParameters)
		lss41 = self.addLink('s32','s50',**linkSSParameters)
		lss42 = self.addLink('s32','s33',**linkSSParameters)
		lss43 = self.addLink('s36','s37',**linkSSParameters)
		lss44 = self.addLink('s37','s49',**linkSSParameters)
		lss45 = self.addLink('s40','s42',**linkSSParameters)
		lss46 = self.addLink('s41','s42',**linkSSParameters)
		lss47 = self.addLink('s44','s45',**linkSSParameters)
		lss48 = self.addLink('s45','s47',**linkSSParameters)
