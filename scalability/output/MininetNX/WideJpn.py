...
class MininetNX( Topo ):
	def build( self ):
		...
		lss3 = self.addLink('s1','s29',**linkSSParameters)
		lss4 = self.addLink('s2','s29',**linkSSParameters)
		lss5 = self.addLink('s3','s29',**linkSSParameters)
		lss6 = self.addLink('s5','s14',**linkSSParameters)
		lss7 = self.addLink('s6','s13',**linkSSParameters)
		lss8 = self.addLink('s7','s8',**linkSSParameters)
		lss9 = self.addLink('s7','s28',**linkSSParameters)
		lss10 = self.addLink('s8','s12',**linkSSParameters)
		lss11 = self.addLink('s8','s27',**linkSSParameters)
		lss12 = self.addLink('s9','s10',**linkSSParameters)
		lss13 = self.addLink('s9','s20',**linkSSParameters)
		lss14 = self.addLink('s10','s11',**linkSSParameters)
		lss15 = self.addLink('s10','s13',**linkSSParameters)
		lss16 = self.addLink('s12','s14',**linkSSParameters)
		lss17 = self.addLink('s12','s16',**linkSSParameters)
		lss18 = self.addLink('s12','s23',**linkSSParameters)
		lss19 = self.addLink('s12','s24',**linkSSParameters)
		lss20 = self.addLink('s12','s25',**linkSSParameters)
		lss21 = self.addLink('s12','s26',**linkSSParameters)
		lss22 = self.addLink('s14','s29',**linkSSParameters)
		lss23 = self.addLink('s14','s15',**linkSSParameters)
		lss24 = self.addLink('s14','s17',**linkSSParameters)
		lss25 = self.addLink('s14','s21',**linkSSParameters)
		lss26 = self.addLink('s14','s22',**linkSSParameters)
		lss27 = self.addLink('s18','s29',**linkSSParameters)
		lss28 = self.addLink('s19','s29',**linkSSParameters)
