...
class MininetNX( Topo ):
	def build( self ):
		...
		lhs58 = self.addLink('s30','h58',**linkHSParameters)
		lhs59 = self.addLink('s30','h59',**linkHSParameters)
		#Add a link of switches of original topology
		lss0 = self.addLink('s0','s3',**linkSSParameters)
		lss1 = self.addLink('s0','s5',**linkSSParameters)
		lss2 = self.addLink('s0','s9',**linkSSParameters)
		lss3 = self.addLink('s0','s11',**linkSSParameters)
		lss4 = self.addLink('s0','s14',**linkSSParameters)
		lss5 = self.addLink('s0','s15',**linkSSParameters)
		lss6 = self.addLink('s0','s19',**linkSSParameters)
		lss7 = self.addLink('s0','s21',**linkSSParameters)
		lss8 = self.addLink('s1','s5',**linkSSParameters)
		lss9 = self.addLink('s2','s3',**linkSSParameters)
		lss10 = self.addLink('s3','s4',**linkSSParameters)
		lss11 = self.addLink('s3','s18',**linkSSParameters)
		lss12 = self.addLink('s5','s30',**linkSSParameters)
		lss13 = self.addLink('s5','s6',**linkSSParameters)
		lss14 = self.addLink('s5','s7',**linkSSParameters)
		lss15 = self.addLink('s6','s29',**linkSSParameters)
		lss16 = self.addLink('s7','s8',**linkSSParameters)
		lss17 = self.addLink('s7','s9',**linkSSParameters)
		lss18 = self.addLink('s7','s27',**linkSSParameters)
		lss19 = self.addLink('s8','s9',**linkSSParameters)
		lss20 = self.addLink('s8','s28',**linkSSParameters)
		lss21 = self.addLink('s9','s10',**linkSSParameters)
		lss22 = self.addLink('s9','s12',**linkSSParameters)
		lss23 = self.addLink('s9','s17',**linkSSParameters)
		lss24 = self.addLink('s9','s24',**linkSSParameters)
		lss25 = self.addLink('s9','s25',**linkSSParameters)
		lss26 = self.addLink('s10','s26',**linkSSParameters)
		lss27 = self.addLink('s11','s16',**linkSSParameters)
		lss28 = self.addLink('s11','s12',**linkSSParameters)
		lss29 = self.addLink('s11','s13',**linkSSParameters)
		lss30 = self.addLink('s11','s22',**linkSSParameters)
		lss31 = self.addLink('s12','s23',**linkSSParameters)
		
topos = { 'Ernet': ( lambda: MininetNX() ) }