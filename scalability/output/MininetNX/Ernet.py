...
class MininetNX( Topo ):
	def build( self ):
		...
		lhs58 = self.addLink('s30','h58')
		lhs59 = self.addLink('s30','h59')
		#Add a link of switches of original topology
		lss0 = self.addLink('s0','s3')
		lss1 = self.addLink('s0','s5')
		lss2 = self.addLink('s0','s9')
		lss3 = self.addLink('s0','s11')
		lss4 = self.addLink('s0','s14')
		lss5 = self.addLink('s0','s15')
		lss6 = self.addLink('s0','s19')
		lss7 = self.addLink('s0','s21')
		lss8 = self.addLink('s1','s5')
		lss9 = self.addLink('s2','s3')
		lss10 = self.addLink('s3','s4')
		lss11 = self.addLink('s3','s18')
		lss12 = self.addLink('s5','s30')
		lss13 = self.addLink('s5','s6')
		lss14 = self.addLink('s5','s7')
		lss15 = self.addLink('s6','s29')
		lss16 = self.addLink('s7','s8')
		lss17 = self.addLink('s7','s9')
		lss18 = self.addLink('s7','s27')
		lss19 = self.addLink('s8','s9')
		lss20 = self.addLink('s8','s28')
		lss21 = self.addLink('s9','s10')
		lss22 = self.addLink('s9','s12')
		lss23 = self.addLink('s9','s17')
		lss24 = self.addLink('s9','s24')
		lss25 = self.addLink('s9','s25')
		lss26 = self.addLink('s10','s26')
		lss27 = self.addLink('s11','s16')
		lss28 = self.addLink('s11','s12')
		lss29 = self.addLink('s11','s13')
		lss30 = self.addLink('s11','s22')
		lss31 = self.addLink('s12','s23')
