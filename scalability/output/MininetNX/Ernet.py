...
class MininetNX( Topo ):
	def build( self ):
		...
		lhs29 = self.addLink('s30','h29',**linkHSParameters)
		...
		lss16 = self.addLink('s7','s27',**linkSSParameters)
		lss17 = self.addLink('s8','s9',**linkSSParameters)
		lss18 = self.addLink('s8','s28',**linkSSParameters)
		lss19 = self.addLink('s9','s10',**linkSSParameters)
		lss20 = self.addLink('s9','s12',**linkSSParameters)
		lss21 = self.addLink('s9','s17',**linkSSParameters)
		lss22 = self.addLink('s9','s24',**linkSSParameters)
		lss23 = self.addLink('s9','s25',**linkSSParameters)
		lss24 = self.addLink('s10','s26',**linkSSParameters)
		lss25 = self.addLink('s11','s16',**linkSSParameters)
		lss26 = self.addLink('s11','s13',**linkSSParameters)
		lss27 = self.addLink('s11','s22',**linkSSParameters)
		lss28 = self.addLink('s12','s23',**linkSSParameters)
