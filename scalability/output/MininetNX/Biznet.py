...
class MininetNX( Topo ):
	def build( self ):
		...
		lss4 = self.addLink('s2','s10',**linkSSParameters)
		...
		lss9 = self.addLink('s5','s9',**linkSSParameters)
		...
		lss18 = self.addLink('s15','s19',**linkSSParameters)
		lss19 = self.addLink('s16','s17',**linkSSParameters)
		lss20 = self.addLink('s17','s18',**linkSSParameters)
		lss21 = self.addLink('s17','s19',**linkSSParameters)
		lss22 = self.addLink('s18','s20',**linkSSParameters)
		lss23 = self.addLink('s19','s21',**linkSSParameters)
		lss24 = self.addLink('s20','s23',**linkSSParameters)
		lss25 = self.addLink('s21','s22',**linkSSParameters)
		lss26 = self.addLink('s22','s24',**linkSSParameters)
		lss27 = self.addLink('s22','s23',**linkSSParameters)
		lss28 = self.addLink('s23','s25',**linkSSParameters)
