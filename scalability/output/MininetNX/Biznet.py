...
class MininetNX( Topo ):
	def build( self ):
		...
		lss8 = self.addLink('s5','s10',**linkSSParameters)
		...
		lss13 = self.addLink('s12','s13',**linkSSParameters)
		lss14 = self.addLink('s14','s15',**linkSSParameters)
		lss15 = self.addLink('s15','s19',**linkSSParameters)
		lss16 = self.addLink('s16','s17',**linkSSParameters)
		lss17 = self.addLink('s17','s18',**linkSSParameters)
		lss18 = self.addLink('s17','s19',**linkSSParameters)
		lss19 = self.addLink('s18','s20',**linkSSParameters)
		lss20 = self.addLink('s19','s21',**linkSSParameters)
		lss21 = self.addLink('s20','s23',**linkSSParameters)
		lss22 = self.addLink('s21','s22',**linkSSParameters)
		lss23 = self.addLink('s22','s24',**linkSSParameters)
		lss24 = self.addLink('s23','s25',**linkSSParameters)
		lss25 = self.addLink('s25','s26',**linkSSParameters)
		lss26 = self.addLink('s26','s27',**linkSSParameters)
		lss27 = self.addLink('s27','s28',**linkSSParameters)
