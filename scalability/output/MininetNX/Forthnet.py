...
class MininetNX( Topo ):
	def build( self ):
		...
		lhs122 = self.addLink('s63','h122',**linkHSParameters)
		lhs123 = self.addLink('s63','h123',**linkHSParameters)
		...
		lss5 = self.addLink('s1','s6',**linkSSParameters)
		lss6 = self.addLink('s1','s7',**linkSSParameters)
		lss7 = self.addLink('s1','s8',**linkSSParameters)
		lss8 = self.addLink('s1','s11',**linkSSParameters)
		lss9 = self.addLink('s1','s12',**linkSSParameters)
		lss10 = self.addLink('s1','s13',**linkSSParameters)
		lss11 = self.addLink('s1','s15',**linkSSParameters)
		lss12 = self.addLink('s1','s63',**linkSSParameters)
		lss13 = self.addLink('s9','s11',**linkSSParameters)
		lss14 = self.addLink('s10','s11',**linkSSParameters)
		lss15 = self.addLink('s14','s15',**linkSSParameters)
		lss16 = self.addLink('s15','s35',**linkSSParameters)
		lss17 = self.addLink('s15','s36',**linkSSParameters)
		lss18 = self.addLink('s15','s37',**linkSSParameters)
		lss19 = self.addLink('s15','s38',**linkSSParameters)
		lss20 = self.addLink('s15','s39',**linkSSParameters)
		lss21 = self.addLink('s15','s40',**linkSSParameters)
		lss22 = self.addLink('s15','s60',**linkSSParameters)
		lss23 = self.addLink('s15','s63',**linkSSParameters)
		lss24 = self.addLink('s15','s16',**linkSSParameters)
		lss25 = self.addLink('s15','s17',**linkSSParameters)
		lss26 = self.addLink('s15','s18',**linkSSParameters)
		lss27 = self.addLink('s15','s19',**linkSSParameters)
		lss28 = self.addLink('s15','s20',**linkSSParameters)
		lss29 = self.addLink('s15','s46',**linkSSParameters)
		lss30 = self.addLink('s15','s22',**linkSSParameters)
		lss31 = self.addLink('s15','s24',**linkSSParameters)
		lss32 = self.addLink('s15','s59',**linkSSParameters)
		lss33 = self.addLink('s15','s28',**linkSSParameters)
		lss34 = self.addLink('s15','s21',**linkSSParameters)
		lss35 = self.addLink('s23','s24',**linkSSParameters)
		lss36 = self.addLink('s24','s25',**linkSSParameters)
		lss37 = self.addLink('s24','s26',**linkSSParameters)
		lss38 = self.addLink('s27','s28',**linkSSParameters)
		lss39 = self.addLink('s28','s31',**linkSSParameters)
		lss40 = self.addLink('s28','s29',**linkSSParameters)
		lss41 = self.addLink('s28','s30',**linkSSParameters)
		lss42 = self.addLink('s29','s32',**linkSSParameters)
		lss43 = self.addLink('s32','s33',**linkSSParameters)
		lss44 = self.addLink('s32','s34',**linkSSParameters)
		lss45 = self.addLink('s40','s41',**linkSSParameters)
		lss46 = self.addLink('s42','s59',**linkSSParameters)
		lss47 = self.addLink('s43','s59',**linkSSParameters)
		lss48 = self.addLink('s44','s59',**linkSSParameters)
		lss49 = self.addLink('s45','s59',**linkSSParameters)
		lss50 = self.addLink('s46','s47',**linkSSParameters)
		lss51 = self.addLink('s46','s48',**linkSSParameters)
		lss52 = self.addLink('s46','s49',**linkSSParameters)
		lss53 = self.addLink('s46','s50',**linkSSParameters)
		lss54 = self.addLink('s46','s51',**linkSSParameters)
		lss55 = self.addLink('s46','s58',**linkSSParameters)
		lss56 = self.addLink('s52','s60',**linkSSParameters)
		lss57 = self.addLink('s53','s60',**linkSSParameters)
		lss58 = self.addLink('s54','s60',**linkSSParameters)
		lss59 = self.addLink('s55','s60',**linkSSParameters)
		lss60 = self.addLink('s56','s60',**linkSSParameters)
		lss61 = self.addLink('s57','s60',**linkSSParameters)
		
topos = { 'Forthnet': ( lambda: MininetNX() ) }