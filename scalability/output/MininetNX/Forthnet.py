...
class MininetNX( Topo ):
	def build( self ):
		...
		lhs61 = self.addLink('s63','h61',**linkHSParameters)
		...
		lss23 = self.addLink('s15','s16',**linkSSParameters)
		lss24 = self.addLink('s15','s17',**linkSSParameters)
		lss25 = self.addLink('s15','s18',**linkSSParameters)
		lss26 = self.addLink('s15','s19',**linkSSParameters)
		lss27 = self.addLink('s15','s20',**linkSSParameters)
		lss28 = self.addLink('s15','s46',**linkSSParameters)
		lss29 = self.addLink('s15','s22',**linkSSParameters)
		lss30 = self.addLink('s15','s24',**linkSSParameters)
		lss31 = self.addLink('s15','s59',**linkSSParameters)
		lss32 = self.addLink('s15','s28',**linkSSParameters)
		lss33 = self.addLink('s15','s21',**linkSSParameters)
		lss34 = self.addLink('s23','s24',**linkSSParameters)
		lss35 = self.addLink('s24','s25',**linkSSParameters)
		lss36 = self.addLink('s24','s26',**linkSSParameters)
		lss37 = self.addLink('s27','s28',**linkSSParameters)
		lss38 = self.addLink('s28','s31',**linkSSParameters)
		lss39 = self.addLink('s28','s29',**linkSSParameters)
		lss40 = self.addLink('s28','s30',**linkSSParameters)
		lss41 = self.addLink('s29','s32',**linkSSParameters)
		lss42 = self.addLink('s32','s33',**linkSSParameters)
		lss43 = self.addLink('s32','s34',**linkSSParameters)
		lss44 = self.addLink('s40','s41',**linkSSParameters)
		lss45 = self.addLink('s42','s59',**linkSSParameters)
		lss46 = self.addLink('s43','s59',**linkSSParameters)
		lss47 = self.addLink('s44','s59',**linkSSParameters)
		lss48 = self.addLink('s45','s59',**linkSSParameters)
		lss49 = self.addLink('s46','s47',**linkSSParameters)
		lss50 = self.addLink('s46','s48',**linkSSParameters)
		lss51 = self.addLink('s46','s49',**linkSSParameters)
		lss52 = self.addLink('s46','s50',**linkSSParameters)
		lss53 = self.addLink('s46','s51',**linkSSParameters)
		lss54 = self.addLink('s46','s58',**linkSSParameters)
		lss55 = self.addLink('s52','s60',**linkSSParameters)
		lss56 = self.addLink('s53','s60',**linkSSParameters)
		lss57 = self.addLink('s54','s60',**linkSSParameters)
		lss58 = self.addLink('s55','s60',**linkSSParameters)
		lss59 = self.addLink('s56','s60',**linkSSParameters)
		lss60 = self.addLink('s57','s60',**linkSSParameters)
