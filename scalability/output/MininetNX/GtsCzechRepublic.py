...
class MininetNX( Topo ):
	def build( self ):
		...
		lss1 = self.addLink('s1','s24')
		lss2 = self.addLink('s1','s2')
		lss3 = self.addLink('s1','s23')
		lss4 = self.addLink('s2','s31')
		lss5 = self.addLink('s3','s4')
		lss6 = self.addLink('s3','s29')
		lss7 = self.addLink('s4','s31')
		lss8 = self.addLink('s5','s6')
		lss9 = self.addLink('s6','s7')
		lss10 = self.addLink('s6','s8')
		lss11 = self.addLink('s6','s14')
		lss12 = self.addLink('s6','s26')
		lss13 = self.addLink('s6','s28')
		lss14 = self.addLink('s6','s31')
		lss15 = self.addLink('s8','s11')
		lss16 = self.addLink('s9','s10')
		lss17 = self.addLink('s9','s11')
		lss18 = self.addLink('s10','s29')
