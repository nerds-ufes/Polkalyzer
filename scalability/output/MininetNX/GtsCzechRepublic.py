...
class MininetNX( Topo ):
	def build( self ):
		...
		lss1 = self.addLink('s1','s23',**linkSSParameters)
		...
		lss9 = self.addLink('s6','s31',**linkSSParameters)
		lss10 = self.addLink('s6','s7',**linkSSParameters)
		lss11 = self.addLink('s6','s8',**linkSSParameters)
		lss12 = self.addLink('s6','s14',**linkSSParameters)
		lss13 = self.addLink('s6','s26',**linkSSParameters)
		lss14 = self.addLink('s6','s28',**linkSSParameters)
		...
		lss23 = self.addLink('s18','s19',**linkSSParameters)
		lss24 = self.addLink('s19','s20',**linkSSParameters)
		lss25 = self.addLink('s19','s27',**linkSSParameters)
		lss26 = self.addLink('s20','s21',**linkSSParameters)
		lss27 = self.addLink('s21','s22',**linkSSParameters)
		lss28 = self.addLink('s22','s23',**linkSSParameters)
		lss29 = self.addLink('s23','s25',**linkSSParameters)
		lss30 = self.addLink('s30','s31',**linkSSParameters)
