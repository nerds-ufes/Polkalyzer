...
class MininetNX( Topo ):
	def build( self ):
		...
		lss1 = self.addLink('s1','s24',**linkSSParameters)
		lss2 = self.addLink('s1','s2',**linkSSParameters)
		lss3 = self.addLink('s1','s23',**linkSSParameters)
		lss4 = self.addLink('s2','s31',**linkSSParameters)
		lss5 = self.addLink('s3','s4',**linkSSParameters)
		lss6 = self.addLink('s3','s29',**linkSSParameters)
		lss7 = self.addLink('s4','s31',**linkSSParameters)
		...
		lss11 = self.addLink('s6','s14',**linkSSParameters)
		lss12 = self.addLink('s6','s26',**linkSSParameters)
		lss13 = self.addLink('s6','s28',**linkSSParameters)
		lss14 = self.addLink('s6','s31',**linkSSParameters)
		lss15 = self.addLink('s8','s11',**linkSSParameters)
		lss16 = self.addLink('s9','s10',**linkSSParameters)
		lss17 = self.addLink('s9','s11',**linkSSParameters)
		lss18 = self.addLink('s10','s29',**linkSSParameters)
		lss19 = self.addLink('s11','s12',**linkSSParameters)
		lss20 = self.addLink('s13','s14',**linkSSParameters)
		lss21 = self.addLink('s14','s16',**linkSSParameters)
		...
		lss26 = self.addLink('s19','s27',**linkSSParameters)
...
topos = { 'GtsCzechRepublic': ( lambda: MininetNX() ) }