...
class MininetNX( Topo ):
	def build( self ):
		...
		lss2 = self.addLink('s0','s27',**linkSSParameters)
		lss3 = self.addLink('s0','s26',**linkSSParameters)
		lss4 = self.addLink('s1','s26',**linkSSParameters)
		lss5 = self.addLink('s1','s15',**linkSSParameters)
		lss6 = self.addLink('s2','s25',**linkSSParameters)
		lss7 = self.addLink('s2','s4',**linkSSParameters)
		lss8 = self.addLink('s3','s25',**linkSSParameters)
		lss9 = self.addLink('s3','s18',**linkSSParameters)
		lss10 = self.addLink('s3','s4',**linkSSParameters)
		lss11 = self.addLink('s4','s27',**linkSSParameters)
		lss12 = self.addLink('s4','s18',**linkSSParameters)
		lss13 = self.addLink('s5','s11',**linkSSParameters)
		...
		lss18 = self.addLink('s9','s26',**linkSSParameters)
		lss19 = self.addLink('s10','s26',**linkSSParameters)
		lss20 = self.addLink('s10','s11',**linkSSParameters)
		lss21 = self.addLink('s10','s14',**linkSSParameters)
		lss22 = self.addLink('s11','s13',**linkSSParameters)
		lss23 = self.addLink('s12','s13',**linkSSParameters)
		lss24 = self.addLink('s12','s14',**linkSSParameters)
		lss25 = self.addLink('s13','s14',**linkSSParameters)
		lss26 = self.addLink('s15','s25',**linkSSParameters)
		lss27 = self.addLink('s16','s27',**linkSSParameters)
		lss28 = self.addLink('s17','s27',**linkSSParameters)
		lss29 = self.addLink('s18','s19',**linkSSParameters)
		lss30 = self.addLink('s19','s20',**linkSSParameters)
		lss31 = self.addLink('s20','s21',**linkSSParameters)
		lss32 = self.addLink('s21','s22',**linkSSParameters)
		lss33 = self.addLink('s22','s23',**linkSSParameters)
		lss34 = self.addLink('s23','s24',**linkSSParameters)
		
topos = { 'Shentel': ( lambda: MininetNX() ) }