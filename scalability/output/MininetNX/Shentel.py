...
class MininetNX( Topo ):
	def build( self ):
		...
		lss7 = self.addLink('s3','s25',**linkSSParameters)
		lss8 = self.addLink('s4','s18',**linkSSParameters)
		...
		lss13 = self.addLink('s9','s26',**linkSSParameters)
		lss14 = self.addLink('s10','s11',**linkSSParameters)
		lss15 = self.addLink('s10','s14',**linkSSParameters)
		lss16 = self.addLink('s11','s13',**linkSSParameters)
		lss17 = self.addLink('s12','s14',**linkSSParameters)
		lss18 = self.addLink('s15','s25',**linkSSParameters)
		lss19 = self.addLink('s16','s27',**linkSSParameters)
		lss20 = self.addLink('s17','s27',**linkSSParameters)
		lss21 = self.addLink('s18','s19',**linkSSParameters)
		lss22 = self.addLink('s19','s20',**linkSSParameters)
