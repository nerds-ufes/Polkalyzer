...
class MininetNX( Topo ):
	def build( self ):
		...
		lss2 = self.addLink('s0','s27')
		lss3 = self.addLink('s0','s26')
		lss4 = self.addLink('s1','s26')
		lss5 = self.addLink('s1','s15')
		lss6 = self.addLink('s2','s25')
		lss7 = self.addLink('s2','s4')
		lss8 = self.addLink('s3','s25')
		lss9 = self.addLink('s3','s18')
		lss10 = self.addLink('s3','s4')
		lss11 = self.addLink('s4','s27')
		lss12 = self.addLink('s4','s18')
		lss13 = self.addLink('s5','s11')
		lss14 = self.addLink('s5','s6')
		lss15 = self.addLink('s6','s7')
		lss16 = self.addLink('s7','s8')
		lss17 = self.addLink('s8','s9')
		lss18 = self.addLink('s9','s26')
		lss19 = self.addLink('s10','s26')
		lss20 = self.addLink('s10','s11')
		lss21 = self.addLink('s10','s14')
		lss22 = self.addLink('s11','s13')
		lss23 = self.addLink('s12','s13')
		lss24 = self.addLink('s12','s14')
		lss25 = self.addLink('s13','s14')
		lss26 = self.addLink('s15','s25')
		lss27 = self.addLink('s16','s27')
		lss28 = self.addLink('s17','s27')
		lss29 = self.addLink('s18','s19')
		lss30 = self.addLink('s19','s20')
		lss31 = self.addLink('s20','s21')
		lss32 = self.addLink('s21','s22')
		lss33 = self.addLink('s22','s23')
		lss34 = self.addLink('s23','s24')
