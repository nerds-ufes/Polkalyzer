...
class MininetNX( Topo ):
	def build( self ):
		...
		lss4 = self.addLink('s2','s27',**linkSSParameters)
		lss5 = self.addLink('s3','s4',**linkSSParameters)
		lss6 = self.addLink('s4','s28',**linkSSParameters)
		lss7 = self.addLink('s4','s5',**linkSSParameters)
		lss8 = self.addLink('s5','s25',**linkSSParameters)
		lss9 = self.addLink('s5','s6',**linkSSParameters)
		lss10 = self.addLink('s7','s8',**linkSSParameters)
		lss11 = self.addLink('s7','s10',**linkSSParameters)
		...
		lss15 = self.addLink('s11','s12',**linkSSParameters)
		lss16 = self.addLink('s12','s13',**linkSSParameters)
		lss17 = self.addLink('s12','s19',**linkSSParameters)
		lss18 = self.addLink('s12','s20',**linkSSParameters)
		lss19 = self.addLink('s12','s21',**linkSSParameters)
		lss20 = self.addLink('s12','s23',**linkSSParameters)
		lss21 = self.addLink('s13','s14',**linkSSParameters)
		lss22 = self.addLink('s14','s17',**linkSSParameters)
		lss23 = self.addLink('s14','s15',**linkSSParameters)
		lss24 = self.addLink('s14','s31',**linkSSParameters)
		...
		lss28 = self.addLink('s19','s34',**linkSSParameters)
		lss29 = self.addLink('s20','s33',**linkSSParameters)
		lss30 = self.addLink('s21','s22',**linkSSParameters)
		lss31 = self.addLink('s22','s30',**linkSSParameters)
		lss32 = self.addLink('s23','s28',**linkSSParameters)
		lss33 = self.addLink('s23','s29',**linkSSParameters)
		lss34 = self.addLink('s23','s30',**linkSSParameters)
		lss35 = self.addLink('s24','s25',**linkSSParameters)
		lss36 = self.addLink('s25','s26',**linkSSParameters)
		lss37 = self.addLink('s26','s28',**linkSSParameters)
		lss38 = self.addLink('s27','s47',**linkSSParameters)
		lss39 = self.addLink('s28','s47',**linkSSParameters)
		lss40 = self.addLink('s29','s41',**linkSSParameters)
		lss41 = self.addLink('s30','s33',**linkSSParameters)
		lss42 = self.addLink('s30','s42',**linkSSParameters)
		lss43 = self.addLink('s31','s32',**linkSSParameters)
		lss44 = self.addLink('s31','s41',**linkSSParameters)
		lss45 = self.addLink('s31','s35',**linkSSParameters)
		lss46 = self.addLink('s32','s33',**linkSSParameters)
		lss47 = self.addLink('s33','s34',**linkSSParameters)
		lss48 = self.addLink('s35','s36',**linkSSParameters)
		lss49 = self.addLink('s36','s37',**linkSSParameters)
		lss50 = self.addLink('s37','s38',**linkSSParameters)
		lss51 = self.addLink('s38','s39',**linkSSParameters)
		lss52 = self.addLink('s39','s40',**linkSSParameters)
		lss53 = self.addLink('s40','s41',**linkSSParameters)
		lss54 = self.addLink('s41','s42',**linkSSParameters)
		lss55 = self.addLink('s41','s44',**linkSSParameters)
		lss56 = self.addLink('s42','s43',**linkSSParameters)
		lss57 = self.addLink('s43','s44',**linkSSParameters)
		lss58 = self.addLink('s44','s45',**linkSSParameters)
		lss59 = self.addLink('s45','s46',**linkSSParameters)
		lss60 = self.addLink('s46','s47',**linkSSParameters)
		lss61 = self.addLink('s47','s50',**linkSSParameters)
		lss62 = self.addLink('s48','s49',**linkSSParameters)
		lss63 = self.addLink('s48','s50',**linkSSParameters)
		
topos = { 'Iris': ( lambda: MininetNX() ) }