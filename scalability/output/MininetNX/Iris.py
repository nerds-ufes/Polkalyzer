...
class MininetNX( Topo ):
	def build( self ):
		...
		lss1 = self.addLink('s0','s6')
		lss2 = self.addLink('s1','s2')
		lss3 = self.addLink('s2','s3')
		lss4 = self.addLink('s2','s27')
		lss5 = self.addLink('s3','s4')
		lss6 = self.addLink('s4','s28')
		lss7 = self.addLink('s4','s5')
		lss8 = self.addLink('s5','s25')
		lss9 = self.addLink('s5','s6')
		lss10 = self.addLink('s7','s8')
		lss11 = self.addLink('s7','s10')
		lss12 = self.addLink('s8','s10')
		lss13 = self.addLink('s9','s10')
		lss14 = self.addLink('s10','s11')
		lss15 = self.addLink('s11','s12')
		lss16 = self.addLink('s12','s13')
		lss17 = self.addLink('s12','s19')
		lss18 = self.addLink('s12','s20')
		lss19 = self.addLink('s12','s21')
		lss20 = self.addLink('s12','s23')
		lss21 = self.addLink('s13','s14')
		lss22 = self.addLink('s14','s17')
		lss23 = self.addLink('s14','s15')
		lss24 = self.addLink('s14','s31')
		lss25 = self.addLink('s15','s16')
		lss26 = self.addLink('s16','s17')
		lss27 = self.addLink('s17','s18')
		lss28 = self.addLink('s19','s34')
		lss29 = self.addLink('s20','s33')
		lss30 = self.addLink('s21','s22')
		lss31 = self.addLink('s22','s30')
		lss32 = self.addLink('s23','s28')
		lss33 = self.addLink('s23','s29')
		lss34 = self.addLink('s23','s30')
		lss35 = self.addLink('s24','s25')
		lss36 = self.addLink('s25','s26')
		lss37 = self.addLink('s26','s28')
		lss38 = self.addLink('s27','s47')
		lss39 = self.addLink('s28','s47')
		lss40 = self.addLink('s29','s41')
		lss41 = self.addLink('s30','s33')
		lss42 = self.addLink('s30','s42')
		lss43 = self.addLink('s31','s32')
		lss44 = self.addLink('s31','s41')
		lss45 = self.addLink('s31','s35')
		lss46 = self.addLink('s32','s33')
		lss47 = self.addLink('s33','s34')
		lss48 = self.addLink('s35','s36')
		lss49 = self.addLink('s36','s37')
		lss50 = self.addLink('s37','s38')
		lss51 = self.addLink('s38','s39')
		lss52 = self.addLink('s39','s40')
		lss53 = self.addLink('s40','s41')
		lss54 = self.addLink('s41','s42')
		lss55 = self.addLink('s41','s44')
		lss56 = self.addLink('s42','s43')
		lss57 = self.addLink('s43','s44')
		lss58 = self.addLink('s44','s45')
		lss59 = self.addLink('s45','s46')
		lss60 = self.addLink('s46','s47')
		lss61 = self.addLink('s47','s50')
		lss62 = self.addLink('s48','s49')
		lss63 = self.addLink('s48','s50')
