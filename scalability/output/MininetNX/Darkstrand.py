...
class MininetNX( Topo ):
	def build( self ):
		...
		lss6 = self.addLink('s5','s27')
		lss7 = self.addLink('s5','s13')
		lss8 = self.addLink('s6','s9')
		lss9 = self.addLink('s6','s27')
		lss10 = self.addLink('s7','s8')
		lss11 = self.addLink('s7','s9')
		lss12 = self.addLink('s9','s10')
		lss13 = self.addLink('s10','s14')
		lss14 = self.addLink('s11','s12')
		lss15 = self.addLink('s11','s14')
		lss16 = self.addLink('s12','s13')
		lss17 = self.addLink('s13','s20')
		lss18 = self.addLink('s14','s15')
		lss19 = self.addLink('s15','s16')
		lss20 = self.addLink('s16','s17')
		lss21 = self.addLink('s17','s18')
		lss22 = self.addLink('s18','s19')
		lss23 = self.addLink('s19','s25')
		lss24 = self.addLink('s20','s21')
		lss25 = self.addLink('s21','s26')
		lss26 = self.addLink('s21','s22')
		lss27 = self.addLink('s22','s23')
		lss28 = self.addLink('s23','s24')
		lss29 = self.addLink('s24','s25')
