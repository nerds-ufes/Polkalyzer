...
class MininetNX( Topo ):
	def build( self ):
		...
		lss9 = self.addLink('s6','s27',**linkSSParameters)
		...
		lss13 = self.addLink('s10','s14',**linkSSParameters)
		lss14 = self.addLink('s11','s12',**linkSSParameters)
		lss15 = self.addLink('s11','s14',**linkSSParameters)
		lss16 = self.addLink('s12','s13',**linkSSParameters)
		lss17 = self.addLink('s13','s20',**linkSSParameters)
		...
		lss23 = self.addLink('s19','s25',**linkSSParameters)
		lss24 = self.addLink('s20','s21',**linkSSParameters)
		lss25 = self.addLink('s21','s26',**linkSSParameters)
...
topos = { 'Darkstrand': ( lambda: MininetNX() ) }