...
class MininetNX( Topo ):
	def build( self ):
		...
		lss8 = self.addLink('s6','s27',**linkSSParameters)
		lss9 = self.addLink('s7','s8',**linkSSParameters)
		lss10 = self.addLink('s7','s9',**linkSSParameters)
		lss11 = self.addLink('s9','s10',**linkSSParameters)
		lss12 = self.addLink('s10','s14',**linkSSParameters)
		lss13 = self.addLink('s11','s12',**linkSSParameters)
		lss14 = self.addLink('s12','s13',**linkSSParameters)
		lss15 = self.addLink('s13','s20',**linkSSParameters)
		...
		lss20 = self.addLink('s19','s25',**linkSSParameters)
		lss21 = self.addLink('s20','s21',**linkSSParameters)
		lss22 = self.addLink('s21','s26',**linkSSParameters)
		lss23 = self.addLink('s21','s22',**linkSSParameters)
		lss24 = self.addLink('s22','s23',**linkSSParameters)
