...
class MininetNX( Topo ):
	def build( self ):
		...
		lss8 = self.addLink('s4','s20',**linkSSParameters)
		lss9 = self.addLink('s4','s5',**linkSSParameters)
		lss10 = self.addLink('s4','s14',**linkSSParameters)
		lss11 = self.addLink('s5','s6',**linkSSParameters)
		lss12 = self.addLink('s6','s18',**linkSSParameters)
		lss13 = self.addLink('s6','s7',**linkSSParameters)
		lss14 = self.addLink('s6','s22',**linkSSParameters)
		lss15 = self.addLink('s6','s23',**linkSSParameters)
		lss16 = self.addLink('s7','s8',**linkSSParameters)
		lss17 = self.addLink('s7','s11',**linkSSParameters)
		lss18 = self.addLink('s7','s22',**linkSSParameters)
		lss19 = self.addLink('s9','s10',**linkSSParameters)
		lss20 = self.addLink('s9','s11',**linkSSParameters)
		lss21 = self.addLink('s10','s11',**linkSSParameters)
		lss22 = self.addLink('s11','s25',**linkSSParameters)
		lss23 = self.addLink('s11','s12',**linkSSParameters)
		lss24 = self.addLink('s12','s24',**linkSSParameters)
		lss25 = self.addLink('s13','s15',**linkSSParameters)
		lss26 = self.addLink('s14','s16',**linkSSParameters)
		...
		lss31 = self.addLink('s18','s26',**linkSSParameters)
		lss32 = self.addLink('s18','s19',**linkSSParameters)
		lss33 = self.addLink('s18','s20',**linkSSParameters)
		lss34 = self.addLink('s21','s23',**linkSSParameters)
