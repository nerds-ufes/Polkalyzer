...
class MininetNX( Topo ):
	def build( self ):
		...
		lss3 = self.addLink('s1','s12')
		lss4 = self.addLink('s1','s13')
		lss5 = self.addLink('s2','s3')
		lss6 = self.addLink('s2','s4')
		lss7 = self.addLink('s3','s4')
		lss8 = self.addLink('s4','s20')
		lss9 = self.addLink('s4','s5')
		lss10 = self.addLink('s4','s14')
		lss11 = self.addLink('s5','s6')
		lss12 = self.addLink('s6','s18')
		lss13 = self.addLink('s6','s7')
		lss14 = self.addLink('s6','s22')
		lss15 = self.addLink('s6','s23')
		lss16 = self.addLink('s7','s8')
		lss17 = self.addLink('s7','s11')
		lss18 = self.addLink('s7','s22')
		lss19 = self.addLink('s9','s10')
		lss20 = self.addLink('s9','s11')
		lss21 = self.addLink('s10','s11')
		lss22 = self.addLink('s11','s25')
		lss23 = self.addLink('s11','s12')
		lss24 = self.addLink('s12','s24')
		lss25 = self.addLink('s13','s15')
		lss26 = self.addLink('s14','s16')
		lss27 = self.addLink('s14','s15')
		lss28 = self.addLink('s15','s16')
		lss29 = self.addLink('s16','s17')
		lss30 = self.addLink('s17','s18')
		lss31 = self.addLink('s18','s26')
		lss32 = self.addLink('s18','s19')
		lss33 = self.addLink('s18','s20')
		lss34 = self.addLink('s21','s23')
