...
class MininetNX( Topo ):
	def build( self ):
		...
		lss12 = self.addLink('s7','s19',**linkSSParameters)
		lss13 = self.addLink('s8','s9',**linkSSParameters)
		lss14 = self.addLink('s8','s11',**linkSSParameters)
		lss15 = self.addLink('s10','s11',**linkSSParameters)
		lss16 = self.addLink('s11','s12',**linkSSParameters)
		lss17 = self.addLink('s11','s14',**linkSSParameters)
		...
		lss25 = self.addLink('s19','s23',**linkSSParameters)
		lss26 = self.addLink('s20','s23',**linkSSParameters)
