...
class MininetNX( Topo ):
	def build( self ):
		...
		lss3 = self.addLink('s0','s4',**linkSSParameters)
		lss4 = self.addLink('s0','s5',**linkSSParameters)
		lss5 = self.addLink('s0','s9',**linkSSParameters)
		lss6 = self.addLink('s0','s10',**linkSSParameters)
		lss7 = self.addLink('s0','s11',**linkSSParameters)
		lss8 = self.addLink('s0','s12',**linkSSParameters)
		lss9 = self.addLink('s0','s13',**linkSSParameters)
		lss10 = self.addLink('s1','s8',**linkSSParameters)
		lss11 = self.addLink('s1','s6',**linkSSParameters)
		lss12 = self.addLink('s1','s7',**linkSSParameters)
		
topos = { 'Nordu1997': ( lambda: MininetNX() ) }