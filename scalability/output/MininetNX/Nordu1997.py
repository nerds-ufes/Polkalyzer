...
class MininetNX( Topo ):
	def build( self ):
		...
		lss5 = self.addLink('s0','s9')
		lss6 = self.addLink('s0','s10')
		lss7 = self.addLink('s0','s11')
		lss8 = self.addLink('s0','s12')
		lss9 = self.addLink('s0','s13')
		lss10 = self.addLink('s1','s8')
		lss11 = self.addLink('s1','s6')
		lss12 = self.addLink('s1','s7')
