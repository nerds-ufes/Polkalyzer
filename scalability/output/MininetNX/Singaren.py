...
class MininetNX( Topo ):
	def build( self ):
		...
		lss0 = self.addLink('s0','s6',**linkSSParameters)
		lss1 = self.addLink('s1','s6',**linkSSParameters)
		lss2 = self.addLink('s2','s6',**linkSSParameters)
		lss3 = self.addLink('s3','s6',**linkSSParameters)
		lss4 = self.addLink('s4','s6',**linkSSParameters)
		lss5 = self.addLink('s5','s6',**linkSSParameters)
		lss6 = self.addLink('s6','s7',**linkSSParameters)
		lss7 = self.addLink('s6','s8',**linkSSParameters)
		lss8 = self.addLink('s6','s9',**linkSSParameters)
		lss9 = self.addLink('s6','s10',**linkSSParameters)
