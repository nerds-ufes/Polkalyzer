...
class MininetNX( Topo ):
	def build( self ):
		...
		lss85 = self.addLink('s69','s70',**linkSSParameters)
		lss86 = self.addLink('s71','s72',**linkSSParameters)
		lss87 = self.addLink('s73','s74',**linkSSParameters)
		lss88 = self.addLink('s74','s75',**linkSSParameters)
		lss89 = self.addLink('s77','s78',**linkSSParameters)
		lss90 = self.addLink('s79','s80',**linkSSParameters)
		lss91 = self.addLink('s84','s85',**linkSSParameters)
		
topos = { 'VtlWavenet2008': ( lambda: MininetNX() ) }