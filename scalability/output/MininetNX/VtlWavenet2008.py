...
class MininetNX( Topo ):
	def build( self ):
		...
		lss81 = self.addLink('s69','s70',**linkSSParameters)
		lss82 = self.addLink('s73','s74',**linkSSParameters)
		lss83 = self.addLink('s74','s75',**linkSSParameters)
		lss84 = self.addLink('s77','s78',**linkSSParameters)
		lss85 = self.addLink('s79','s80',**linkSSParameters)
		lss86 = self.addLink('s84','s85',**linkSSParameters)
