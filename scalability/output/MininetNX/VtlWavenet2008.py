...
class MininetNX( Topo ):
	def build( self ):
		...
		lss85 = self.addLink('s69','s70')
		lss86 = self.addLink('s71','s72')
		lss87 = self.addLink('s73','s74')
		lss88 = self.addLink('s74','s75')
		lss89 = self.addLink('s77','s78')
		lss90 = self.addLink('s79','s80')
		lss91 = self.addLink('s84','s85')
