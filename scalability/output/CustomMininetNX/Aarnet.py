...
class MininetNX( Topo ):
	def build( self ):
		...
		lss5 = self.addLink('s2','s7',**linkSSParameters)
		lss6 = self.addLink('s3','s5',**linkSSParameters)
		lss7 = self.addLink('s3','s6',**linkSSParameters)
		lss8 = self.addLink('s4','s8',**linkSSParameters)
		lss9 = self.addLink('s4','s10',**linkSSParameters)
		lss10 = self.addLink('s4','s5',**linkSSParameters)
		lss11 = self.addLink('s5','s8',**linkSSParameters)
		lss12 = self.addLink('s5','s11',**linkSSParameters)
		...
		lss16 = self.addLink('s11','s18',**linkSSParameters)
